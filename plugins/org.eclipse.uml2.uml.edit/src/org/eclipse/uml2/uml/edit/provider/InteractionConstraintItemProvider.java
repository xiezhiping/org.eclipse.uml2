 ...
 *
 * $Id: InteractionConstraintItemProvider.java,v 1.1 2005/11/14 22:11:34 khussey Exp $
 */
...
public class InteractionConstraintItemProvider
	...
	protected void addMinintPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getInteractionConstraint_Minint(), true,
				null, null,
	...
	protected void addMaxintPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getInteractionConstraint_Maxint(), true,
				null, null,
				new String[]{"org.eclipse.ui.views.properties.expert" //$NON-NLS-1$
				}));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator()
			.getImage("full/obj16/InteractionConstraint"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getInteractionConstraint_Minint(), UMLFactory.eINSTANCE
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getInteractionConstraint_Maxint(), UMLFactory.eINSTANCE
			.createOpaqueExpression()));
