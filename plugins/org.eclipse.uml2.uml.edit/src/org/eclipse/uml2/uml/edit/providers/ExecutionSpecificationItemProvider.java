 ...
 *
 * $Id: ExecutionSpecificationItemProvider.java,v 1.1 2005/12/07 14:20:28 khussey Exp $
 */
...
public class ExecutionSpecificationItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_ExecutionSpecification_type") : //$NON-NLS-1$
			getString("_UI_ExecutionSpecification_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
