 ...
 *
 * $Id: ChangeEventItemProvider.java,v 1.1 2005/11/14 22:11:36 khussey Exp $
 */
...
public class ChangeEventItemProvider
	...
	protected void addChangeExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getChangeEvent_ChangeExpression(), true,
				null, null,
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/ChangeEvent"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_ChangeEvent_type") : //$NON-NLS-1$
			getString("_UI_ChangeEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getChangeEvent_ChangeExpression(), UMLFactory.eINSTANCE
