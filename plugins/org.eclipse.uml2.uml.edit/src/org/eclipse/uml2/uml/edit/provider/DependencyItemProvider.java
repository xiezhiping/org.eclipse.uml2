 ...
 *
 * $Id: DependencyItemProvider.java,v 1.1 2005/11/14 22:11:33 khussey Exp $
 */
	...
	protected void addSupplierPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getDependency_Supplier(), true, null,
				null, null));
	}
	...
	protected void addClientPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getDependency_Client(), true, null, null,
				null));
	}
