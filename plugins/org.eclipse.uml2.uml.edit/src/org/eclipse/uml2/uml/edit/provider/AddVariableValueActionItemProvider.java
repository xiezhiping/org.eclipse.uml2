 ...
 *
 * $Id: AddVariableValueActionItemProvider.java,v 1.1 2005/11/14 22:11:36 khussey Exp $
 */
...
public class AddVariableValueActionItemProvider
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage(
			"full/obj16/AddVariableValueAction"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getAddVariableValueAction_InsertAt(), UMLFactory.eINSTANCE
			.createInputPin()));
