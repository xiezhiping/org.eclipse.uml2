 ...
 *
 * $Id: ReceiveOperationEventItemProvider.java,v 1.1 2005/12/08 14:52:55 khussey Exp $
 */
...
public class ReceiveOperationEventItemProvider
	...
	public Object getImage(Object object) {
		return getResourceLocator()
			.getImage("full/obj16/ReceiveOperationEvent"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_ReceiveOperationEvent_type") : //$NON-NLS-1$
			getString("_UI_ReceiveOperationEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
