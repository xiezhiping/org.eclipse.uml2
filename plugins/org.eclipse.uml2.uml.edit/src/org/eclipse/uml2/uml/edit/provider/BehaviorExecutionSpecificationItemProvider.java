 ...
 *
 * $Id: BehaviorExecutionSpecificationItemProvider.java,v 1.1 2005/11/14 22:11:35 khussey Exp $
 */
...
public class BehaviorExecutionSpecificationItemProvider
		...
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE
					.getBehaviorExecutionSpecification_Behavior(), true, null,
				null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_BehaviorExecutionSpecification_type") : //$NON-NLS-1$
			getString("_UI_BehaviorExecutionSpecification_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
