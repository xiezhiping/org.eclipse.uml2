 ...
 *
 * $Id: ReadSelfActionItemProvider.java,v 1.7 2007/03/22 16:46:11 khussey Exp $
 */
...
public class ReadSelfActionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
			"full/obj16/ReadSelfAction")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
			UMLPackage.Literals.READ_SELF_ACTION__RESULT, UMLFactory.eINSTANCE
				.createOutputPin()));
	}
