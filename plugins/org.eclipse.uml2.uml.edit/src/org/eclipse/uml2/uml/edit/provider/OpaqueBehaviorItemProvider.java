 ...
 *
 * $Id: OpaqueBehaviorItemProvider.java,v 1.1 2005/11/14 22:11:35 khussey Exp $
 */
...
public class OpaqueBehaviorItemProvider
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getOpaqueBehavior_Body(), true,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getOpaqueBehavior_Language(), true,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/OpaqueBehavior"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_OpaqueBehavior_type") : //$NON-NLS-1$
			getString("_UI_OpaqueBehavior_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
