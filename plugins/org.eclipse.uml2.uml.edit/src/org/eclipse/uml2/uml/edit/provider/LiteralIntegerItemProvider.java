 ...
 *
 * $Id: LiteralIntegerItemProvider.java,v 1.1 2005/11/14 22:11:35 khussey Exp $
 */
...
public class LiteralIntegerItemProvider
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getLiteralInteger_Value(), true,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_LiteralInteger_type") : //$NON-NLS-1$
			getString("_UI_LiteralInteger_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
