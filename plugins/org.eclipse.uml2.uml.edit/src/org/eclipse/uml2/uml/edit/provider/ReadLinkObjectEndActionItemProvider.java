 ...
 *
 * $Id: ReadLinkObjectEndActionItemProvider.java,v 1.1 2005/11/14 22:11:36 khussey Exp $
 */
...
public class ReadLinkObjectEndActionItemProvider
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getReadLinkObjectEndAction_Object(), true,
				null, null,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getReadLinkObjectEndAction_End(), true,
				null, null, null));
	}
	...
	protected void addResultPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(
				...
				UMLPackage.eINSTANCE.getReadLinkObjectEndAction_Result(), true,
				null, null,
				new String[]{"org.eclipse.ui.views.properties.expert" //$NON-NLS-1$
				}));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage(
			"full/obj16/ReadLinkObjectEndAction"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getReadLinkObjectEndAction_Object(), UMLFactory.eINSTANCE
			.createInputPin()));
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getReadLinkObjectEndAction_Result(), UMLFactory.eINSTANCE
			.createOutputPin()));
	}
