 ...
 *
 * $Id: StartClassifierBehaviorActionItemProvider.java,v 1.1 2005/11/14 22:11:35 khussey Exp $
 */
...
public class StartClassifierBehaviorActionItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_StartClassifierBehaviorAction_type") : //$NON-NLS-1$
			getString("_UI_StartClassifierBehaviorAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.eINSTANCE
			.getStartClassifierBehaviorAction_Object(), UMLFactory.eINSTANCE
			.createInputPin()));
