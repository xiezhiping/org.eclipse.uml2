 ...
 *
 * $Id: InterfaceRealizationItemProvider.java,v 1.1 2005/12/07 14:20:24 khussey Exp $
 */
...
public class InterfaceRealizationItemProvider
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/InterfaceRealization"); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			...
			getString("_UI_InterfaceRealization_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
