 ...
 *   Kenn Hussey - 286329
 *
 * $Id: LifelineImpl.java,v 1.25 2009/12/04 15:30:46 khussey Exp $
 */
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
			...
			case UMLPackage.LIFELINE___VALIDATE_SELECTOR_SPECIFIED__DIAGNOSTICCHAIN_MAP :
				return validateSelectorSpecified((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.LIFELINE___VALIDATE_SAME_CLASSIFIER__DIAGNOSTICCHAIN_MAP :
				return validateSameClassifier((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
		}
