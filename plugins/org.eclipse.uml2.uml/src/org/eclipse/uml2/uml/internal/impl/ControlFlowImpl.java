 ...
 *   Kenn Hussey - 286329
 *
 * $Id: ControlFlowImpl.java,v 1.4 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.CONTROL_FLOW___VALIDATE_SOURCE_AND_TARGET__DIAGNOSTICCHAIN_MAP :
				return validateSourceAndTarget((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.CONTROL_FLOW___VALIDATE_OWNED__DIAGNOSTICCHAIN_MAP :
				return validateOwned((DiagnosticChain) arguments.get(0),
					(Map<Object, Object>) arguments.get(1));
			case UMLPackage.CONTROL_FLOW___VALIDATE_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP :
