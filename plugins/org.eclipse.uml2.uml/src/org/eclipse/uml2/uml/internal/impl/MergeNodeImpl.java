 ...
 *   Kenn Hussey - 286329
 *
 * $Id: MergeNodeImpl.java,v 1.4 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.MERGE_NODE___IS_REDEFINITION_CONTEXT_VALID__REDEFINABLEELEMENT :
				return isRedefinitionContextValid((RedefinableElement) arguments
					.get(0));
			case UMLPackage.MERGE_NODE___VALIDATE_OWNED_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP :
				return validateOwnedStructuredNode((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.MERGE_NODE___VALIDATE_OWNED__DIAGNOSTICCHAIN_MAP :
			...
			case UMLPackage.MERGE_NODE___VALIDATE_ONE_OUTGOING_EDGE__DIAGNOSTICCHAIN_MAP :
				return validateOneOutgoingEdge((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
