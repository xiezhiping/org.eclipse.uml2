 ...
 *
 * $Id: ReceptionOperations.java,v 1.2 2005/12/08 19:38:07 khussey Exp $
 */
 ...
 * @generated not
 */
public final class ReceptionOperations extends UMLOperations {
				...
				diagnostics
					.add(new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE
							.getString(
								"_UI_GenericInvariant_diagnostic", new Object[]{"validateNotQuery", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(reception, context)}), //$NON-NLS-1$ //$NON-NLS-2$
