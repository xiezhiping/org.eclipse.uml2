 ...
 *   Kenn Hussey - 286329
 *
 * $Id: TestIdentityActionImpl.java,v 1.28 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.TEST_IDENTITY_ACTION___IS_REDEFINITION_CONTEXT_VALID__REDEFINABLEELEMENT :
				return isRedefinitionContextValid((RedefinableElement) arguments
					.get(0));
			case UMLPackage.TEST_IDENTITY_ACTION___VALIDATE_OWNED_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP :
				return validateOwnedStructuredNode((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.TEST_IDENTITY_ACTION___VALIDATE_OWNED__DIAGNOSTICCHAIN_MAP :
			...
			case UMLPackage.TEST_IDENTITY_ACTION___VALIDATE_RESULT_IS_BOOLEAN__DIAGNOSTICCHAIN_MAP :
				return validateResultIsBoolean((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
		}
