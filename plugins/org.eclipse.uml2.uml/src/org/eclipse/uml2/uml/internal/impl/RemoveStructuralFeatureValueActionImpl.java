 ...
 *
 * $Id: RemoveStructuralFeatureValueActionImpl.java,v 1.5 2005/11/28 20:26:03 khussey Exp $
 */
		...
		switch (featureID) {
			...
			case UMLPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__NAME :
				String name = (String) eVirtualGet(
					UMLPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__NAME,
					NAME_EDEFAULT);
			...
			case UMLPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__VISIBILITY :
				return eVirtualGet(
					UMLPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__VISIBILITY,
