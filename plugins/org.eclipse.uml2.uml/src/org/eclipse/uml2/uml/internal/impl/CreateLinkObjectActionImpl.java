 ...
 *   Kenn Hussey - 286329
 *
 * $Id: CreateLinkObjectActionImpl.java,v 1.27 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.CREATE_LINK_OBJECT_ACTION___IS_REDEFINITION_CONTEXT_VALID__REDEFINABLEELEMENT :
				return isRedefinitionContextValid((RedefinableElement) arguments
					.get(0));
			case UMLPackage.CREATE_LINK_OBJECT_ACTION___VALIDATE_OWNED_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP :
				return validateOwnedStructuredNode((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.CREATE_LINK_OBJECT_ACTION___VALIDATE_OWNED__DIAGNOSTICCHAIN_MAP :
			...
			case UMLPackage.CREATE_LINK_OBJECT_ACTION___VALIDATE_ASSOCIATION_CLASS__DIAGNOSTICCHAIN_MAP :
				return validateAssociationClass((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
