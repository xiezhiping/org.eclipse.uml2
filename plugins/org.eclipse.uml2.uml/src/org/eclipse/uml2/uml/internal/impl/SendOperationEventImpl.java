 ...
 *
 * $Id: SendOperationEventImpl.java,v 1.9 2006/02/21 16:12:18 khussey Exp $
 */
...
public class SendOperationEventImpl
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UMLPackage.SEND_OPERATION_EVENT__EANNOTATIONS :
				EList eAnnotations = (EList) eVirtualGet(UMLPackage.SEND_OPERATION_EVENT__EANNOTATIONS);
