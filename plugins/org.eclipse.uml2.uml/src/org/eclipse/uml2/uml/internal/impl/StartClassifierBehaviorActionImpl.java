 ...
 *
 * $Id: StartClassifierBehaviorActionImpl.java,v 1.6 2005/12/01 20:04:38 khussey Exp $
 */
		...
		switch (featureID) {
			...
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__NAME :
				String name = (String) eVirtualGet(
					UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__NAME,
					NAME_EDEFAULT);
			...
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__VISIBILITY :
				return eVirtualGet(
					UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__VISIBILITY,
