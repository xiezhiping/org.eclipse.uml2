 ...
 *   Kenn Hussey - 286329
 *
 * $Id: StartClassifierBehaviorActionImpl.java,v 1.28 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION___IS_REDEFINITION_CONTEXT_VALID__REDEFINABLEELEMENT :
				return isRedefinitionContextValid((RedefinableElement) arguments
					.get(0));
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION___VALIDATE_OWNED_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP :
				return validateOwnedStructuredNode((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION___VALIDATE_OWNED__DIAGNOSTICCHAIN_MAP :
			...
			case UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION___VALIDATE_TYPE_HAS_CLASSIFIER__DIAGNOSTICCHAIN_MAP :
				return validateTypeHasClassifier((DiagnosticChain) arguments
					.get(0), (Map<Object, Object>) arguments.get(1));
		}
