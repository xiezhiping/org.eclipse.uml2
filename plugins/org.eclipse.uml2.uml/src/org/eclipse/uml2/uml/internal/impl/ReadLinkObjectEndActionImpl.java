 ...
 *
 * $Id: ReadLinkObjectEndActionImpl.java,v 1.5 2005/11/28 20:26:03 khussey Exp $
 */
		...
		switch (featureID) {
			...
			case UMLPackage.READ_LINK_OBJECT_END_ACTION__NAME :
				String name = (String) eVirtualGet(
					UMLPackage.READ_LINK_OBJECT_END_ACTION__NAME, NAME_EDEFAULT);
				return NAME_EDEFAULT == null
					? name != null
					: !NAME_EDEFAULT.equals(name);
			case UMLPackage.READ_LINK_OBJECT_END_ACTION__VISIBILITY :
				return eVirtualGet(
					UMLPackage.READ_LINK_OBJECT_END_ACTION__VISIBILITY,
