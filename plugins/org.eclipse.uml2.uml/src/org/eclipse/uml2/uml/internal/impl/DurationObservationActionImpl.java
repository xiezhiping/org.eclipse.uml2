 ...
 *
 * $Id: DurationObservationActionImpl.java,v 1.7 2005/12/06 23:21:49 khussey Exp $
 */
...
public class DurationObservationActionImpl
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UMLPackage.DURATION_OBSERVATION_ACTION__EANNOTATIONS :
				EList eAnnotations = (EList) eVirtualGet(UMLPackage.DURATION_OBSERVATION_ACTION__EANNOTATIONS);
