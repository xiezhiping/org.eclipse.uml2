 ...
 *   Kenn Hussey - 286329
 *
 * $Id: BehavioredClassifierImpl.java,v 1.34 2009/12/04 15:30:42 khussey Exp $
 */
		...
		switch (operationID) {
			...
			case UMLPackage.BEHAVIORED_CLASSIFIER___VALIDATE_NO_CYCLES_IN_GENERALIZATION__DIAGNOSTICCHAIN_MAP :
				return validateNoCyclesInGeneralization(
					(DiagnosticChain) arguments.get(0),
					(Map<Object, Object>) arguments.get(1));
			case UMLPackage.BEHAVIORED_CLASSIFIER___VALIDATE_GENERALIZATION_HIERARCHIES__DIAGNOSTICCHAIN_MAP :
			...
			case UMLPackage.BEHAVIORED_CLASSIFIER___CONFORMS_TO__CLASSIFIER :
