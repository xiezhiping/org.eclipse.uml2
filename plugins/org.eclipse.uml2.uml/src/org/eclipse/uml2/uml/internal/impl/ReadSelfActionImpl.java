 ...
 *
 * $Id: ReadSelfActionImpl.java,v 1.10 2006/01/03 18:01:59 khussey Exp $
 */
...
public class ReadSelfActionImpl
	...
	public EList getOutputs() {
		EList output = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__OUTPUT);
		if (output == null) {
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UMLPackage.READ_SELF_ACTION__EANNOTATIONS :
				EList eAnnotations = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__EANNOTATIONS);
			...
			case UMLPackage.READ_SELF_ACTION__OWNER :
				return isSetOwner();
			case UMLPackage.READ_SELF_ACTION__OWNED_COMMENT :
				EList ownedComment = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__OWNED_COMMENT);
			...
			case UMLPackage.READ_SELF_ACTION__CLIENT_DEPENDENCY :
				EList clientDependency = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__CLIENT_DEPENDENCY);
			...
			case UMLPackage.READ_SELF_ACTION__OUTGOING :
				EList outgoing = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__OUTGOING);
				return outgoing != null && !outgoing.isEmpty();
			case UMLPackage.READ_SELF_ACTION__INCOMING :
				EList incoming = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__INCOMING);
				return incoming != null && !incoming.isEmpty();
			case UMLPackage.READ_SELF_ACTION__IN_PARTITION :
				EList inPartition = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__IN_PARTITION);
				return inPartition != null && !inPartition.isEmpty();
			case UMLPackage.READ_SELF_ACTION__IN_INTERRUPTIBLE_REGION :
				EList inInterruptibleRegion = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__IN_INTERRUPTIBLE_REGION);
				return inInterruptibleRegion != null
					&& !inInterruptibleRegion.isEmpty();
			case UMLPackage.READ_SELF_ACTION__IN_GROUP :
				return isSetInGroups();
			case UMLPackage.READ_SELF_ACTION__REDEFINED_NODE :
				EList redefinedNode = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__REDEFINED_NODE);
				return redefinedNode != null && !redefinedNode.isEmpty();
			case UMLPackage.READ_SELF_ACTION__HANDLER :
				EList handler = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__HANDLER);
			...
			case UMLPackage.READ_SELF_ACTION__LOCAL_PRECONDITION :
				EList localPrecondition = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__LOCAL_PRECONDITION);
				return localPrecondition != null
					&& !localPrecondition.isEmpty();
			case UMLPackage.READ_SELF_ACTION__LOCAL_POSTCONDITION :
				EList localPostcondition = (EList) eVirtualGet(UMLPackage.READ_SELF_ACTION__LOCAL_POSTCONDITION);
