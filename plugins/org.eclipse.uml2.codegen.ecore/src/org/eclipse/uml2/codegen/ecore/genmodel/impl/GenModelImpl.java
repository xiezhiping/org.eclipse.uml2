 ...
 *
 * $Id: GenModelImpl.java,v 1.1 2005/05/17 22:06:28 khussey Exp $
 */
 ...
 * @generated
 */
public class GenModelImpl extends
		org.eclipse.emf.codegen.ecore.genmodel.impl.GenModelImpl implements
		GenModel {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		if (featureID >= 0) {
			...
			case GenModelPackage.GEN_MODEL__GEN_PACKAGES:
				return ((InternalEList) getGenPackages()).basicAdd(otherEnd,
						msgs);
			default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
			case GenModelPackage.GEN_MODEL__GEN_PACKAGES:
				return ((InternalEList) getGenPackages()).basicRemove(otherEnd,
						msgs);
			default:
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		...
		case GenModelPackage.GEN_MODEL__REDIRECTION:
			return REDIRECTION_EDEFAULT == null ? redirection != null
		...
		case GenModelPackage.GEN_MODEL__IMPORTER_ID:
			return IMPORTER_ID_EDEFAULT == null ? importerID != null
		...
		case GenModelPackage.GEN_MODEL__INVARIANT_PREFIX:
			return INVARIANT_PREFIX_EDEFAULT == null ? invariantPrefix != null
