...
public class ItemProvider
{
  ...
  protected final String TEXT_283 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createAddCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection, int)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_284 = NL + "\t@Override";
  protected final String TEXT_285 = NL + "\tprotected ";
  protected final String TEXT_286 = " createAddCommand(";
  protected final String TEXT_287 = " domain, ";
  protected final String TEXT_288 = " owner, ";
  protected final String TEXT_289 = " feature, ";
  protected final String TEXT_290 = " collection, int index) {";
  protected final String TEXT_291 = NL + "\t\tif (feature == ";
  protected final String TEXT_292 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_293 = "(domain, owner, feature, ";
  protected final String TEXT_294 = ", collection, index);" + NL + "\t\t}";
  protected final String TEXT_295 = NL + "\t\treturn super.createAddCommand(domain, owner, feature, collection, index);" + NL + "\t}" + NL;
  protected final String TEXT_296 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createRemoveCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_297 = NL + "\t@Override";
  protected final String TEXT_298 = NL + "\tprotected ";
  protected final String TEXT_299 = " createRemoveCommand(";
  protected final String TEXT_300 = " domain, ";
  protected final String TEXT_301 = " owner, ";
  protected final String TEXT_302 = " feature, ";
  protected final String TEXT_303 = " collection) {";
  protected final String TEXT_304 = NL + "\t\tif (feature == ";
  protected final String TEXT_305 = ") {" + NL + "\t\t\treturn new ";
  ...
  protected final String TEXT_313 = " domain, ";
  protected final String TEXT_314 = " owner, ";
  protected final String TEXT_315 = " feature, ";
  protected final String TEXT_316 = " value, ";
  protected final String TEXT_317 = " collection) {";
  protected final String TEXT_318 = NL + "\t\tif (feature == ";
  protected final String TEXT_319 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_320 = "(domain, owner, feature, ";
  protected final String TEXT_321 = ", ";
  protected final String TEXT_322 = ", value, collection);" + NL + "\t\t}";
  protected final String TEXT_323 = NL + "\t\treturn super.createReplaceCommand(domain, owner, feature, value, collection);" + NL + "\t}" + NL;
  protected final String TEXT_324 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createSetCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.lang.Object)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_325 = NL + "\t@Override";
  protected final String TEXT_326 = NL + "\tprotected ";
  protected final String TEXT_327 = " createSetCommand(";
  protected final String TEXT_328 = " domain, ";
  protected final String TEXT_329 = " owner, ";
  protected final String TEXT_330 = " feature, Object value) {";
  protected final String TEXT_331 = NL + "\t\tif (feature == ";
  protected final String TEXT_332 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_333 = "(domain, owner, feature, ";
  protected final String TEXT_334 = ", ";
  protected final String TEXT_335 = ", value);" + NL + "\t\t}";
  protected final String TEXT_336 = NL + "\t\treturn super.createSetCommand(domain, owner, feature, value);" + NL + "\t}" + NL;
