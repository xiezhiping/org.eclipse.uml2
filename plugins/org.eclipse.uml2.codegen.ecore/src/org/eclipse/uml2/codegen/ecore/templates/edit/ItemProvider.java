...
public class ItemProvider
{
  ...
  protected final String TEXT_220 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createAddCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection, int)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_221 = NL + "\t@Override";
  protected final String TEXT_222 = NL + "\tprotected ";
  protected final String TEXT_223 = " createAddCommand(";
  protected final String TEXT_224 = " domain, ";
  protected final String TEXT_225 = " owner, ";
  protected final String TEXT_226 = " feature, ";
  protected final String TEXT_227 = " collection, int index) {";
  protected final String TEXT_228 = NL + "\t\tif (feature == ";
  protected final String TEXT_229 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_230 = "(domain, owner, feature, ";
  protected final String TEXT_231 = ", collection, index);" + NL + "\t\t}";
  protected final String TEXT_232 = NL + "\t\treturn super.createAddCommand(domain, owner, feature, collection, index);" + NL + "\t}" + NL;
  protected final String TEXT_233 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createRemoveCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_234 = NL + "\t@Override";
  protected final String TEXT_235 = NL + "\tprotected ";
  protected final String TEXT_236 = " createRemoveCommand(";
  protected final String TEXT_237 = " domain, ";
  protected final String TEXT_238 = " owner, ";
  protected final String TEXT_239 = " feature, ";
  protected final String TEXT_240 = " collection) {";
  protected final String TEXT_241 = NL + "\t\tif (feature == ";
  protected final String TEXT_242 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_243 = "(domain, owner, feature, ";
  protected final String TEXT_244 = ", collection);" + NL + "\t\t}";
  protected final String TEXT_245 = NL + "\t\treturn super.createRemoveCommand(domain, owner, feature, collection);" + NL + "\t}" + NL;
  protected final String TEXT_246 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createReplaceCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, org.eclipse.emf.ecore.EObject, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_261 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createSetCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.lang.Object)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_262 = NL + "\t@Override";
  protected final String TEXT_263 = NL + "\tprotected ";
  protected final String TEXT_264 = " createSetCommand(";
  protected final String TEXT_265 = " domain, ";
  protected final String TEXT_266 = " owner, ";
  protected final String TEXT_267 = " feature, Object value) {";
  protected final String TEXT_268 = NL + "\t\tif (feature == ";
  protected final String TEXT_269 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_270 = "(domain, owner, feature, ";
  protected final String TEXT_271 = ", ";
  protected final String TEXT_272 = ", value);" + NL + "\t\t}";
  protected final String TEXT_273 = NL + "\t\treturn super.createSetCommand(domain, owner, feature, value);" + NL + "\t}" + NL;
