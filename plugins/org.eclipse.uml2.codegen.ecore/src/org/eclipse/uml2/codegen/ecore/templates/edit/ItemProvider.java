...
public class ItemProvider
{
  ...
  protected final String TEXT_285 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createAddCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection, int)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_286 = NL + "\t@Override";
  protected final String TEXT_287 = NL + "\tprotected ";
  protected final String TEXT_288 = " createAddCommand(";
  protected final String TEXT_289 = " domain, ";
  protected final String TEXT_290 = " owner, ";
  protected final String TEXT_291 = " feature, ";
  protected final String TEXT_292 = " collection, int index) {";
  protected final String TEXT_293 = NL + "\t\tif (feature == ";
  protected final String TEXT_294 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_295 = "(domain, owner, feature, ";
  protected final String TEXT_296 = ", collection, index);" + NL + "\t\t}";
  protected final String TEXT_297 = NL + "\t\treturn super.createAddCommand(domain, owner, feature, collection, index);" + NL + "\t}" + NL;
  protected final String TEXT_298 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createRemoveCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_299 = NL + "\t@Override";
  protected final String TEXT_300 = NL + "\tprotected ";
  protected final String TEXT_301 = " createRemoveCommand(";
  protected final String TEXT_302 = " domain, ";
  protected final String TEXT_303 = " owner, ";
  protected final String TEXT_304 = " feature, ";
  protected final String TEXT_305 = " collection) {";
  protected final String TEXT_306 = NL + "\t\tif (feature == ";
  protected final String TEXT_307 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_308 = "(domain, owner, feature, ";
  protected final String TEXT_309 = ", collection);" + NL + "\t\t}";
  protected final String TEXT_310 = NL + "\t\treturn super.createRemoveCommand(domain, owner, feature, collection);" + NL + "\t}" + NL;
  protected final String TEXT_311 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createReplaceCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.lang.Object, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_312 = NL + "\t@Override";
  protected final String TEXT_313 = NL + "\tprotected ";
  protected final String TEXT_314 = " createReplaceCommand(";
  protected final String TEXT_315 = " domain, ";
  protected final String TEXT_316 = " owner, ";
  protected final String TEXT_317 = " feature, ";
  protected final String TEXT_318 = " value, ";
  protected final String TEXT_319 = " collection) {";
  protected final String TEXT_320 = NL + "\t\tif (feature == ";
  protected final String TEXT_321 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_322 = "(domain, owner, feature, ";
  protected final String TEXT_323 = ", ";
  protected final String TEXT_324 = ", value, collection);" + NL + "\t\t}";
  protected final String TEXT_325 = NL + "\t\treturn super.createReplaceCommand(domain, owner, feature, value, collection);" + NL + "\t}" + NL;
  protected final String TEXT_326 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createSetCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.lang.Object)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_327 = NL + "\t@Override";
  protected final String TEXT_328 = NL + "\tprotected ";
  protected final String TEXT_329 = " createSetCommand(";
  protected final String TEXT_330 = " domain, ";
  protected final String TEXT_331 = " owner, ";
  protected final String TEXT_332 = " feature, Object value) {";
  protected final String TEXT_333 = NL + "\t\tif (feature == ";
  protected final String TEXT_334 = ") {" + NL + "\t\t\treturn new ";
  protected final String TEXT_335 = "(domain, owner, feature, ";
  protected final String TEXT_336 = ", ";
  protected final String TEXT_337 = ", value);" + NL + "\t\t}";
  protected final String TEXT_338 = NL + "\t\treturn super.createSetCommand(domain, owner, feature, value);" + NL + "\t}" + NL;
