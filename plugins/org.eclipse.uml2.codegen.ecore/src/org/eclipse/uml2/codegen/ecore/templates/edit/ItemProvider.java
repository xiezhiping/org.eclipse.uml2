...
public class ItemProvider
{
  ...
  protected final String TEXT_85 = ")object).eGet(";
  protected final String TEXT_86 = ".eINSTANCE.get";
  protected final String TEXT_87 = "());";
  protected final String TEXT_88 = NL + "\t\t";
  protected final String TEXT_89 = " labelValue = ((";
  protected final String TEXT_90 = ")object).";
  protected final String TEXT_91 = "();";
  protected final String TEXT_92 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_93 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_94 = "_type\") :";
  protected final String TEXT_95 = NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_96 = "_type\") + \" \" + label;";
  protected final String TEXT_97 = NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_98 = "_type\");";
  protected final String TEXT_99 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_100 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_101 = ".class))" + NL + "\t\t{";
  protected final String TEXT_102 = NL + "\t\t\tcase ";
  protected final String TEXT_103 = ":";
  protected final String TEXT_104 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_105 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_106 = NL + "\t\t\tcase ";
  protected final String TEXT_107 = ":";
  protected final String TEXT_108 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_109 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_110 = NL + "\t\t\tcase ";
  protected final String TEXT_111 = ":";
  protected final String TEXT_112 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_113 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_114 = NL + "\t\t}";
  protected final String TEXT_115 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_116 = NL + "\t/**" + NL + "\t * This adds to the collection of {@link org.eclipse.emf.edit.command.CommandParameter}s" + NL + "\t * describing all of the children that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_117 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  ...
  protected final String TEXT_135 = ".eINSTANCE.create(";
  protected final String TEXT_136 = ".eINSTANCE.get";
  protected final String TEXT_137 = "()))));";
  protected final String TEXT_138 = NL + "\t\t\t\t\t ";
  protected final String TEXT_139 = ".eINSTANCE.create";
  protected final String TEXT_140 = "())));";
  protected final String TEXT_141 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  protected final String TEXT_142 = ".eINSTANCE.get";
  protected final String TEXT_143 = "()," + NL + "\t\t\t\t ";
  protected final String TEXT_144 = ".createEntry" + NL + "\t\t\t\t\t(";
  ...
  protected final String TEXT_152 = ".eINSTANCE.createFromString(";
  ...
  protected final String TEXT_161 = ".eINSTANCE.create(";
  protected final String TEXT_162 = ".eINSTANCE.get";
  protected final String TEXT_163 = "())));";
  protected final String TEXT_164 = NL + "\t\t\t\t ";
  protected final String TEXT_165 = ".eINSTANCE.create";
  ...
  protected final String TEXT_175 = ".eINSTANCE.createFromString(";
  ...
  protected final String TEXT_193 = NL + "\t/**" + NL + "\t * This returns the icon image for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getCreateChildImage(Object owner, Object feature, Object child, Collection selection)" + NL + "\t{" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_194 = " && ";
  protected final String TEXT_195 = ".isFeatureMap((";
  protected final String TEXT_196 = ")feature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_197 = ".Entry entry = (";
  protected final String TEXT_198 = ".Entry)child;" + NL + "\t\t\tfeature = entry.getEStructuralFeature();" + NL + "\t\t\tchild = entry.getValue();        " + NL + "\t\t}" + NL + "" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_199 = " && child instanceof ";
  protected final String TEXT_200 = ")" + NL + "\t\t{" + NL + "\t\t\tString name = \"full/obj16/\" + ((EObject)child).eClass().getName();";
  protected final String TEXT_201 = NL + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn getResourceLocator().getImage(name);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_202 = ".INSTANCE.log(e);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\treturn super.getCreateChildImage(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_203 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ResourceLocator getResourceLocator()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_204 = ".INSTANCE;" + NL + "\t}" + NL;
  protected final String TEXT_205 = NL;
  protected final String TEXT_206 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createAddCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection, int)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_207 = " createAddCommand(";
  protected final String TEXT_208 = " domain, ";
  protected final String TEXT_209 = " owner, ";
  protected final String TEXT_210 = " feature, ";
  protected final String TEXT_211 = " collection, int index) {";
  protected final String TEXT_212 = NL + "\t\tif (feature == ";
  protected final String TEXT_213 = "()) {" + NL + "\t\t\treturn new ";
  protected final String TEXT_214 = "(domain, owner, feature, ";
  protected final String TEXT_215 = ", collection, index);" + NL + "\t\t}";
  protected final String TEXT_216 = NL + "\t\treturn super.createAddCommand(domain, owner, feature, collection, index);" + NL + "\t}" + NL;
  protected final String TEXT_217 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createRemoveCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_218 = " createRemoveCommand(";
  protected final String TEXT_219 = " domain, ";
  protected final String TEXT_220 = " owner, ";
  protected final String TEXT_221 = " feature, ";
  ...
  protected final String TEXT_226 = ", collection);" + NL + "\t\t}";
  protected final String TEXT_227 = NL + "\t\treturn super.createRemoveCommand(domain, owner, feature, collection);" + NL + "\t}" + NL;
  protected final String TEXT_228 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createReplaceCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, org.eclipse.emf.ecore.EObject, java.util.Collection)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_229 = " createReplaceCommand(";
  protected final String TEXT_230 = " domain, ";
  protected final String TEXT_231 = " owner, ";
  protected final String TEXT_232 = " feature, ";
  protected final String TEXT_233 = " value, ";
  protected final String TEXT_234 = " collection) {";
  protected final String TEXT_235 = NL + "\t\tif (feature == ";
  protected final String TEXT_236 = "()) {" + NL + "\t\t\treturn new ";
  protected final String TEXT_237 = "(domain, owner, feature, ";
  protected final String TEXT_238 = ", value, collection);" + NL + "\t\t}";
  ...
  protected final String TEXT_242 = ", value, collection);" + NL + "\t\t}";
  protected final String TEXT_243 = NL + "\t\treturn super.createReplaceCommand(domain, owner, feature, value, collection);" + NL + "\t}" + NL;
  protected final String TEXT_244 = NL + "\t/**" + NL + "\t * @see org.eclipse.emf.edit.provider.ItemProviderAdapter#createSetCommand(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, java.lang.Object)" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_245 = " createSetCommand(";
  protected final String TEXT_246 = " domain, ";
  protected final String TEXT_247 = " owner, ";
  protected final String TEXT_248 = " feature, Object value) {";
  ...
  protected final String TEXT_252 = ", value);" + NL + "\t\t}";
  ...
  protected final String TEXT_256 = ", value);" + NL + "\t\t}";
  protected final String TEXT_257 = NL + "\t\treturn super.createSetCommand(domain, owner, feature, value);" + NL + "\t}" + NL;
