...
public class Class
{
  ...
  protected final String TEXT_720 = NL + "\t@Override";
  ...
  protected final String TEXT_741 = NL + "\t\tif (new";
  protected final String TEXT_742 = " != eInternalContainer() || (eContainerFeatureID != ";
  protected final String TEXT_743 = " && new";
  protected final String TEXT_744 = " != null))" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_745 = ".isAncestor(this, ";
  protected final String TEXT_746 = "new";
  protected final String TEXT_747 = "))" + NL + "\t\t\t\tthrow new ";
  protected final String TEXT_748 = "(\"Recursive containment not allowed for \" + toString());";
  protected final String TEXT_749 = NL + "\t\t\t";
  protected final String TEXT_750 = " msgs = null;" + NL + "\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_751 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_752 = ")new";
  protected final String TEXT_753 = ").eInverseAdd(this, ";
  protected final String TEXT_754 = ", ";
  protected final String TEXT_755 = ".class, msgs);" + NL + "\t\t\tmsgs = basicSet";
  protected final String TEXT_756 = "(";
  protected final String TEXT_757 = "new";
  protected final String TEXT_758 = ", msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}";
  ...
  protected final String TEXT_773 = " msgs = null;" + NL + "\t\t\tif (";
  ...
  protected final String TEXT_778 = ", null, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_779 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_780 = ")new";
  protected final String TEXT_781 = ").eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_782 = ", null, msgs);";
  protected final String TEXT_783 = NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_784 = ")";
  protected final String TEXT_785 = ").eInverseRemove(this, ";
  protected final String TEXT_786 = ", ";
  protected final String TEXT_787 = ".class, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_788 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_789 = ")new";
  protected final String TEXT_790 = ").eInverseAdd(this, ";
  protected final String TEXT_791 = ", ";
  protected final String TEXT_792 = ".class, msgs);";
  protected final String TEXT_793 = NL + "\t\t\tmsgs = basicSet";
  protected final String TEXT_794 = "(";
  protected final String TEXT_795 = "new";
  protected final String TEXT_796 = ", msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}";
  ...
  protected final String TEXT_821 = NL + "\t\telse if (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  ...
  protected final String TEXT_831 = "_EFLAG) != 0;";
  protected final String TEXT_832 = NL + "\t\tif (new";
  protected final String TEXT_833 = ") ";
  protected final String TEXT_834 = " |= ";
  protected final String TEXT_835 = "_EFLAG; else ";
  protected final String TEXT_836 = " &= ~";
  protected final String TEXT_837 = "_EFLAG;";
  ...
  protected final String TEXT_862 = NL + "\t\tObject old";
  protected final String TEXT_863 = " = eVirtualSet(";
  ...
  protected final String TEXT_908 = ".Internal eInternalResource = eInternalResource();" + NL + "\t\tif (eInternalResource == null || !eInternalResource.isLoading()) {";
  protected final String TEXT_909 = NL + "\t\t\t";
  protected final String TEXT_910 = " ";
  protected final String TEXT_911 = " = ";
  protected final String TEXT_912 = "();";
  protected final String TEXT_913 = NL + "\t\t\tObject ";
  ...
  protected final String TEXT_919 = ")" + NL + "\t\t\t{" + NL + "\t\t\t\tset";
  protected final String TEXT_920 = "(null);" + NL + "\t\t\t}";
  protected final String TEXT_921 = NL + "\t\t\tif (new";
  ...
  protected final String TEXT_927 = ".contains(new";
  protected final String TEXT_928 = "))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_929 = ".add(new";
  protected final String TEXT_930 = ");" + NL + "\t\t\t\t}";
  protected final String TEXT_931 = NL + "\t\t\t\t";
  protected final String TEXT_932 = " ";
  protected final String TEXT_933 = " = ";
  protected final String TEXT_934 = "();";
  protected final String TEXT_935 = NL + "\t\t\t\tObject ";
  protected final String TEXT_936 = " = eVirtualGet(";
  protected final String TEXT_937 = ");";
  protected final String TEXT_938 = NL + "\t\t\t\tif (new";
  protected final String TEXT_939 = " != ";
  protected final String TEXT_940 = ")" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tset";
  ...
  protected final String TEXT_948 = "()).featureMap()).set(";
  ...
  protected final String TEXT_956 = ".Internal)get";
  ...
  protected final String TEXT_975 = NL + "\t@Override";
  protected final String TEXT_976 = NL + "\tpublic ";
  protected final String TEXT_977 = " basicUnset";
  protected final String TEXT_978 = "(";
  protected final String TEXT_979 = " msgs)" + NL + "\t{";
  protected final String TEXT_980 = NL + "\t\tObject old";
  protected final String TEXT_981 = " = eVirtualUnset(";
  ...
  protected final String TEXT_988 = NL + "\t\tboolean isSetChange = old";
  ...
  protected final String TEXT_993 = "_ESETFLAG) != 0;" + NL + "\t\t";
  ...
  protected final String TEXT_998 = "ESet;" + NL + "\t\t";
  protected final String TEXT_999 = "ESet = false;";
  protected final String TEXT_1000 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_1001 = " notification = new ";
  protected final String TEXT_1002 = "(this, ";
  protected final String TEXT_1003 = ".UNSET, ";
  protected final String TEXT_1004 = ", ";
  protected final String TEXT_1005 = "isSetChange ? old";
  ...
  protected final String TEXT_1012 = ");" + NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}" + NL + "\t\treturn msgs;";
  protected final String TEXT_1013 = NL + "\t\t// TODO: implement this method to unset the contained '";
  ...
  protected final String TEXT_1017 = NL + "\t/**" + NL + "\t * Unsets the value of the '{@link ";
  protected final String TEXT_1018 = "#";
  protected final String TEXT_1019 = " <em>";
  protected final String TEXT_1020 = "</em>}' ";
  protected final String TEXT_1021 = ".";
  protected final String TEXT_1022 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_1023 = NL + "\t * @see #isSet";
  ...
  protected final String TEXT_1056 = " != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_1057 = " msgs = null;";
  protected final String TEXT_1058 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_1059 = ")";
  protected final String TEXT_1060 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_1061 = ", null, msgs);";
  protected final String TEXT_1062 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_1063 = ")";
  protected final String TEXT_1064 = ").eInverseRemove(this, ";
  protected final String TEXT_1065 = ", ";
  protected final String TEXT_1066 = ".class, msgs);";
  protected final String TEXT_1067 = NL + "\t\t\tmsgs = basicUnset";
  protected final String TEXT_1068 = "(msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  protected final String TEXT_1069 = NL + "\t\t\tboolean old";
  protected final String TEXT_1070 = "ESet = eVirtualIsSet(";
  protected final String TEXT_1071 = ");";
  protected final String TEXT_1072 = NL + "\t\t\tboolean old";
  protected final String TEXT_1073 = "ESet = (";
  protected final String TEXT_1074 = " & ";
  protected final String TEXT_1075 = "_ESETFLAG) != 0;";
  ...
  protected final String TEXT_1087 = ", null, null, old";
  ...
  protected final String TEXT_1094 = "_EFLAG) != 0;";
  protected final String TEXT_1095 = NL + "\t\tObject old";
  protected final String TEXT_1096 = " = eVirtualUnset(";
  ...
  protected final String TEXT_1102 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_1103 = " != EVIRTUAL_NO_VALUE;";
  protected final String TEXT_1104 = NL + "\t\tboolean old";
  protected final String TEXT_1105 = "ESet = (";
  protected final String TEXT_1106 = " & ";
  protected final String TEXT_1107 = "_ESETFLAG) != 0;";
  ...
  protected final String TEXT_1115 = "_ESETFLAG;";
  protected final String TEXT_1116 = NL + "\t\t";
  protected final String TEXT_1117 = "ESet = false;";
  protected final String TEXT_1118 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1119 = "(this, ";
  protected final String TEXT_1120 = ".UNSET, ";
  protected final String TEXT_1121 = ", ";
  protected final String TEXT_1122 = "isSetChange ? old";
  protected final String TEXT_1123 = " : null";
  protected final String TEXT_1124 = "old";
  protected final String TEXT_1125 = ", null, ";
  protected final String TEXT_1126 = "isSetChange";
  protected final String TEXT_1127 = "old";
  protected final String TEXT_1128 = "ESet";
  protected final String TEXT_1129 = "));";
  protected final String TEXT_1130 = NL + "\t\tif (";
  protected final String TEXT_1131 = ") ";
  protected final String TEXT_1132 = " |= ";
  protected final String TEXT_1133 = "_EFLAG; else ";
  ...
  protected final String TEXT_1141 = "_ESETFLAG;";
  protected final String TEXT_1142 = NL + "\t\t";
  protected final String TEXT_1143 = "ESet = false;";
  protected final String TEXT_1144 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1145 = "(this, ";
  protected final String TEXT_1146 = ".UNSET, ";
  protected final String TEXT_1147 = ", ";
  protected final String TEXT_1148 = "isSetChange ? old";
  ...
  protected final String TEXT_1153 = "isSetChange";
  protected final String TEXT_1154 = "old";
  protected final String TEXT_1155 = "ESet";
  protected final String TEXT_1156 = "));";
  protected final String TEXT_1157 = NL + "\t\t((";
  protected final String TEXT_1158 = ".Internal)((";
  protected final String TEXT_1159 = ".Internal.Wrapper)get";
  protected final String TEXT_1160 = "()).featureMap()).clear(";
  protected final String TEXT_1161 = ");";
  protected final String TEXT_1162 = NL + "\t\t((";
  protected final String TEXT_1163 = ".Internal)get";
  protected final String TEXT_1164 = "()).clear(";
  ...
  protected final String TEXT_1170 = NL + "\t\t// TODO: implement this method to unset the '";
  protected final String TEXT_1171 = "' ";
  protected final String TEXT_1172 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1173 = NL + "\t}" + NL;
  protected final String TEXT_1174 = NL + "\t/**" + NL + "\t * Returns whether the value of the '{@link ";
  ...
  protected final String TEXT_1179 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return whether the value of the '<em>";
  protected final String TEXT_1180 = "</em>' ";
  protected final String TEXT_1181 = " is set.";
  protected final String TEXT_1182 = NL + "\t * @see #unset";
  protected final String TEXT_1183 = "()";
  protected final String TEXT_1184 = NL + "\t * @see #";
  protected final String TEXT_1185 = "()";
  protected final String TEXT_1186 = NL + "\t * @see #set";
  protected final String TEXT_1187 = "(";
  protected final String TEXT_1188 = ")";
  protected final String TEXT_1189 = NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_1193 = NL + "\tboolean isSet";
  protected final String TEXT_1194 = "();" + NL;
  protected final String TEXT_1195 = NL + "\tpublic boolean isSet";
  protected final String TEXT_1196 = "()" + NL + "\t{";
  protected final String TEXT_1197 = NL + "\t\treturn eIsSet(";
  ...
  protected final String TEXT_1208 = ").isSet();";
  protected final String TEXT_1209 = NL + "\t\treturn eVirtualIsSet(";
  protected final String TEXT_1210 = ");";
  protected final String TEXT_1211 = NL + "\t\treturn (";
  protected final String TEXT_1212 = " & ";
  protected final String TEXT_1213 = "_ESETFLAG) != 0;";
  ...
  protected final String TEXT_1217 = ".Internal)((";
  protected final String TEXT_1218 = ".Internal.Wrapper)get";
  ...
  protected final String TEXT_1222 = ".Internal)get";
  protected final String TEXT_1223 = "()).isEmpty(";
  ...
  protected final String TEXT_1228 = "(this);";
  protected final String TEXT_1229 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_1230 = "' ";
  protected final String TEXT_1231 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1232 = NL + "\t}" + NL;
  protected final String TEXT_1233 = NL;
  protected final String TEXT_1234 = NL + "\t/**" + NL + "\t * The array of subset feature identifiers for the '{@link #";
  ...
  protected final String TEXT_1239 = "_ESUBSETS = ";
  protected final String TEXT_1240 = ";" + NL;
  protected final String TEXT_1241 = NL + "\t/**" + NL + "\t * The array of superset feature identifiers for the '{@link #";
  ...
  protected final String TEXT_1246 = "_ESUPERSETS = ";
  protected final String TEXT_1247 = ";" + NL;
  protected final String TEXT_1248 = NL + "\t/**";
  protected final String TEXT_1249 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1250 = "}, with the specified ";
  protected final String TEXT_1251 = ", and appends it to the '<em><b>";
  protected final String TEXT_1252 = "</b></em>' ";
  protected final String TEXT_1253 = ".";
  protected final String TEXT_1254 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1255 = "}, with the specified ";
  protected final String TEXT_1256 = ", and sets the '<em><b>";
  protected final String TEXT_1257 = "</b></em>' ";
  protected final String TEXT_1258 = ".";
  protected final String TEXT_1259 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1260 = "} and appends it to the '<em><b>";
  ...
  protected final String TEXT_1267 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_1268 = NL + "\t * @param ";
  protected final String TEXT_1269 = " The ";
  protected final String TEXT_1270 = " for the new {@link ";
  protected final String TEXT_1271 = "}, or <code>null</code>.";
  protected final String TEXT_1272 = NL + "\t * @param eClass The Ecore class of the {@link ";
  protected final String TEXT_1273 = "} to create." + NL + "\t * @return The new {@link ";
  protected final String TEXT_1274 = "}." + NL + "\t * @see #";
  ...
  protected final String TEXT_1281 = " eClass);" + NL;
  protected final String TEXT_1282 = NL + "\t@Override";
  protected final String TEXT_1283 = NL + "\tpublic ";
  protected final String TEXT_1284 = " create";
  protected final String TEXT_1285 = "(";
  protected final String TEXT_1286 = ", ";
  protected final String TEXT_1287 = " eClass)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1288 = " new";
  protected final String TEXT_1289 = " = (";
  protected final String TEXT_1290 = ") create(eClass);";
  protected final String TEXT_1291 = NL + "\t\t";
  protected final String TEXT_1292 = "().add(new";
  protected final String TEXT_1293 = ");";
  protected final String TEXT_1294 = NL + "\t\tset";
  protected final String TEXT_1295 = "(new";
  protected final String TEXT_1296 = ");";
  protected final String TEXT_1297 = NL + "\t\tint ";
  protected final String TEXT_1298 = "ListSize = 0;";
  protected final String TEXT_1299 = NL + "\t\tint ";
  protected final String TEXT_1300 = "Size = ";
  protected final String TEXT_1301 = " == null ? 0 : ";
  protected final String TEXT_1302 = ".size();" + NL + "\t\tif (";
  protected final String TEXT_1303 = "Size > ";
  protected final String TEXT_1304 = "ListSize)" + NL + "\t\t\t";
  protected final String TEXT_1305 = "ListSize = ";
  protected final String TEXT_1306 = "Size;";
  protected final String TEXT_1307 = NL + "\t\tfor (int i = 0; i < ";
  protected final String TEXT_1308 = "ListSize; i++) {" + NL + "\t\t\tnew";
  protected final String TEXT_1309 = ".create";
  protected final String TEXT_1310 = "(";
  protected final String TEXT_1311 = ", ";
  protected final String TEXT_1312 = "i < ";
  protected final String TEXT_1313 = "Size ? (";
  protected final String TEXT_1314 = ") ";
  protected final String TEXT_1315 = ".get(i) : null";
  protected final String TEXT_1316 = ");" + NL + "\t\t}";
  protected final String TEXT_1317 = NL + "\t\tnew";
  protected final String TEXT_1318 = ".create";
  ...
  protected final String TEXT_1326 = "().addAll(";
  protected final String TEXT_1327 = ");";
  protected final String TEXT_1328 = NL + "\t\t\tnew";
  protected final String TEXT_1329 = ".set";
  ...
  protected final String TEXT_1335 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1336 = "}, with the specified ";
  protected final String TEXT_1337 = ", and appends it to the '<em><b>";
  protected final String TEXT_1338 = "</b></em>' ";
  protected final String TEXT_1339 = ".";
  protected final String TEXT_1340 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1341 = "},with the specified ";
  protected final String TEXT_1342 = ", and sets the '<em><b>";
  protected final String TEXT_1343 = "</b></em>' ";
  protected final String TEXT_1344 = ".";
  protected final String TEXT_1345 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_1346 = "} and appends it to the '<em><b>";
  ...
  protected final String TEXT_1353 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_1354 = NL + "\t * @param ";
  protected final String TEXT_1355 = " The ";
  protected final String TEXT_1356 = " for the new {@link ";
  protected final String TEXT_1357 = "}, or <code>null</code>.";
  protected final String TEXT_1358 = NL + "\t * @return The new {@link ";
  ...
  protected final String TEXT_1378 = ") create(";
  protected final String TEXT_1379 = ");";
  protected final String TEXT_1380 = NL + "\t\t";
  protected final String TEXT_1381 = "().add(new";
  protected final String TEXT_1382 = ");";
  protected final String TEXT_1383 = NL + "\t\tset";
  protected final String TEXT_1384 = "(new";
  protected final String TEXT_1385 = ");";
  protected final String TEXT_1386 = NL + "\t\tint ";
  protected final String TEXT_1387 = "ListSize = 0;";
  protected final String TEXT_1388 = NL + "\t\tint ";
  protected final String TEXT_1389 = "Size = ";
  protected final String TEXT_1390 = " == null ? 0 : ";
  protected final String TEXT_1391 = ".size();" + NL + "\t\tif (";
  protected final String TEXT_1392 = "Size > ";
  protected final String TEXT_1393 = "ListSize)" + NL + "\t\t\t";
  protected final String TEXT_1394 = "ListSize = ";
  protected final String TEXT_1395 = "Size;";
  protected final String TEXT_1396 = NL + "\t\tfor (int i = 0; i < ";
  protected final String TEXT_1397 = "ListSize; i++) {" + NL + "\t\t\tnew";
  protected final String TEXT_1398 = ".create";
  protected final String TEXT_1399 = "(";
  protected final String TEXT_1400 = ", ";
  protected final String TEXT_1401 = "i < ";
  protected final String TEXT_1402 = "Size ? (";
  protected final String TEXT_1403 = ") ";
  protected final String TEXT_1404 = ".get(i) : null";
  protected final String TEXT_1405 = ");" + NL + "\t\t}";
  protected final String TEXT_1406 = NL + "\t\tnew";
  protected final String TEXT_1407 = ".create";
  ...
  protected final String TEXT_1421 = NL + "\t\treturn new";
  ...
  protected final String TEXT_1433 = NL + "\t * @return The first {@link ";
  protected final String TEXT_1434 = "} with the specified ";
  protected final String TEXT_1435 = ", or <code>null</code>." + NL + "\t * @see #";
  protected final String TEXT_1436 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1437 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1438 = NL + "\t";
  protected final String TEXT_1439 = " get";
  protected final String TEXT_1440 = "(";
  protected final String TEXT_1441 = ");" + NL;
  protected final String TEXT_1442 = NL + "\t@Override";
  protected final String TEXT_1443 = NL + "\tpublic ";
  protected final String TEXT_1444 = " get";
  protected final String TEXT_1445 = "(";
  protected final String TEXT_1446 = ")" + NL + "\t{" + NL + "\t\treturn get";
  protected final String TEXT_1447 = "(";
  protected final String TEXT_1448 = ", false";
  protected final String TEXT_1449 = ", null";
  protected final String TEXT_1450 = ", false";
  ...
  protected final String TEXT_1461 = NL + "\t * @param ignoreCase Whether to ignore case in {@link java.lang.String} comparisons.";
  protected final String TEXT_1462 = NL + "\t * @param eClass The Ecore class of the {@link ";
  protected final String TEXT_1463 = "} to retrieve, or <code>null</code>.";
  protected final String TEXT_1464 = NL + "\t * @param createOnDemand Whether to create a {@link ";
  protected final String TEXT_1465 = "} on demand if not found.";
  protected final String TEXT_1466 = NL + "\t * @return The first {@link ";
  protected final String TEXT_1467 = "} with the specified ";
  protected final String TEXT_1468 = ", or <code>null</code>." + NL + "\t * @see #";
  protected final String TEXT_1469 = "()" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_1474 = ", boolean ignoreCase";
  protected final String TEXT_1475 = ", ";
  protected final String TEXT_1476 = " eClass";
  protected final String TEXT_1477 = ", boolean createOnDemand";
  protected final String TEXT_1478 = ");" + NL;
  protected final String TEXT_1479 = NL + "\t@Override";
  protected final String TEXT_1480 = NL + "\tpublic ";
  protected final String TEXT_1481 = " get";
  protected final String TEXT_1482 = "(";
  protected final String TEXT_1483 = ", boolean ignoreCase";
  protected final String TEXT_1484 = ", ";
  protected final String TEXT_1485 = " eClass";
  protected final String TEXT_1486 = ", boolean createOnDemand";
  protected final String TEXT_1487 = ")" + NL + "\t{";
  protected final String TEXT_1488 = NL + "\t\t";
  protected final String TEXT_1489 = "Loop: for (";
  ...
  protected final String TEXT_1494 = "Loop: for (";
  protected final String TEXT_1495 = " i = ";
  protected final String TEXT_1496 = "().iterator(); i.hasNext(); )" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_1497 = " ";
  protected final String TEXT_1498 = " = (";
  protected final String TEXT_1499 = ") i.next();";
  protected final String TEXT_1500 = NL + "\t\t\tif (eClass != null && !eClass.isInstance(";
  protected final String TEXT_1501 = "))" + NL + "\t\t\t\tcontinue ";
  protected final String TEXT_1502 = "Loop;";
  protected final String TEXT_1503 = NL + "\t\t\t";
  protected final String TEXT_1504 = " ";
  protected final String TEXT_1505 = "List = ";
  protected final String TEXT_1506 = ".";
  protected final String TEXT_1507 = "();" + NL + "\t\t\tint ";
  protected final String TEXT_1508 = "ListSize = ";
  protected final String TEXT_1509 = "List.size();" + NL + "\t\t\tif (";
  protected final String TEXT_1510 = " || (";
  protected final String TEXT_1511 = " != null && ";
  protected final String TEXT_1512 = ".size() != ";
  protected final String TEXT_1513 = "ListSize";
  protected final String TEXT_1514 = ")";
  protected final String TEXT_1515 = ")" + NL + "\t\t\t\tcontinue  ";
  protected final String TEXT_1516 = "Loop;" + NL + "\t\t\tfor (int j = 0; j < ";
  protected final String TEXT_1517 = "ListSize; j++)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_1522 = "List.get(j);";
  protected final String TEXT_1523 = NL + "\t\t\t\tif (";
  protected final String TEXT_1524 = " != null && !(ignoreCase ? (";
  protected final String TEXT_1525 = "(";
  protected final String TEXT_1526 = ")";
  protected final String TEXT_1527 = ".get(j)).equalsIgnoreCase(";
  protected final String TEXT_1528 = ".";
  protected final String TEXT_1529 = "()) : ";
  protected final String TEXT_1530 = ".get(j).equals(";
  ...
  protected final String TEXT_1535 = ".get(j).equals(";
  protected final String TEXT_1536 = ".";
  protected final String TEXT_1537 = "()))";
  protected final String TEXT_1538 = NL + "\t\t\t\t\tcontinue ";
  protected final String TEXT_1539 = "Loop;";
  ...
  protected final String TEXT_1546 = " == null)" + NL + "\t\t\t\tcontinue ";
  protected final String TEXT_1547 = "Loop;";
  protected final String TEXT_1548 = NL + "\t\t\tif (";
  protected final String TEXT_1549 = " != null && !(ignoreCase ? ";
  protected final String TEXT_1550 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_1561 = NL + "\t\t\t\tcontinue ";
  protected final String TEXT_1562 = "Loop;";
  protected final String TEXT_1563 = NL + "\t\t\tif (";
  protected final String TEXT_1564 = " != null && !(ignoreCase ? ";
  protected final String TEXT_1565 = ".equalsIgnoreCase(";
  protected final String TEXT_1566 = ".";
  protected final String TEXT_1567 = "()) : ";
  protected final String TEXT_1568 = ".equals(";
  ...
  protected final String TEXT_1576 = NL + "\t\t\t\tcontinue ";
  protected final String TEXT_1577 = "Loop;";
  protected final String TEXT_1578 = NL + "\t\t\treturn ";
  protected final String TEXT_1579 = ";" + NL + "\t\t}";
  protected final String TEXT_1580 = NL + "\t\treturn createOnDemand";
  protected final String TEXT_1581 = " && eClass != null";
  protected final String TEXT_1582 = " ? create";
  protected final String TEXT_1583 = "(";
  protected final String TEXT_1584 = ", eClass";
  protected final String TEXT_1585 = ") : null;";
  protected final String TEXT_1586 = NL + "\t\treturn null;";
  protected final String TEXT_1587 = NL + "\t}" + NL;
  protected final String TEXT_1588 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_1589 = "()" + NL + "\t{";
  protected final String TEXT_1590 = NL + "  \t\treturn false;";
  protected final String TEXT_1591 = NL + "\t\treturn eIsSet(";
  protected final String TEXT_1592 = ");";
  protected final String TEXT_1593 = NL + "\t\treturn !((";
  protected final String TEXT_1594 = ".Internal.Wrapper)";
  ...
  protected final String TEXT_1598 = ".featureMap().isEmpty();";
  ...
  protected final String TEXT_1605 = ")eVirtualGet(";
  ...
  protected final String TEXT_1610 = "().isEmpty();";
  ...
  protected final String TEXT_1625 = "_EFLAG) != 0) != ";
  ...
  protected final String TEXT_1630 = NL + "\t\treturn eVirtualGet(";
  ...
  protected final String TEXT_1640 = ".equals(";
  ...
  protected final String TEXT_1645 = ")eVirtualGet(";
  ...
  protected final String TEXT_1677 = ".Internal)((";
  protected final String TEXT_1678 = ".Internal.Wrapper)get";
  protected final String TEXT_1679 = "()).featureMap()).isEmpty(";
  protected final String TEXT_1680 = ");";
  protected final String TEXT_1681 = NL + "\t\treturn !((";
  protected final String TEXT_1682 = ".Internal)get";
  protected final String TEXT_1683 = "()).isEmpty(";
  ...
  protected final String TEXT_1689 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_1690 = "' ";
  protected final String TEXT_1691 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1692 = NL + "\t}" + NL;
  protected final String TEXT_1693 = NL;
  protected final String TEXT_1694 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_1695 = NL + "\t * <!-- begin-model-doc -->";
  protected final String TEXT_1696 = NL + "\t * ";
  protected final String TEXT_1697 = NL + "\t * @param ";
  protected final String TEXT_1698 = NL + "\t *   ";
  protected final String TEXT_1699 = NL + "\t * @param ";
  protected final String TEXT_1700 = " ";
  protected final String TEXT_1701 = NL + "\t * <!-- end-model-doc -->";
  protected final String TEXT_1702 = NL + "\t * @model ";
  protected final String TEXT_1703 = NL + "\t *        ";
  protected final String TEXT_1704 = NL + "\t * @model";
  ...
  protected final String TEXT_1708 = NL + "\t@Override";
  ...
  protected final String TEXT_1725 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// -> specify the condition that violates the invariant" + NL + "\t\t// -> verify the details of the diagnostic, including severity and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_1726 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_1727 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_1728 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_1729 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1730 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1731 = ".";
  protected final String TEXT_1732 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1733 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_1734 = "\", ";
  protected final String TEXT_1735 = ".getObjectLabel(this, ";
  protected final String TEXT_1736 = ") }),";
  protected final String TEXT_1737 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  ...
  protected final String TEXT_1744 = " cache = getCacheAdapter();" + NL + "\t\tif (cache != null)" + NL + "\t\t{";
  protected final String TEXT_1745 = NL + "\t\t\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1746 = NL + "\t\t\t";
  protected final String TEXT_1747 = " result = (";
  protected final String TEXT_1748 = ") cache.get(";
  protected final String TEXT_1749 = "eResource(), ";
  protected final String TEXT_1750 = "this, ";
  protected final String TEXT_1751 = ".getEOperations().get(";
  protected final String TEXT_1752 = "));" + NL + "\t\t\tif (result == null)" + NL + "\t\t\t{" + NL + "\t\t\t\tcache.put(";
  protected final String TEXT_1753 = "eResource(), ";
  protected final String TEXT_1754 = "this, ";
  protected final String TEXT_1755 = ".getEOperations().get(";
  protected final String TEXT_1756 = "), result = ";
  ...
  protected final String TEXT_1764 = ");" + NL + "\t\t\t}" + NL + "\t\t\treturn result";
  ...
  protected final String TEXT_1770 = "(this";
  protected final String TEXT_1771 = ", ";
  protected final String TEXT_1772 = ");";
  protected final String TEXT_1773 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1774 = NL + "\t}" + NL;
  protected final String TEXT_1775 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1776 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1777 = NL + "\t@Override";
  protected final String TEXT_1778 = NL + "\tpublic ";
  protected final String TEXT_1779 = " eInverseAdd(";
  protected final String TEXT_1780 = " otherEnd, int featureID, ";
  protected final String TEXT_1781 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  ...
  protected final String TEXT_1786 = ".InternalMapView";
  protected final String TEXT_1787 = ")";
  protected final String TEXT_1788 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_1789 = NL + "\t\t\t\treturn (";
  protected final String TEXT_1790 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_1791 = NL + "\t\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);";
  protected final String TEXT_1792 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1793 = "((";
  protected final String TEXT_1794 = ")otherEnd, msgs);";
  protected final String TEXT_1795 = NL + "\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_1796 = ", msgs);";
  protected final String TEXT_1797 = NL + "\t\t\t\t";
  protected final String TEXT_1798 = " ";
  protected final String TEXT_1799 = " = (";
  protected final String TEXT_1800 = ")eVirtualGet(";
  protected final String TEXT_1801 = ");";
  protected final String TEXT_1802 = NL + "\t\t\t\tif (";
  protected final String TEXT_1803 = " != null)";
  protected final String TEXT_1804 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1805 = ")";
  protected final String TEXT_1806 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_1807 = ", null, msgs);";
  protected final String TEXT_1808 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1809 = ")";
  protected final String TEXT_1810 = ").eInverseRemove(this, ";
  protected final String TEXT_1811 = ", ";
  protected final String TEXT_1812 = ".class, msgs);";
  protected final String TEXT_1813 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1814 = "((";
  protected final String TEXT_1815 = ")otherEnd, msgs);";
  protected final String TEXT_1816 = NL + "\t\t}";
  protected final String TEXT_1817 = NL + "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_1818 = NL + "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_1819 = NL + "\t}" + NL;
  ...
  protected final String TEXT_1822 = NL + "\tpublic ";
  protected final String TEXT_1823 = " eInverseRemove(";
  protected final String TEXT_1824 = " otherEnd, int featureID, ";
  protected final String TEXT_1825 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1826 = NL + "\t\t\tcase ";
  protected final String TEXT_1827 = ":";
  protected final String TEXT_1828 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1829 = ")((";
  protected final String TEXT_1830 = ".InternalMapView";
  protected final String TEXT_1831 = ")";
  protected final String TEXT_1832 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1833 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1834 = ")((";
  protected final String TEXT_1835 = ".Internal.Wrapper)";
  protected final String TEXT_1836 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1837 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1838 = ")";
  protected final String TEXT_1839 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1840 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_1841 = ", msgs);";
  protected final String TEXT_1842 = NL + "\t\t\t\treturn basicUnset";
  protected final String TEXT_1843 = "(msgs);";
  protected final String TEXT_1844 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1845 = "(null, msgs);";
  protected final String TEXT_1846 = NL + "\t\t}";
  protected final String TEXT_1847 = NL + "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1848 = NL + "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1849 = NL + "\t}" + NL;
  protected final String TEXT_1850 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1851 = NL + "\t@Override";
  protected final String TEXT_1852 = NL + "\tpublic ";
  protected final String TEXT_1853 = " eBasicRemoveFromContainerFeature(";
  protected final String TEXT_1854 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID)" + NL + "\t\t{";
  protected final String TEXT_1855 = NL + "\t\t\tcase ";
  protected final String TEXT_1856 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
  protected final String TEXT_1857 = ", ";
  protected final String TEXT_1858 = ".class, msgs);";
  protected final String TEXT_1859 = NL + "\t\t}";
  protected final String TEXT_1860 = NL + "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
  protected final String TEXT_1861 = NL + "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
  ...
  protected final String TEXT_1865 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1866 = NL + "\t\t\tcase ";
  protected final String TEXT_1867 = ":";
  protected final String TEXT_1868 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1869 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_1870 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_1871 = "(";
  protected final String TEXT_1872 = "());";
  protected final String TEXT_1873 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_1874 = "();" + NL + "\t\t\t\treturn basicGet";
  ...
  protected final String TEXT_1879 = "()).eMap();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1880 = "();";
  protected final String TEXT_1881 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_1882 = "();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1883 = "().map();";
  protected final String TEXT_1884 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_1885 = ".Internal.Wrapper)";
  protected final String TEXT_1886 = "()).featureMap();" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1887 = "();";
  protected final String TEXT_1888 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_1889 = "();" + NL + "\t\t\t\treturn ((";
  protected final String TEXT_1890 = ".Internal)";
  protected final String TEXT_1891 = "()).getWrapper();";
  protected final String TEXT_1892 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1893 = "();";
  protected final String TEXT_1894 = NL + "\t\t}";
  protected final String TEXT_1895 = NL + "\t\treturn super.eGet(featureID, resolve, coreType);";
  protected final String TEXT_1896 = NL + "\t\treturn eDynamicGet(featureID, resolve, coreType);";
  ...
  protected final String TEXT_1899 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1900 = NL + "\t@Override";
  protected final String TEXT_1901 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1902 = NL + "\t\t\tcase ";
  ...
  protected final String TEXT_1907 = "()).featureMap()).set(newValue);";
  protected final String TEXT_1908 = NL + "\t\t\t\t((";
  protected final String TEXT_1909 = ".Internal)";
  protected final String TEXT_1910 = "()).set(newValue);";
  protected final String TEXT_1911 = NL + "\t\t\t\t((";
  protected final String TEXT_1912 = ".Setting)((";
  protected final String TEXT_1913 = ".InternalMapView";
  protected final String TEXT_1914 = ")";
  protected final String TEXT_1915 = "()).eMap()).set(newValue);";
  protected final String TEXT_1916 = NL + "\t\t\t\t((";
  protected final String TEXT_1917 = ".Setting)";
  protected final String TEXT_1918 = "()).set(newValue);";
  protected final String TEXT_1919 = NL + "\t\t\t\t";
  protected final String TEXT_1920 = "().clear();" + NL + "\t\t\t\t";
  protected final String TEXT_1921 = "().addAll((";
  protected final String TEXT_1922 = "<? extends ";
  ...
  protected final String TEXT_1927 = ")newValue).";
  protected final String TEXT_1928 = "());";
  protected final String TEXT_1929 = NL + "\t\t\t\tset";
  protected final String TEXT_1930 = "(";
  protected final String TEXT_1931 = "(";
  protected final String TEXT_1932 = ")";
  protected final String TEXT_1933 = "newValue);";
  protected final String TEXT_1934 = NL + "\t\t\t\treturn;";
  protected final String TEXT_1935 = NL + "\t\t}";
  protected final String TEXT_1936 = NL + "\t\tsuper.eSet(featureID, newValue);";
  protected final String TEXT_1937 = NL + "\t\teDynamicSet(featureID, newValue);";
  protected final String TEXT_1938 = NL + "\t}" + NL;
  protected final String TEXT_1939 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1940 = NL + "\t@Override";
  protected final String TEXT_1941 = NL + "\tpublic void eUnset(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1942 = NL + "\t\t\tcase ";
  protected final String TEXT_1943 = ":";
  protected final String TEXT_1944 = NL + "\t\t\t\t((";
  protected final String TEXT_1945 = ".Internal.Wrapper)";
  protected final String TEXT_1946 = "()).featureMap().clear();";
  protected final String TEXT_1947 = NL + "\t\t\t\t";
  protected final String TEXT_1948 = "().clear();";
  protected final String TEXT_1949 = NL + "\t\t\t\tunset";
  ...
  protected final String TEXT_1954 = NL + "\t\t\t\tset";
  ...
  protected final String TEXT_1959 = NL + "\t\tsuper.eUnset(featureID);";
  protected final String TEXT_1960 = NL + "\t\teDynamicUnset(featureID);";
  protected final String TEXT_1961 = NL + "\t}" + NL;
  protected final String TEXT_1962 = NL;
  protected final String TEXT_1963 = "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1964 = NL + "\t@Override";
  protected final String TEXT_1965 = NL + "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1966 = NL + "\t\t\tcase ";
  protected final String TEXT_1967 = ":";
  protected final String TEXT_1968 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_1969 = "();";
  protected final String TEXT_1970 = NL + "\t\t\t\treturn !((";
  protected final String TEXT_1971 = ".Internal.Wrapper)";
  ...
  protected final String TEXT_2004 = "_EFLAG) != 0) != ";
  protected final String TEXT_2005 = ";";
  protected final String TEXT_2006 = NL + "\t\t\t\treturn ";
  protected final String TEXT_2007 = " != ";
  protected final String TEXT_2008 = ";";
  protected final String TEXT_2009 = NL + "\t\t\t\treturn eVirtualGet(";
  ...
  protected final String TEXT_2018 = " != null : !";
  protected final String TEXT_2019 = ".equals(";
  ...
  protected final String TEXT_2024 = ")eVirtualGet(";
  ...
  protected final String TEXT_2029 = ".equals(";
  ...
  protected final String TEXT_2034 = ".equals(";
  protected final String TEXT_2035 = "());";
  protected final String TEXT_2036 = NL + "\t\t}";
  protected final String TEXT_2037 = NL + "\t\treturn super.eIsSet(featureID);";
  protected final String TEXT_2038 = NL + "\t\treturn eDynamicIsSet(featureID);";
  protected final String TEXT_2039 = NL + "\t}" + NL;
  ...
  protected final String TEXT_2042 = NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class";
  protected final String TEXT_2043 = " baseClass)" + NL + "\t{";
  protected final String TEXT_2044 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_2045 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_2046 = NL + "\t\t\t\tcase ";
  protected final String TEXT_2047 = ": return ";
  protected final String TEXT_2048 = ";";
  protected final String TEXT_2049 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_2050 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2051 = NL + "\t@Override";
  protected final String TEXT_2052 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
  protected final String TEXT_2053 = " baseClass)" + NL + "\t{";
  protected final String TEXT_2054 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_2055 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_2056 = NL + "\t\t\t\tcase ";
  protected final String TEXT_2057 = ": return ";
  protected final String TEXT_2058 = ";";
  protected final String TEXT_2059 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_2060 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_2061 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2062 = NL + "\t@Override";
  protected final String TEXT_2063 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_2064 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2065 = NL + "\t@Override";
  protected final String TEXT_2066 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_2067 = " = newValues;" + NL + "\t}" + NL;
  protected final String TEXT_2068 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2069 = NL + "\t@Override";
  protected final String TEXT_2070 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_2071 = NL + "\t\t\tcase ";
  protected final String TEXT_2072 = " :" + NL + "\t\t\t\treturn ";
  protected final String TEXT_2073 = ";";
  protected final String TEXT_2074 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2075 = NL + "\t@Override";
  protected final String TEXT_2076 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_2077 = NL + "\t\t\tcase ";
  protected final String TEXT_2078 = " :" + NL + "\t\t\t\t";
  protected final String TEXT_2079 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
  protected final String TEXT_2080 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_2081 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2082 = NL + "\t@Override";
  protected final String TEXT_2083 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\tStringBuffer result = new StringBuffer(super.toString());";
  protected final String TEXT_2084 = NL + "\t\tresult.append(\" (";
  protected final String TEXT_2085 = ": \");";
  protected final String TEXT_2086 = NL + "\t\tresult.append(\", ";
  protected final String TEXT_2087 = ": \");";
  protected final String TEXT_2088 = NL + "\t\tif (eVirtualIsSet(";
  protected final String TEXT_2089 = ")) result.append(eVirtualGet(";
  protected final String TEXT_2090 = ")); else result.append(\"<unset>\");";
  ...
  protected final String TEXT_2098 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  protected final String TEXT_2099 = NL + "\t\tif (";
  protected final String TEXT_2100 = "(";
  protected final String TEXT_2101 = " & ";
  protected final String TEXT_2102 = "_ESETFLAG) != 0";
  protected final String TEXT_2103 = "ESet";
  protected final String TEXT_2104 = ") result.append(";
  protected final String TEXT_2105 = "); else result.append(\"<unset>\");";
  protected final String TEXT_2106 = NL + "\t\tresult.append(eVirtualGet(";
  ...
  protected final String TEXT_2111 = "_EFLAG) != 0);";
  protected final String TEXT_2112 = NL + "\t\tresult.append(";
  protected final String TEXT_2113 = ");";
  protected final String TEXT_2114 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_2115 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2116 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_2117 = " getKey()" + NL + "\t{";
  protected final String TEXT_2118 = NL + "\t\treturn new ";
  protected final String TEXT_2119 = "(getTypedKey());";
  protected final String TEXT_2120 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_2121 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(";
  protected final String TEXT_2122 = " key)" + NL + "\t{";
  protected final String TEXT_2123 = NL + "\t\tgetTypedKey().addAll(";
  protected final String TEXT_2124 = "(";
  protected final String TEXT_2125 = ")";
  protected final String TEXT_2126 = "key);";
  protected final String TEXT_2127 = NL + "\t\tsetTypedKey(key);";
  protected final String TEXT_2128 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_2129 = ")key).";
  protected final String TEXT_2130 = "());";
  protected final String TEXT_2131 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_2132 = ")key);";
  protected final String TEXT_2133 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_2134 = " getValue()" + NL + "\t{";
  protected final String TEXT_2135 = NL + "\t\treturn new ";
  protected final String TEXT_2136 = "(getTypedValue());";
  protected final String TEXT_2137 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_2138 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_2139 = " setValue(";
  protected final String TEXT_2140 = " value)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_2141 = " oldValue = getValue();";
  protected final String TEXT_2142 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
  protected final String TEXT_2143 = "(";
  protected final String TEXT_2144 = ")";
  protected final String TEXT_2145 = "value);";
  protected final String TEXT_2146 = NL + "\t\tsetTypedValue(value);";
  protected final String TEXT_2147 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_2148 = ")value).";
  protected final String TEXT_2149 = "());";
  protected final String TEXT_2150 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_2151 = ")value);";
  protected final String TEXT_2152 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2153 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_2154 = NL + "\tpublic ";
  protected final String TEXT_2155 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_2156 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_2157 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
  protected final String TEXT_2158 = NL;
  protected final String TEXT_2159 = NL + "\t/**" + NL + "\t * Creates a new instance of the specified Ecore class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param eClass The Ecore class of the instance to create." + NL + "\t * @return The new instance." + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_2160 = " create(";
  protected final String TEXT_2161 = " eClass)" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_2162 = ".create(eClass);" + NL + "\t}" + NL;
  protected final String TEXT_2163 = NL + "\t/**" + NL + "\t * Retrieves the cache adapter for this '<em><b>";
  protected final String TEXT_2164 = "</b></em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return The cache adapter for this '<em><b>";
  protected final String TEXT_2165 = "</b></em>'." + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_2166 = " getCacheAdapter()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_2167 = ".getCacheAdapter(this);" + NL + "\t}" + NL;
  protected final String TEXT_2168 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2169 = NL + "\t@Override";
  protected final String TEXT_2170 = NL + "\tprotected ";
  protected final String TEXT_2171 = " ";
  protected final String TEXT_2172 = "Helper(";
  protected final String TEXT_2173 = " ";
  protected final String TEXT_2174 = ")" + NL + "\t{";
  protected final String TEXT_2175 = NL + "\t\t";
  protected final String TEXT_2176 = ".addAll(super.";
  protected final String TEXT_2177 = "());";
  protected final String TEXT_2178 = NL + "\t\tsuper.";
  protected final String TEXT_2179 = "Helper(";
  protected final String TEXT_2180 = ");";
  protected final String TEXT_2181 = NL + "\t\tif (isSet";
  ...
  protected final String TEXT_2189 = NL + "\t\tif (eIsSet(";
  protected final String TEXT_2190 = "))" + NL + "\t\t{" + NL + "\t\t\tfor (";
  protected final String TEXT_2191 = "<";
  protected final String TEXT_2192 = ">";
  protected final String TEXT_2193 = " i = ((";
  protected final String TEXT_2194 = ") ";
  protected final String TEXT_2195 = "()).basicIterator(); i.hasNext(); )" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_2196 = ".add(i.next());" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_2197 = NL + "\t\t";
  protected final String TEXT_2198 = " ";
  protected final String TEXT_2199 = " = ";
  protected final String TEXT_2200 = "();" + NL + "\t\tif (!";
  protected final String TEXT_2201 = ".isEmpty())" + NL + "\t\t{" + NL + "\t\t\tfor (";
  protected final String TEXT_2202 = "<";
  protected final String TEXT_2203 = ">";
  protected final String TEXT_2204 = " i = ((";
  protected final String TEXT_2205 = ") ";
  protected final String TEXT_2206 = ").basicIterator(); i.hasNext(); )" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_2207 = ".add(i.next());" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_2208 = NL + "\t\tif (isSet";
  protected final String TEXT_2209 = "())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2210 = ".addAll(";
  protected final String TEXT_2211 = "());" + NL + "\t\t}";
  protected final String TEXT_2212 = NL + "\t\tif (eIsSet(";
  protected final String TEXT_2213 = "))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2214 = ".addAll(";
  ...
  protected final String TEXT_2220 = ".isEmpty())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2221 = ".addAll(";
  protected final String TEXT_2222 = ");" + NL + "\t\t}";
  protected final String TEXT_2223 = NL + "\t\tif (isSet";
  protected final String TEXT_2224 = "())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2225 = ".add(";
  protected final String TEXT_2226 = "basicGet";
  ...
  protected final String TEXT_2232 = "();" + NL + "\t\tif (";
  protected final String TEXT_2233 = " != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2234 = ".add(";
  protected final String TEXT_2235 = ");" + NL + "\t\t}";
  protected final String TEXT_2236 = NL + "\t\treturn ";
  protected final String TEXT_2237 = ";" + NL + "\t}" + NL;
  protected final String TEXT_2238 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2239 = NL;
  protected final String TEXT_2240 = NL + "\t@Override";
  protected final String TEXT_2241 = NL + "\tpublic boolean isSet";
  protected final String TEXT_2242 = "()" + NL + "\t{";
  protected final String TEXT_2243 = NL + "\t\treturn super.isSet";
  protected final String TEXT_2244 = "()";
  protected final String TEXT_2245 = NL + "\t\treturn isSet";
  ...
  protected final String TEXT_2290 = NL + "\t\treturn new ";
  protected final String TEXT_2291 = ".UnmodifiableEList";
  protected final String TEXT_2292 = "(this, ";
  protected final String TEXT_2293 = "null";
  protected final String TEXT_2294 = ", 0, ";
  protected final String TEXT_2295 = ".EMPTY_LIST.toArray());";
  protected final String TEXT_2296 = NL + "\t\treturn null;";
  protected final String TEXT_2297 = NL + "\t\treturn ";
  protected final String TEXT_2298 = "();";
  protected final String TEXT_2299 = NL + "\t}" + NL;
  protected final String TEXT_2300 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2301 = NL;
  protected final String TEXT_2302 = NL + "\t@Override";
  protected final String TEXT_2303 = NL + "\tpublic ";
  protected final String TEXT_2304 = " basicGet";
  protected final String TEXT_2305 = "()" + NL + "\t{";
  protected final String TEXT_2306 = NL + "\t\treturn null;";
  protected final String TEXT_2307 = NL + "\t\treturn ";
  protected final String TEXT_2308 = "basicGet";
  ...
  protected final String TEXT_2313 = NL + "\t@Override";
  protected final String TEXT_2314 = NL + "\tpublic ";
  protected final String TEXT_2315 = " basicSet";
  protected final String TEXT_2316 = "(";
  protected final String TEXT_2317 = " new";
  protected final String TEXT_2318 = ", ";
  protected final String TEXT_2319 = " msgs)" + NL + "\t{";
  protected final String TEXT_2320 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_2321 = NL + "\t\tif (new";
  protected final String TEXT_2322 = " != null && !(new";
  protected final String TEXT_2323 = " instanceof ";
  protected final String TEXT_2324 = "))" + NL + "\t\t{" + NL + "\t\t\tthrow new IllegalArgumentException(String.valueOf(new";
  protected final String TEXT_2325 = "));" + NL + "\t\t}";
  protected final String TEXT_2326 = NL + "\t\treturn basicSet";
  protected final String TEXT_2327 = "(";
  protected final String TEXT_2328 = "(";
  protected final String TEXT_2329 = ") ";
  protected final String TEXT_2330 = "new";
  protected final String TEXT_2331 = ", msgs);";
  protected final String TEXT_2332 = NL + "\t\tset";
  ...
  protected final String TEXT_2337 = ");" + NL + "\t\treturn msgs;";
  protected final String TEXT_2338 = NL + "\t}" + NL;
  protected final String TEXT_2339 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_2359 = NL;
  protected final String TEXT_2360 = NL + "\t/**" + NL + "\t * The array of subset feature identifiers for the '{@link #";
  protected final String TEXT_2361 = "() <em>";
  protected final String TEXT_2362 = "</em>}' ";
  protected final String TEXT_2363 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_2364 = "()" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\tprotected static final int[] ";
  protected final String TEXT_2365 = "_ESUBSETS = ";
  protected final String TEXT_2366 = ";" + NL;
  protected final String TEXT_2367 = NL + "\t/**" + NL + "\t * The array of superset feature identifiers for the '{@link #";
  protected final String TEXT_2368 = "() <em>";
  protected final String TEXT_2369 = "</em>}' ";
  protected final String TEXT_2370 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_2371 = "()" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\tprotected static final int[] ";
  protected final String TEXT_2372 = "_ESUPERSETS = ";
  protected final String TEXT_2373 = ";" + NL;
  protected final String TEXT_2374 = NL + "\t/**";
  protected final String TEXT_2375 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2376 = "}, with the specified ";
  protected final String TEXT_2377 = ", and appends it to the '<em><b>";
  protected final String TEXT_2378 = "</b></em>' ";
  protected final String TEXT_2379 = ".";
  protected final String TEXT_2380 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2381 = "}, with the specified ";
  protected final String TEXT_2382 = ", and sets the '<em><b>";
  protected final String TEXT_2383 = "</b></em>' ";
  protected final String TEXT_2384 = ".";
  protected final String TEXT_2385 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2386 = "} and appends it to the '<em><b>";
  protected final String TEXT_2387 = "</b></em>' ";
  protected final String TEXT_2388 = ".";
  protected final String TEXT_2389 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2390 = "} and sets the '<em><b>";
  protected final String TEXT_2391 = "</b></em>' ";
  protected final String TEXT_2392 = ".";
  protected final String TEXT_2393 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_2394 = NL + "\t * @param ";
  protected final String TEXT_2395 = " The ";
  protected final String TEXT_2396 = " for the new {@link ";
  protected final String TEXT_2397 = "}, or <code>null</code>.";
  protected final String TEXT_2398 = NL + "\t * @param eClass The Ecore class of the {@link ";
  protected final String TEXT_2399 = "} to create." + NL + "\t * @return The new {@link ";
  protected final String TEXT_2400 = "}." + NL + "\t * @see #";
  ...
  protected final String TEXT_2404 = " create";
  protected final String TEXT_2405 = "(";
  protected final String TEXT_2406 = ", ";
  protected final String TEXT_2407 = " eClass);" + NL;
  protected final String TEXT_2408 = NL + "\t@Override";
  protected final String TEXT_2409 = NL + "\tpublic ";
  protected final String TEXT_2410 = " create";
  protected final String TEXT_2411 = "(";
  protected final String TEXT_2412 = ", ";
  protected final String TEXT_2413 = " eClass)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_2414 = " new";
  protected final String TEXT_2415 = " = (";
  protected final String TEXT_2416 = ") create(eClass);";
  protected final String TEXT_2417 = NL + "\t\t";
  protected final String TEXT_2418 = "().add(new";
  protected final String TEXT_2419 = ");";
  protected final String TEXT_2420 = NL + "\t\tset";
  protected final String TEXT_2421 = "(new";
  protected final String TEXT_2422 = ");";
  protected final String TEXT_2423 = NL + "\t\tint ";
  protected final String TEXT_2424 = "ListSize = 0;";
  protected final String TEXT_2425 = NL + "\t\tint ";
  protected final String TEXT_2426 = "Size = ";
  protected final String TEXT_2427 = " == null ? 0 : ";
  protected final String TEXT_2428 = ".size();" + NL + "\t\tif (";
  protected final String TEXT_2429 = "Size > ";
  protected final String TEXT_2430 = "ListSize)" + NL + "\t\t\t";
  protected final String TEXT_2431 = "ListSize = ";
  protected final String TEXT_2432 = "Size;";
  protected final String TEXT_2433 = NL + "\t\tfor (int i = 0; i < ";
  protected final String TEXT_2434 = "ListSize; i++) {" + NL + "\t\t\tnew";
  protected final String TEXT_2435 = ".create";
  protected final String TEXT_2436 = "(";
  protected final String TEXT_2437 = ", ";
  protected final String TEXT_2438 = "i < ";
  protected final String TEXT_2439 = "Size ? (";
  protected final String TEXT_2440 = ") ";
  protected final String TEXT_2441 = ".get(i) : null";
  protected final String TEXT_2442 = ");" + NL + "\t\t}";
  protected final String TEXT_2443 = NL + "\t\tnew";
  protected final String TEXT_2444 = ".create";
  protected final String TEXT_2445 = "(";
  protected final String TEXT_2446 = ", ";
  protected final String TEXT_2447 = ");";
  protected final String TEXT_2448 = NL + "\t\tif (";
  protected final String TEXT_2449 = " != null)";
  protected final String TEXT_2450 = NL + "\t\t\tnew";
  protected final String TEXT_2451 = ".";
  protected final String TEXT_2452 = "().addAll(";
  protected final String TEXT_2453 = ");";
  protected final String TEXT_2454 = NL + "\t\t\tnew";
  protected final String TEXT_2455 = ".set";
  protected final String TEXT_2456 = "(";
  protected final String TEXT_2457 = ");";
  protected final String TEXT_2458 = NL + "\t\treturn new";
  protected final String TEXT_2459 = ";" + NL + "\t}" + NL;
  protected final String TEXT_2460 = NL + "\t/**";
  protected final String TEXT_2461 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2462 = "}, with the specified ";
  protected final String TEXT_2463 = ", and appends it to the '<em><b>";
  protected final String TEXT_2464 = "</b></em>' ";
  protected final String TEXT_2465 = ".";
  protected final String TEXT_2466 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2467 = "},with the specified ";
  protected final String TEXT_2468 = ", and sets the '<em><b>";
  protected final String TEXT_2469 = "</b></em>' ";
  protected final String TEXT_2470 = ".";
  protected final String TEXT_2471 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2472 = "} and appends it to the '<em><b>";
  protected final String TEXT_2473 = "</b></em>' ";
  protected final String TEXT_2474 = ".";
  protected final String TEXT_2475 = NL + "\t * Creates a new {@link ";
  protected final String TEXT_2476 = "} and sets the '<em><b>";
  protected final String TEXT_2477 = "</b></em>' ";
  protected final String TEXT_2478 = ".";
  protected final String TEXT_2479 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_2480 = NL + "\t * @param ";
  protected final String TEXT_2481 = " The ";
  protected final String TEXT_2482 = " for the new {@link ";
  protected final String TEXT_2483 = "}, or <code>null</code>.";
  protected final String TEXT_2484 = NL + "\t * @return The new {@link ";
  protected final String TEXT_2485 = "}." + NL + "\t * @see #";
  protected final String TEXT_2486 = "()" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_2493 = NL + "\tpublic ";
  protected final String TEXT_2494 = " create";
  protected final String TEXT_2495 = "(";
  protected final String TEXT_2496 = ")" + NL + "\t{";
  protected final String TEXT_2497 = NL + "\t\treturn create";
  protected final String TEXT_2498 = "(";
  protected final String TEXT_2499 = ", ";
  protected final String TEXT_2500 = ");";
  protected final String TEXT_2501 = NL + "\t\t";
  ...
  protected final String TEXT_2506 = NL + "\t\t";
  protected final String TEXT_2507 = "().add(new";
  protected final String TEXT_2508 = ");";
  protected final String TEXT_2509 = NL + "\t\tset";
  protected final String TEXT_2510 = "(new";
  protected final String TEXT_2511 = ");";
  protected final String TEXT_2512 = NL + "\t\tint ";
  protected final String TEXT_2513 = "ListSize = 0;";
  protected final String TEXT_2514 = NL + "\t\tint ";
  protected final String TEXT_2515 = "Size = ";
  protected final String TEXT_2516 = " == null ? 0 : ";
  protected final String TEXT_2517 = ".size();" + NL + "\t\tif (";
  protected final String TEXT_2518 = "Size > ";
  protected final String TEXT_2519 = "ListSize)" + NL + "\t\t\t";
  protected final String TEXT_2520 = "ListSize = ";
  protected final String TEXT_2521 = "Size;";
  protected final String TEXT_2522 = NL + "\t\tfor (int i = 0; i < ";
  protected final String TEXT_2523 = "ListSize; i++) {" + NL + "\t\t\tnew";
  protected final String TEXT_2524 = ".create";
  protected final String TEXT_2525 = "(";
  protected final String TEXT_2526 = ", ";
  protected final String TEXT_2527 = "i < ";
  protected final String TEXT_2528 = "Size ? (";
  protected final String TEXT_2529 = ") ";
  protected final String TEXT_2530 = ".get(i) : null";
  protected final String TEXT_2531 = ");" + NL + "\t\t}";
  protected final String TEXT_2532 = NL + "\t\tnew";
  protected final String TEXT_2533 = ".create";
  protected final String TEXT_2534 = "(";
  protected final String TEXT_2535 = ", ";
  protected final String TEXT_2536 = ");";
  protected final String TEXT_2537 = NL + "\t\tif (";
  protected final String TEXT_2538 = " != null)";
  protected final String TEXT_2539 = NL + "\t\t\tnew";
  protected final String TEXT_2540 = ".";
  protected final String TEXT_2541 = "().addAll(";
  protected final String TEXT_2542 = ");";
  protected final String TEXT_2543 = NL + "\t\t\tnew";
  protected final String TEXT_2544 = ".set";
  protected final String TEXT_2545 = "(";
  protected final String TEXT_2546 = ");";
  protected final String TEXT_2547 = NL + "\t\treturn new";
  protected final String TEXT_2548 = ";";
  protected final String TEXT_2549 = NL + "\t}" + NL;
  protected final String TEXT_2550 = NL + "\t/**" + NL + "\t * Retrieves the first {@link ";
  protected final String TEXT_2551 = "} with the specified ";
  protected final String TEXT_2552 = " from the '<em><b>";
  protected final String TEXT_2553 = "</b></em>' ";
  protected final String TEXT_2554 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_2555 = NL + "\t * @param ";
  protected final String TEXT_2556 = " The ";
  protected final String TEXT_2557 = " of the {@link ";
  protected final String TEXT_2558 = "} to retrieve, or <code>null</code>.";
  ...
  protected final String TEXT_2568 = NL + "\t@Override";
  protected final String TEXT_2569 = NL + "\tpublic ";
  protected final String TEXT_2570 = " get";
  protected final String TEXT_2571 = "(";
  protected final String TEXT_2572 = ")" + NL + "\t{" + NL + "\t\treturn get";
  protected final String TEXT_2573 = "(";
  protected final String TEXT_2574 = ", false";
  protected final String TEXT_2575 = ", null";
  protected final String TEXT_2576 = ", false";
  protected final String TEXT_2577 = ");" + NL + "\t}" + NL;
  protected final String TEXT_2578 = NL + "\t/**" + NL + "\t * Retrieves the first {@link ";
  protected final String TEXT_2579 = "} with the specified ";
  protected final String TEXT_2580 = " from the '<em><b>";
  protected final String TEXT_2581 = "</b></em>' ";
  protected final String TEXT_2582 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_2583 = NL + "\t * @param ";
  protected final String TEXT_2584 = " The ";
  protected final String TEXT_2585 = " of the {@link ";
  protected final String TEXT_2586 = "} to retrieve, or <code>null</code>.";
  protected final String TEXT_2587 = NL + "\t * @param ignoreCase Whether to ignore case in {@link java.lang.String} comparisons.";
  protected final String TEXT_2588 = NL + "\t * @param eClass The Ecore class of the {@link ";
  protected final String TEXT_2589 = "} to retrieve, or <code>null</code>.";
  protected final String TEXT_2590 = NL + "\t * @param createOnDemand Whether to create a {@link ";
  protected final String TEXT_2591 = "} on demand if not found.";
  protected final String TEXT_2592 = NL + "\t * @return The first {@link ";
  protected final String TEXT_2593 = "} with the specified ";
  protected final String TEXT_2594 = ", or <code>null</code>." + NL + "\t * @see #";
  protected final String TEXT_2595 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2596 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_2597 = NL + "\t";
  protected final String TEXT_2598 = " get";
  protected final String TEXT_2599 = "(";
  protected final String TEXT_2600 = ", boolean ignoreCase";
  protected final String TEXT_2601 = ", ";
  protected final String TEXT_2602 = " eClass";
  protected final String TEXT_2603 = ", boolean createOnDemand";
  ...
  protected final String TEXT_2607 = " get";
  protected final String TEXT_2608 = "(";
  protected final String TEXT_2609 = ", boolean ignoreCase";
  protected final String TEXT_2610 = ", ";
  protected final String TEXT_2611 = " eClass";
  protected final String TEXT_2612 = ", boolean createOnDemand";
  protected final String TEXT_2613 = ")" + NL + "\t{";
  protected final String TEXT_2614 = NL + "\t\t";
  protected final String TEXT_2615 = "Loop: for (";
  ...
  protected final String TEXT_2620 = "Loop: for (";
  protected final String TEXT_2621 = " i = ";
  protected final String TEXT_2622 = "().iterator(); i.hasNext(); )" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_2623 = " ";
  protected final String TEXT_2624 = " = (";
  protected final String TEXT_2625 = ") i.next();";
  protected final String TEXT_2626 = NL + "\t\t\tif (eClass != null && !eClass.isInstance(";
  protected final String TEXT_2627 = "))" + NL + "\t\t\t\tcontinue ";
  protected final String TEXT_2628 = "Loop;";
  protected final String TEXT_2629 = NL + "\t\t\t";
  protected final String TEXT_2630 = " ";
  protected final String TEXT_2631 = "List = ";
  protected final String TEXT_2632 = ".";
  protected final String TEXT_2633 = "();" + NL + "\t\t\tint ";
  protected final String TEXT_2634 = "ListSize = ";
  protected final String TEXT_2635 = "List.size();" + NL + "\t\t\tif (";
  protected final String TEXT_2636 = " || (";
  protected final String TEXT_2637 = " != null && ";
  protected final String TEXT_2638 = ".size() != ";
  protected final String TEXT_2639 = "ListSize";
  protected final String TEXT_2640 = ")";
  protected final String TEXT_2641 = ")" + NL + "\t\t\t\tcontinue  ";
  protected final String TEXT_2642 = "Loop;" + NL + "\t\t\tfor (int j = 0; j < ";
  protected final String TEXT_2643 = "ListSize; j++)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_2672 = " == null)" + NL + "\t\t\t\tcontinue ";
  protected final String TEXT_2673 = "Loop;";
  protected final String TEXT_2674 = NL + "\t\t\tif (";
  protected final String TEXT_2675 = " != null && !(ignoreCase ? ";
  protected final String TEXT_2676 = ".equalsIgnoreCase(";
  protected final String TEXT_2677 = ".";
  protected final String TEXT_2678 = "()) : ";
  protected final String TEXT_2679 = ".equals(";
  ...
  protected final String TEXT_2684 = ".equals(";
  protected final String TEXT_2685 = ".";
  protected final String TEXT_2686 = "()))";
  protected final String TEXT_2687 = NL + "\t\t\t\tcontinue ";
  protected final String TEXT_2688 = "Loop;";
  protected final String TEXT_2689 = NL + "\t\t\tif (";
  protected final String TEXT_2690 = " != null && !(ignoreCase ? ";
  protected final String TEXT_2691 = ".equalsIgnoreCase(";
  protected final String TEXT_2692 = ".";
  protected final String TEXT_2693 = "()) : ";
  protected final String TEXT_2694 = ".equals(";
  ...
  protected final String TEXT_2699 = ".equals(";
  protected final String TEXT_2700 = ".";
  protected final String TEXT_2701 = "()))";
  protected final String TEXT_2702 = NL + "\t\t\t\tcontinue ";
  protected final String TEXT_2703 = "Loop;";
  protected final String TEXT_2704 = NL + "\t\t\treturn ";
  protected final String TEXT_2705 = ";" + NL + "\t\t}";
  protected final String TEXT_2706 = NL + "\t\treturn createOnDemand";
  protected final String TEXT_2707 = " && eClass != null";
  protected final String TEXT_2708 = " ? create";
  protected final String TEXT_2709 = "(";
  protected final String TEXT_2710 = ", eClass";
  protected final String TEXT_2711 = ") : null;";
  protected final String TEXT_2712 = NL + "\t\treturn null;";
  protected final String TEXT_2713 = NL + "\t}" + NL;
  protected final String TEXT_2714 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_2715 = "()" + NL + "\t{";
  protected final String TEXT_2716 = NL + "  \t\treturn false;";
  protected final String TEXT_2717 = NL + "\t\treturn eIsSet(";
  protected final String TEXT_2718 = ");";
  protected final String TEXT_2719 = NL + "\t\treturn !((";
  protected final String TEXT_2720 = ".Internal.Wrapper)";
  ...
  protected final String TEXT_2739 = NL + "\t\treturn eVirtualGet(";
  protected final String TEXT_2740 = ") != null;";
  protected final String TEXT_2741 = NL + "\t\treturn basicGet";
  protected final String TEXT_2742 = "() != null;";
  protected final String TEXT_2743 = NL + "\t\treturn ";
  protected final String TEXT_2744 = " != null;";
  protected final String TEXT_2745 = NL + "\t\treturn eVirtualGet(";
  protected final String TEXT_2746 = ") != null;";
  ...
  protected final String TEXT_2751 = "_EFLAG) != 0) != ";
  protected final String TEXT_2752 = ";";
  protected final String TEXT_2753 = NL + "\t\treturn ";
  protected final String TEXT_2754 = " != ";
  protected final String TEXT_2755 = ";";
  protected final String TEXT_2756 = NL + "\t\treturn eVirtualGet(";
  ...
  protected final String TEXT_2763 = NL + "\t\treturn ";
  ...
  protected final String TEXT_2768 = NL + "\t\t";
  protected final String TEXT_2769 = " ";
  protected final String TEXT_2770 = " = (";
  protected final String TEXT_2771 = ")eVirtualGet(";
  ...
  protected final String TEXT_2776 = ".equals(";
  ...
  protected final String TEXT_2783 = NL + "\t\treturn eIsSet(";
  protected final String TEXT_2784 = ");";
  protected final String TEXT_2785 = NL + "\t\t";
  protected final String TEXT_2786 = " ";
  protected final String TEXT_2787 = " = (";
  protected final String TEXT_2788 = ")eVirtualGet(";
  protected final String TEXT_2789 = ");";
  protected final String TEXT_2790 = NL + "\t\treturn ";
  protected final String TEXT_2791 = " != null && ((";
  protected final String TEXT_2792 = ".Unsettable";
  protected final String TEXT_2793 = ")";
  protected final String TEXT_2794 = ").isSet();";
  protected final String TEXT_2795 = NL + "\t\treturn eVirtualIsSet(";
  protected final String TEXT_2796 = ");";
  protected final String TEXT_2797 = NL + "\t\treturn (";
  protected final String TEXT_2798 = " & ";
  protected final String TEXT_2799 = "_ESETFLAG) != 0;";
  protected final String TEXT_2800 = NL + "\t\treturn ";
  protected final String TEXT_2801 = "ESet;";
  protected final String TEXT_2802 = NL + "\t\treturn !((";
  protected final String TEXT_2803 = ".Internal)((";
  protected final String TEXT_2804 = ".Internal.Wrapper)get";
  protected final String TEXT_2805 = "()).featureMap()).isEmpty(";
  protected final String TEXT_2806 = ");";
  protected final String TEXT_2807 = NL + "\t\treturn !((";
  protected final String TEXT_2808 = ".Internal)get";
  protected final String TEXT_2809 = "()).isEmpty(";
  ...
  protected final String TEXT_2814 = "(this);";
  protected final String TEXT_2815 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_2816 = "' ";
  protected final String TEXT_2817 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  ...
  protected final String TEXT_2821 = NL + "\t@Override";
  protected final String TEXT_2822 = NL + "\tpublic ";
  ...
  protected final String TEXT_2830 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_2831 = NL + "\t\treturn ";
  protected final String TEXT_2832 = "(";
  protected final String TEXT_2833 = ");";
  protected final String TEXT_2834 = NL + "\t}" + NL;
