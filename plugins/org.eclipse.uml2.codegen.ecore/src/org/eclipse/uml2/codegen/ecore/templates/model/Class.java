...
public class Class
{
  ...
  protected final String TEXT_374 = NL + "\t * <p>" + NL + "\t * This feature subsets the following features:" + NL + "\t * <ul>";
  protected final String TEXT_375 = NL + "\t *   <li>'{@link ";
  protected final String TEXT_376 = "#";
  protected final String TEXT_377 = "() <em>";
  protected final String TEXT_378 = "</em>}'</li>";
  protected final String TEXT_379 = NL + "\t * </ul>" + NL + "\t * </p>";
  protected final String TEXT_380 = NL + "\t * <p>" + NL + "\t * This feature redefines the following features:" + NL + "\t * <ul>";
  protected final String TEXT_381 = NL + "\t *   <li>'{@link ";
  protected final String TEXT_382 = "#";
  protected final String TEXT_383 = "() <em>";
  protected final String TEXT_384 = "</em>}'</li>";
  protected final String TEXT_385 = NL + "\t * </ul>" + NL + "\t * </p>";
