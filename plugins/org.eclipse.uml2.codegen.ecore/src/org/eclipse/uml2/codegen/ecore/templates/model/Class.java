...
public class Class
{
  ...
  protected final String TEXT_660 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_661 = "()" + NL + "\t{";
  protected final String TEXT_662 = NL + "\t\treturn !((";
  protected final String TEXT_663 = ")";
  protected final String TEXT_664 = "()).featureMap().isEmpty();";
  protected final String TEXT_665 = NL + "\t\treturn ";
  protected final String TEXT_666 = " != null && !";
  protected final String TEXT_667 = ".isEmpty();";
  protected final String TEXT_668 = NL + "\t\treturn !";
  protected final String TEXT_669 = "().isEmpty();";
  protected final String TEXT_670 = NL + "\t\treturn ";
  protected final String TEXT_671 = " != null;";
  protected final String TEXT_672 = NL + "\t\treturn basicGet";
  ...
  protected final String TEXT_680 = "_EFLAG) != 0) != ";
  protected final String TEXT_681 = "_EDEFAULT;";
  ...
  protected final String TEXT_687 = "_EDEFAULT;";
  protected final String TEXT_688 = NL + "\t\treturn ";
  protected final String TEXT_689 = "_EDEFAULT == null ? ";
  protected final String TEXT_690 = " != null : !";
  protected final String TEXT_691 = "_EDEFAULT.equals(";
  protected final String TEXT_692 = ");";
  protected final String TEXT_693 = NL + "\t\treturn ";
  protected final String TEXT_694 = "_EDEFAULT == null ? ";
  protected final String TEXT_695 = "() != null : !";
  protected final String TEXT_696 = "_EDEFAULT.equals(";
  protected final String TEXT_697 = "());";
  protected final String TEXT_698 = NL + "\t\treturn eIsSet(";
  ...
  protected final String TEXT_703 = ".Unsettable)";
  protected final String TEXT_704 = ").isSet();";
  protected final String TEXT_705 = NL + "\t\treturn (";
  protected final String TEXT_706 = " & ";
  protected final String TEXT_707 = "_ESETFLAG) != 0;";
  protected final String TEXT_708 = NL + "\t\treturn ";
  protected final String TEXT_709 = "ESet;";
  protected final String TEXT_710 = NL + "\t\treturn !((";
  protected final String TEXT_711 = ".Internal)((";
  protected final String TEXT_712 = ")get";
  protected final String TEXT_713 = "()).featureMap()).isEmpty(";
  protected final String TEXT_714 = "());";
  protected final String TEXT_715 = NL + "\t\treturn !((";
  protected final String TEXT_716 = ".Internal)get";
  protected final String TEXT_717 = "()).isEmpty(";
  protected final String TEXT_718 = "());";
  protected final String TEXT_719 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_720 = "' ";
  protected final String TEXT_721 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_722 = NL + "\t}" + NL;
  protected final String TEXT_723 = NL;
  protected final String TEXT_724 = "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  ...
  protected final String TEXT_735 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// -> specify the condition that violates the invariant" + NL + "\t\t// -> verify the details of the diagnostic, including severity and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_736 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_737 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_738 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_739 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_740 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_741 = ".";
  protected final String TEXT_742 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_743 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_744 = "\", ";
  protected final String TEXT_745 = ".getObjectLabel(this, ";
  protected final String TEXT_746 = ") }),";
  protected final String TEXT_747 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_748 = NL + "\t\t";
  protected final String TEXT_749 = " cache = getCacheAdapter();" + NL + "\t\tif (cache != null) {" + NL + "\t\t\t";
  protected final String TEXT_750 = " result = (";
  protected final String TEXT_751 = ") cache.get(";
  protected final String TEXT_752 = "eResource(), ";
  protected final String TEXT_753 = "this, ";
  protected final String TEXT_754 = ".eINSTANCE.get";
  protected final String TEXT_755 = "().getEOperations().get(";
  protected final String TEXT_756 = "));" + NL + "\t\t\tif (result == null) {" + NL + "\t\t\t\tcache.put(";
  protected final String TEXT_757 = "eResource(), ";
  protected final String TEXT_758 = "this, ";
  protected final String TEXT_759 = ".eINSTANCE.get";
  protected final String TEXT_760 = "().getEOperations().get(";
  protected final String TEXT_761 = "), result = ";
  ...
  protected final String TEXT_769 = ");" + NL + "\t\t\t}" + NL + "\t\t\treturn result";
  protected final String TEXT_770 = ".";
  protected final String TEXT_771 = "()";
  protected final String TEXT_772 = ";" + NL + "\t\t}";
  protected final String TEXT_773 = NL + "\t\treturn ";
  protected final String TEXT_774 = ".";
  protected final String TEXT_775 = "(this";
  protected final String TEXT_776 = ", ";
  protected final String TEXT_777 = ");";
  protected final String TEXT_778 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_779 = NL + "\t}" + NL;
  protected final String TEXT_780 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_781 = " eInverseAdd(";
  protected final String TEXT_782 = " otherEnd, int featureID, Class baseClass, ";
  protected final String TEXT_783 = " msgs)" + NL + "\t{" + NL + "\t\tif (featureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eDerivedStructuralFeatureID(featureID, baseClass))" + NL + "\t\t\t{";
  protected final String TEXT_784 = NL + "\t\t\t\tcase ";
  protected final String TEXT_785 = ":";
  protected final String TEXT_786 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_787 = ")((";
  protected final String TEXT_788 = ")";
  protected final String TEXT_789 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_790 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_791 = ")";
  protected final String TEXT_792 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_793 = NL + "\t\t\t\t\tif (eContainer != null)" + NL + "\t\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_794 = ", msgs);";
  protected final String TEXT_795 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_796 = " != null)";
  protected final String TEXT_797 = NL + "\t\t\t\t\t\tmsgs = ((";
  protected final String TEXT_798 = ")";
  protected final String TEXT_799 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_800 = ", null, msgs);";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\tmsgs = ((";
  protected final String TEXT_802 = ")";
  protected final String TEXT_803 = ").eInverseRemove(this, ";
  protected final String TEXT_804 = ", ";
  protected final String TEXT_805 = ".class, msgs);";
  protected final String TEXT_806 = NL + "\t\t\t\t\treturn basicSet";
  protected final String TEXT_807 = "((";
  protected final String TEXT_808 = ")otherEnd, msgs);";
  protected final String TEXT_809 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicInverseAdd(otherEnd, featureID, baseClass, msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (eContainer != null)" + NL + "\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\treturn eBasicSetContainer(otherEnd, featureID, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_810 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_811 = " eInverseRemove(";
  protected final String TEXT_812 = " otherEnd, int featureID, Class baseClass, ";
  protected final String TEXT_813 = " msgs)" + NL + "\t{" + NL + "\t\tif (featureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eDerivedStructuralFeatureID(featureID, baseClass))" + NL + "\t\t\t{";
  protected final String TEXT_814 = NL + "\t\t\t\tcase ";
  protected final String TEXT_815 = ":";
  protected final String TEXT_816 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_817 = ")((";
  protected final String TEXT_818 = ")";
  protected final String TEXT_819 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_820 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_821 = ")((";
  protected final String TEXT_822 = ")";
  protected final String TEXT_823 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_824 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_825 = ")";
  protected final String TEXT_826 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_827 = NL + "\t\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_828 = ", msgs);";
  protected final String TEXT_829 = NL + "\t\t\t\t\treturn basicUnset";
  protected final String TEXT_830 = "(msgs);";
  protected final String TEXT_831 = NL + "\t\t\t\t\treturn basicSet";
  protected final String TEXT_832 = "(null, msgs);";
  protected final String TEXT_833 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicInverseRemove(otherEnd, featureID, baseClass, msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn eBasicSetContainer(null, featureID, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_834 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_835 = " eBasicRemoveFromContainer(";
  protected final String TEXT_836 = " msgs)" + NL + "\t{" + NL + "\t\tif (eContainerFeatureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eContainerFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_837 = NL + "\t\t\t\tcase ";
  protected final String TEXT_838 = ":" + NL + "\t\t\t\t\treturn eContainer.eInverseRemove(this, ";
  protected final String TEXT_839 = ", ";
  protected final String TEXT_840 = ".class, msgs);";
  protected final String TEXT_841 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicBasicRemoveFromContainer(msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn eContainer.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - eContainerFeatureID, null, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_842 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object eGet(";
  protected final String TEXT_843 = " eFeature, boolean resolve)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_844 = NL + "\t\t\tcase ";
  protected final String TEXT_845 = ":";
  protected final String TEXT_846 = NL + "\t\t\t\treturn ";
  protected final String TEXT_847 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_848 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_849 = "(";
  protected final String TEXT_850 = "());";
  protected final String TEXT_851 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_852 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_853 = "();";
  protected final String TEXT_854 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_855 = ")";
  protected final String TEXT_856 = "()).eMap();";
  protected final String TEXT_857 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_858 = ")";
  protected final String TEXT_859 = "()).featureMap();";
  protected final String TEXT_860 = NL + "\t\t\t\treturn ";
  protected final String TEXT_861 = "();";
  protected final String TEXT_862 = NL + "\t\t}" + NL + "\t\treturn eDynamicGet(eFeature, resolve);" + NL + "\t}" + NL;
  protected final String TEXT_863 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void eSet(";
  protected final String TEXT_864 = " eFeature, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  ...
  protected final String TEXT_871 = "().clear();";
  protected final String TEXT_872 = NL + "\t\t\t\t((";
  protected final String TEXT_873 = ")";
  protected final String TEXT_874 = "()).featureMap().addAll((";
  protected final String TEXT_875 = ")newValue);";
  protected final String TEXT_876 = NL + "\t\t\t\t((";
  protected final String TEXT_877 = ")";
  protected final String TEXT_878 = "()).eMap().addAll((";
  protected final String TEXT_879 = ")newValue);";
  protected final String TEXT_880 = NL + "\t\t\t\t";
  protected final String TEXT_881 = "().addAll((";
  protected final String TEXT_882 = ")newValue);";
  protected final String TEXT_883 = NL + "\t\t\t\tset";
  protected final String TEXT_884 = "(((";
  protected final String TEXT_885 = ")newValue).";
  protected final String TEXT_886 = "());";
  protected final String TEXT_887 = NL + "\t\t\t\tset";
  protected final String TEXT_888 = "((";
  protected final String TEXT_889 = ")newValue);";
  protected final String TEXT_890 = NL + "\t\t\t\treturn;";
  protected final String TEXT_891 = NL + "\t\t}" + NL + "\t\teDynamicSet(eFeature, newValue);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void eUnset(";
  protected final String TEXT_892 = " eFeature)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_893 = NL + "\t\t\tcase ";
  protected final String TEXT_894 = ":";
  protected final String TEXT_895 = NL + "\t\t\t\t((";
  protected final String TEXT_896 = ")";
  protected final String TEXT_897 = "()).featureMap().clear();";
  protected final String TEXT_898 = NL + "\t\t\t\t";
  protected final String TEXT_899 = "().clear();";
  protected final String TEXT_900 = NL + "\t\t\t\tunset";
  protected final String TEXT_901 = "();";
  protected final String TEXT_902 = NL + "\t\t\t\tset";
  protected final String TEXT_903 = "((";
  protected final String TEXT_904 = ")null);";
  protected final String TEXT_905 = NL + "\t\t\t\tset";
  protected final String TEXT_906 = "(";
  protected final String TEXT_907 = "_EDEFAULT);";
  protected final String TEXT_908 = NL + "\t\t\t\treturn;";
  protected final String TEXT_909 = NL + "\t\t}" + NL + "\t\teDynamicUnset(eFeature);" + NL + "\t}" + NL;
  protected final String TEXT_910 = NL;
  protected final String TEXT_911 = "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean eIsSet(";
  protected final String TEXT_912 = " eFeature)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_913 = NL + "\t\t\tcase ";
  protected final String TEXT_914 = ":";
  protected final String TEXT_915 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_916 = "();";
  protected final String TEXT_917 = NL + "\t\t\t\treturn !((";
  protected final String TEXT_918 = ")";
  protected final String TEXT_919 = "()).featureMap().isEmpty();";
  protected final String TEXT_920 = NL + "\t\t\t\treturn ";
  protected final String TEXT_921 = " != null && !";
  protected final String TEXT_922 = ".featureMap().isEmpty();";
  protected final String TEXT_923 = NL + "\t\t\t\treturn ";
  protected final String TEXT_924 = " != null && !";
  protected final String TEXT_925 = ".isEmpty();";
  protected final String TEXT_926 = NL + "\t\t\t\treturn !";
  protected final String TEXT_927 = "().isEmpty();";
  protected final String TEXT_928 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_929 = "();";
  protected final String TEXT_930 = NL + "\t\t\t\treturn ";
  protected final String TEXT_931 = " != null;";
  protected final String TEXT_932 = NL + "\t\t\t\treturn basicGet";
  ...
  protected final String TEXT_954 = "_EDEFAULT == null ? ";
  protected final String TEXT_955 = "() != null : !";
  protected final String TEXT_956 = "_EDEFAULT.equals(";
  protected final String TEXT_957 = "());";
  protected final String TEXT_958 = NL + "\t\t}" + NL + "\t\treturn eDynamicIsSet(eFeature);" + NL + "\t}" + NL;
  protected final String TEXT_959 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass)" + NL + "\t{";
  protected final String TEXT_960 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_961 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_962 = NL + "\t\t\t\tcase ";
  protected final String TEXT_963 = ": return ";
  protected final String TEXT_964 = ";";
  protected final String TEXT_965 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_966 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass)" + NL + "\t{";
  protected final String TEXT_967 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_968 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_969 = NL + "\t\t\t\tcase ";
  protected final String TEXT_970 = ": return ";
  protected final String TEXT_971 = ";";
  protected final String TEXT_972 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_973 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  ...
  protected final String TEXT_984 = ") result.append((";
  protected final String TEXT_985 = " & ";
  protected final String TEXT_986 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  ...
  protected final String TEXT_993 = "); else result.append(\"<unset>\");";
  protected final String TEXT_994 = NL + "\t\tresult.append((";
  protected final String TEXT_995 = " & ";
  protected final String TEXT_996 = "_EFLAG) != 0);";
  protected final String TEXT_997 = NL + "\t\tresult.append(";
  protected final String TEXT_998 = ");";
  protected final String TEXT_999 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_1000 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\tObject theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getKey()" + NL + "\t{";
  protected final String TEXT_1001 = NL + "\t\treturn new ";
  protected final String TEXT_1002 = "(getTypedKey());";
  protected final String TEXT_1003 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_1004 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(Object key)" + NL + "\t{";
  protected final String TEXT_1005 = NL + "\t\tgetTypedKey().addAll((";
  protected final String TEXT_1006 = ")key);";
  protected final String TEXT_1007 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_1008 = ")key).";
  protected final String TEXT_1009 = "());";
  protected final String TEXT_1010 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_1011 = ")key);";
  protected final String TEXT_1012 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getValue()" + NL + "\t{";
  protected final String TEXT_1013 = NL + "\t\treturn new ";
  protected final String TEXT_1014 = "(getTypedValue());";
  protected final String TEXT_1015 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_1016 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object setValue(Object value)" + NL + "\t{" + NL + "\t\tObject oldValue = getValue();";
  protected final String TEXT_1017 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll((";
  protected final String TEXT_1018 = ")value);";
  protected final String TEXT_1019 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_1020 = ")value).";
  protected final String TEXT_1021 = "());";
  protected final String TEXT_1022 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_1023 = ")value);";
  protected final String TEXT_1024 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1025 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1026 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_1027 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
  protected final String TEXT_1028 = NL;
  protected final String TEXT_1029 = NL + "\t/**" + NL + "\t * Retrieves the cache adapter for this '<em><b>";
  protected final String TEXT_1030 = "</b></em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return The cache adapter for this '<em><b>";
  protected final String TEXT_1031 = "</b></em>'." + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_1032 = " getCacheAdapter() {" + NL + "\t\tfor (";
  protected final String TEXT_1033 = " i = eAdapters().iterator(); i.hasNext();) {" + NL + "\t\t\t";
  protected final String TEXT_1034 = " adapter = (";
  protected final String TEXT_1035 = ") i.next();" + NL + "\t\t\tif (adapter instanceof ";
  protected final String TEXT_1036 = ") {" + NL + "\t\t\t\treturn (";
  protected final String TEXT_1037 = ") adapter;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn null;" + NL + "\t}" + NL;
  protected final String TEXT_1038 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1039 = " basicGet";
  protected final String TEXT_1040 = "()" + NL + "\t{";
  protected final String TEXT_1041 = NL + "\t\tif (isSet";
  protected final String TEXT_1042 = "()) {" + NL + "\t\t\treturn ";
  protected final String TEXT_1043 = "basicGet";
  protected final String TEXT_1044 = "();" + NL + "\t\t}";
  protected final String TEXT_1045 = NL + "\t\tif (eIsSet(";
  ...
  protected final String TEXT_1052 = "basicGet";
  protected final String TEXT_1053 = "();\t\t\t" + NL + "\t\tif (";
  protected final String TEXT_1054 = " != null) {" + NL + "\t\t\treturn ";
  protected final String TEXT_1055 = ";" + NL + "\t\t}";
  protected final String TEXT_1056 = NL + "\t\treturn ";
  protected final String TEXT_1057 = "super.basicGet";
  protected final String TEXT_1058 = "()";
  protected final String TEXT_1059 = "null";
  protected final String TEXT_1060 = ";" + NL + "\t}" + NL;
  protected final String TEXT_1061 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1062 = " ";
  protected final String TEXT_1063 = "()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1064 = " ";
  protected final String TEXT_1065 = " = basicGet";
  protected final String TEXT_1066 = "();" + NL + "\t\treturn ";
  protected final String TEXT_1067 = " == null ? null : (";
  protected final String TEXT_1068 = ")eResolveProxy((";
  protected final String TEXT_1069 = ")";
  protected final String TEXT_1070 = ");" + NL + "\t}" + NL;
  protected final String TEXT_1071 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_1072 = " ";
  protected final String TEXT_1073 = "Helper(";
  protected final String TEXT_1074 = " ";
  protected final String TEXT_1075 = ")" + NL + "\t{";
  protected final String TEXT_1076 = NL + "\t\t";
  protected final String TEXT_1077 = ".addAll(super.";
  protected final String TEXT_1078 = "());";
  protected final String TEXT_1079 = NL + "\t\tsuper.";
  protected final String TEXT_1080 = "Helper(";
  protected final String TEXT_1081 = ");";
  protected final String TEXT_1082 = NL + "\t\tif (isSet";
  protected final String TEXT_1083 = "()) {" + NL + "\t\t\tfor (";
  protected final String TEXT_1084 = " i = ((";
  protected final String TEXT_1085 = ") ";
  protected final String TEXT_1086 = "()).basicIterator(); i.hasNext(); ) {" + NL + "\t\t\t\t";
  protected final String TEXT_1087 = ".add(i.next());" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_1088 = NL + "\t\tif (eIsSet(";
  protected final String TEXT_1089 = "())) {" + NL + "\t\t\tfor (";
  protected final String TEXT_1090 = " i = ((";
  protected final String TEXT_1091 = ") ";
  protected final String TEXT_1092 = "()).basicIterator(); i.hasNext(); ) {" + NL + "\t\t\t\t";
  protected final String TEXT_1093 = ".add(i.next());" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_1094 = NL + "\t\t";
  protected final String TEXT_1095 = " ";
  protected final String TEXT_1096 = " = ";
  protected final String TEXT_1097 = "();" + NL + "\t\tif (!";
  protected final String TEXT_1098 = ".isEmpty()) {" + NL + "\t\t\tfor (";
  protected final String TEXT_1099 = " i = ((";
  protected final String TEXT_1100 = ") ";
  protected final String TEXT_1101 = ").basicIterator(); i.hasNext(); ) {" + NL + "\t\t\t\t";
  protected final String TEXT_1102 = ".add(i.next());" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_1103 = NL + "\t\tif (isSet";
  protected final String TEXT_1104 = "()) {" + NL + "\t\t\t";
  protected final String TEXT_1105 = ".addAll(";
  protected final String TEXT_1106 = "());" + NL + "\t\t}";
  protected final String TEXT_1107 = NL + "\t\tif (eIsSet(";
  protected final String TEXT_1108 = "())) {" + NL + "\t\t\t";
  protected final String TEXT_1109 = ".addAll(";
  ...
  protected final String TEXT_1126 = "basicGet";
  ...
  protected final String TEXT_1133 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1134 = " ";
  protected final String TEXT_1135 = "()" + NL + "\t{";
  protected final String TEXT_1136 = NL + "\t\t";
  protected final String TEXT_1137 = " cache = getCacheAdapter();" + NL + "\t\tif (cache != null) {";
  protected final String TEXT_1138 = NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_1139 = " method = getClass().getMethod(\"";
  protected final String TEXT_1140 = "\", null);";
  protected final String TEXT_1141 = NL + "\t\t\t\t";
  protected final String TEXT_1142 = " ";
  protected final String TEXT_1143 = " = (";
  protected final String TEXT_1144 = ") cache.get(eResource(), this, method);" + NL + "\t\t\t\tif (";
  protected final String TEXT_1145 = " == null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_1146 = " union = ";
  protected final String TEXT_1147 = "Helper(new ";
  protected final String TEXT_1148 = "());" + NL + "\t\t\t\t\tcache.put(eResource(), this, method, ";
  ...
  protected final String TEXT_1153 = ", union.size(), union.toArray()));" + NL + "\t\t\t\t}" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1154 = ";" + NL + "\t\t\t} catch (";
  protected final String TEXT_1155 = " nsme) {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}";
  protected final String TEXT_1156 = NL + "\t\t\t";
  protected final String TEXT_1157 = " ";
  protected final String TEXT_1158 = " = (";
  protected final String TEXT_1159 = ") cache.get(eResource(), this, ";
  protected final String TEXT_1160 = "());" + NL + "\t\t\tif (";
  protected final String TEXT_1161 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_1162 = " union = ";
  protected final String TEXT_1163 = "Helper(new ";
  protected final String TEXT_1164 = "());" + NL + "\t\t\t\tcache.put(eResource(), this, ";
  ...
  protected final String TEXT_1170 = ", union.size(), union.toArray()));" + NL + "\t\t\t}" + NL + "\t\t\treturn ";
  protected final String TEXT_1171 = ";";
  protected final String TEXT_1172 = NL + "\t\t}";
  protected final String TEXT_1173 = NL + "\t\t";
  protected final String TEXT_1174 = " union = ";
  protected final String TEXT_1175 = "Helper(new ";
  protected final String TEXT_1176 = "());" + NL + "\t\treturn new ";
  protected final String TEXT_1177 = "(this, ";
  protected final String TEXT_1178 = "null";
  protected final String TEXT_1179 = "()";
  protected final String TEXT_1180 = ", union.size(), union.toArray());" + NL + "\t}" + NL;
  protected final String TEXT_1181 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1182 = " ";
  protected final String TEXT_1183 = "()" + NL + "\t{";
  protected final String TEXT_1184 = NL + "\t\tif (isSet";
  protected final String TEXT_1185 = "()) {" + NL + "\t\t\treturn ";
  protected final String TEXT_1186 = "();" + NL + "\t\t}";
  protected final String TEXT_1187 = NL + "\t\tif (eIsSet(";
  ...
  protected final String TEXT_1194 = " != null) {" + NL + "\t\t\treturn ";
  protected final String TEXT_1195 = ";" + NL + "\t\t}";
  protected final String TEXT_1196 = NL + "\t\treturn ";
  protected final String TEXT_1197 = "super.";
  protected final String TEXT_1198 = "()";
  protected final String TEXT_1199 = "null";
  protected final String TEXT_1200 = ";" + NL + "\t}" + NL;
  protected final String TEXT_1201 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_1202 = "()" + NL + "\t{";
  protected final String TEXT_1203 = NL + "\t\treturn super.isSet";
  protected final String TEXT_1204 = "()";
  protected final String TEXT_1205 = NL + "\t\treturn isSet";
  ...
  protected final String TEXT_1215 = NL + "\t\treturn eIsSet(";
  protected final String TEXT_1216 = "())";
  protected final String TEXT_1217 = ";";
  protected final String TEXT_1218 = NL + "\t\t\t|| isSet";
  ...
  protected final String TEXT_1225 = "basicGet";
  protected final String TEXT_1226 = "() != null";
  protected final String TEXT_1227 = ";";
  protected final String TEXT_1228 = NL + "\t\t\t|| eIsSet(";
  protected final String TEXT_1229 = "())";
  protected final String TEXT_1230 = ";";
  protected final String TEXT_1231 = NL + "\t\treturn super.isSet";
  protected final String TEXT_1232 = "();";
  protected final String TEXT_1233 = NL + "\t\treturn false;";
  protected final String TEXT_1234 = NL + "\t}" + NL;
  protected final String TEXT_1235 = NL;
  protected final String TEXT_1236 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1237 = " create";
  protected final String TEXT_1238 = "(";
  protected final String TEXT_1239 = " eClass) {" + NL + "\t\t";
  protected final String TEXT_1240 = " new";
  protected final String TEXT_1241 = " = (";
  protected final String TEXT_1242 = ") eClass.getEPackage().getEFactoryInstance().create(eClass);" + NL + "\t\tif (eNotificationRequired()) {" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1243 = "(this, 0, ";
  protected final String TEXT_1244 = ", null, new";
  protected final String TEXT_1245 = "));" + NL + "\t\t}";
  protected final String TEXT_1246 = NL + "\t\t";
  protected final String TEXT_1247 = "().add(new";
  protected final String TEXT_1248 = ");";
  protected final String TEXT_1249 = NL + "\t\tset";
  ...
  protected final String TEXT_1254 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1255 = " create";
  protected final String TEXT_1256 = "() {" + NL + "\t\t";
  protected final String TEXT_1257 = " new";
  protected final String TEXT_1258 = " = ";
  protected final String TEXT_1259 = ".eINSTANCE.create";
  protected final String TEXT_1260 = "();" + NL + "\t\tif (eNotificationRequired()) {" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1261 = "(this, 0, ";
  protected final String TEXT_1262 = ", null, new";
  protected final String TEXT_1263 = "));" + NL + "\t\t}";
  protected final String TEXT_1264 = NL + "\t\t";
  protected final String TEXT_1265 = "().add(new";
  protected final String TEXT_1266 = ");";
  protected final String TEXT_1267 = NL + "\t\tset";
  protected final String TEXT_1268 = "(new";
  protected final String TEXT_1269 = ");";
  protected final String TEXT_1270 = NL + "\t\treturn new";
  ...
  protected final String TEXT_1273 = " get";
  ...
  protected final String TEXT_1278 = "().iterator(); i.hasNext(); ) {" + NL + "\t\t\t";
  protected final String TEXT_1279 = " ";
  protected final String TEXT_1280 = " = (";
  protected final String TEXT_1281 = ") i.next();" + NL + "\t\t\tif (";
  protected final String TEXT_1282 = ".equals(";
  protected final String TEXT_1283 = ".";
  protected final String TEXT_1284 = "())) {" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1285 = ";" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn null;" + NL + "\t}" + NL;
  protected final String TEXT_1286 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_1287 = "()" + NL + "\t{";
  protected final String TEXT_1288 = NL + "\t\treturn !((";
  protected final String TEXT_1289 = ")";
  protected final String TEXT_1290 = "()).featureMap().isEmpty();";
  protected final String TEXT_1291 = NL + "\t\treturn ";
  protected final String TEXT_1292 = " != null && !";
  protected final String TEXT_1293 = ".isEmpty();";
  protected final String TEXT_1294 = NL + "\t\treturn !";
  protected final String TEXT_1295 = "().isEmpty();";
  protected final String TEXT_1296 = NL + "\t\treturn ";
  protected final String TEXT_1297 = " != null;";
  protected final String TEXT_1298 = NL + "\t\treturn basicGet";
  protected final String TEXT_1299 = "() != null;";
  protected final String TEXT_1300 = NL + "\t\treturn ";
  protected final String TEXT_1301 = " != null;";
  ...
  protected final String TEXT_1306 = "_EFLAG) != 0) != ";
  protected final String TEXT_1307 = "_EDEFAULT;";
  protected final String TEXT_1308 = NL + "\t\treturn ";
  protected final String TEXT_1309 = " != ";
  protected final String TEXT_1310 = "_EDEFAULT;";
  protected final String TEXT_1311 = NL + "\t\treturn ";
  protected final String TEXT_1312 = "() != ";
  protected final String TEXT_1313 = "_EDEFAULT;";
  protected final String TEXT_1314 = NL + "\t\treturn ";
  protected final String TEXT_1315 = "_EDEFAULT == null ? ";
  protected final String TEXT_1316 = " != null : !";
  protected final String TEXT_1317 = "_EDEFAULT.equals(";
  protected final String TEXT_1318 = ");";
  protected final String TEXT_1319 = NL + "\t\treturn ";
  protected final String TEXT_1320 = "_EDEFAULT == null ? ";
  protected final String TEXT_1321 = "() != null : !";
  protected final String TEXT_1322 = "_EDEFAULT.equals(";
  protected final String TEXT_1323 = "());";
  protected final String TEXT_1324 = NL + "\t\treturn eIsSet(";
  ...
  protected final String TEXT_1329 = ".Unsettable)";
  protected final String TEXT_1330 = ").isSet();";
  ...
  protected final String TEXT_1337 = ".Internal)((";
  protected final String TEXT_1338 = ")get";
  protected final String TEXT_1339 = "()).featureMap()).isEmpty(";
  protected final String TEXT_1340 = "());";
  protected final String TEXT_1341 = NL + "\t\treturn !((";
  protected final String TEXT_1342 = ".Internal)get";
  protected final String TEXT_1343 = "()).isEmpty(";
  protected final String TEXT_1344 = "());";
  protected final String TEXT_1345 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_1346 = "' ";
  protected final String TEXT_1347 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1348 = NL + "\t}" + NL;
  protected final String TEXT_1349 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  ...
  protected final String TEXT_1355 = ".UnmodifiableEList(this, ";
  protected final String TEXT_1356 = "null";
  protected final String TEXT_1357 = "()";
  protected final String TEXT_1358 = ", 0, ";
  protected final String TEXT_1359 = ".EMPTY_LIST.toArray());";
  protected final String TEXT_1360 = NL + "\t\treturn null;";
  protected final String TEXT_1361 = NL + "\t\treturn ";
  protected final String TEXT_1362 = "();";
  protected final String TEXT_1363 = NL + "\t}" + NL;
  protected final String TEXT_1364 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1365 = " basicGet";
  protected final String TEXT_1366 = "()" + NL + "\t{";
  protected final String TEXT_1367 = NL + "\t\treturn null;";
  ...
  protected final String TEXT_1372 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1373 = " basicSet";
  protected final String TEXT_1374 = "(";
  protected final String TEXT_1375 = " new";
  protected final String TEXT_1376 = ", ";
  protected final String TEXT_1377 = " msgs)" + NL + "\t{";
  protected final String TEXT_1378 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1379 = NL + "\t\tif (new";
  protected final String TEXT_1380 = " != null && !(new";
  protected final String TEXT_1381 = " instanceof ";
  protected final String TEXT_1382 = ")) {" + NL + "\t\t\tthrow new IllegalArgumentException(String.valueOf(new";
  protected final String TEXT_1383 = "));" + NL + "\t\t}";
  protected final String TEXT_1384 = NL + "\t\treturn basicSet";
  ...
  protected final String TEXT_1389 = ", msgs);";
  ...
  protected final String TEXT_1394 = "new";
  protected final String TEXT_1395 = ");" + NL + "\t\treturn msgs;";
  protected final String TEXT_1396 = NL + "\t}" + NL;
  protected final String TEXT_1397 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void set";
  protected final String TEXT_1398 = "(";
  protected final String TEXT_1399 = " new";
  protected final String TEXT_1400 = ")" + NL + "\t{";
  protected final String TEXT_1401 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1402 = NL + "\t\tif (new";
  protected final String TEXT_1403 = " != null && !(new";
  protected final String TEXT_1404 = " instanceof ";
  protected final String TEXT_1405 = ")) {" + NL + "\t\t\tthrow new IllegalArgumentException(String.valueOf(new";
  ...
  protected final String TEXT_1416 = " create";
  protected final String TEXT_1417 = "(";
  protected final String TEXT_1418 = " eClass) {" + NL + "\t\t";
  protected final String TEXT_1419 = " new";
  protected final String TEXT_1420 = " = (";
  protected final String TEXT_1421 = ") eClass.getEPackage().getEFactoryInstance().create(eClass);" + NL + "\t\tif (eNotificationRequired()) {" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1422 = "(this, 0, ";
  protected final String TEXT_1423 = ", null, new";
  protected final String TEXT_1424 = "));" + NL + "\t\t}";
  protected final String TEXT_1425 = NL + "\t\t";
  protected final String TEXT_1426 = "().add(new";
  ...
  protected final String TEXT_1433 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1434 = " create";
  protected final String TEXT_1435 = "() {" + NL + "\t\t";
  protected final String TEXT_1436 = " new";
  protected final String TEXT_1437 = " = ";
  protected final String TEXT_1438 = ".eINSTANCE.create";
  protected final String TEXT_1439 = "();" + NL + "\t\tif (eNotificationRequired()) {" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_1440 = "(this, 0, ";
  protected final String TEXT_1441 = ", null, new";
  protected final String TEXT_1442 = "));" + NL + "\t\t}";
  protected final String TEXT_1443 = NL + "\t\t";
  protected final String TEXT_1444 = "().add(new";
  protected final String TEXT_1445 = ");";
  protected final String TEXT_1446 = NL + "\t\tset";
  ...
  protected final String TEXT_1456 = " i = ";
  protected final String TEXT_1457 = "().iterator(); i.hasNext(); ) {" + NL + "\t\t\t";
  protected final String TEXT_1458 = " ";
  protected final String TEXT_1459 = " = (";
  protected final String TEXT_1460 = ") i.next();" + NL + "\t\t\tif (";
  protected final String TEXT_1461 = ".equals(";
  protected final String TEXT_1462 = ".";
  protected final String TEXT_1463 = "())) {" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1464 = ";" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn null;" + NL + "\t}" + NL;
  protected final String TEXT_1465 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean isSet";
  protected final String TEXT_1466 = "()" + NL + "\t{";
  protected final String TEXT_1467 = NL + "\t\treturn !((";
  protected final String TEXT_1468 = ")";
  protected final String TEXT_1469 = "()).featureMap().isEmpty();";
  ...
  protected final String TEXT_1474 = "().isEmpty();";
  protected final String TEXT_1475 = NL + "\t\treturn ";
  protected final String TEXT_1476 = " != null;";
  protected final String TEXT_1477 = NL + "\t\treturn basicGet";
  ...
  protected final String TEXT_1485 = "_EFLAG) != 0) != ";
  ...
  protected final String TEXT_1494 = "_EDEFAULT == null ? ";
  protected final String TEXT_1495 = " != null : !";
  protected final String TEXT_1496 = "_EDEFAULT.equals(";
  protected final String TEXT_1497 = ");";
  protected final String TEXT_1498 = NL + "\t\treturn ";
  protected final String TEXT_1499 = "_EDEFAULT == null ? ";
  protected final String TEXT_1500 = "() != null : !";
  protected final String TEXT_1501 = "_EDEFAULT.equals(";
  protected final String TEXT_1502 = "());";
  protected final String TEXT_1503 = NL + "\t\treturn eIsSet(";
  protected final String TEXT_1504 = ".eINSTANCE.get";
  protected final String TEXT_1505 = "());";
  protected final String TEXT_1506 = NL + "\t\treturn ";
  protected final String TEXT_1507 = " != null && ((";
  protected final String TEXT_1508 = ".Unsettable)";
  protected final String TEXT_1509 = ").isSet();";
  protected final String TEXT_1510 = NL + "\t\treturn (";
  protected final String TEXT_1511 = " & ";
  protected final String TEXT_1512 = "_ESETFLAG) != 0;";
  protected final String TEXT_1513 = NL + "\t\treturn ";
  protected final String TEXT_1514 = "ESet;";
  protected final String TEXT_1515 = NL + "\t\treturn !((";
  protected final String TEXT_1516 = ".Internal)((";
  protected final String TEXT_1517 = ")get";
  protected final String TEXT_1518 = "()).featureMap()).isEmpty(";
  protected final String TEXT_1519 = "());";
  protected final String TEXT_1520 = NL + "\t\treturn !((";
  protected final String TEXT_1521 = ".Internal)get";
  protected final String TEXT_1522 = "()).isEmpty(";
  protected final String TEXT_1523 = "());";
  protected final String TEXT_1524 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_1525 = "' ";
  protected final String TEXT_1526 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  ...
  protected final String TEXT_1536 = NL + "\t\tthrow new UnsupportedOperationException();";
