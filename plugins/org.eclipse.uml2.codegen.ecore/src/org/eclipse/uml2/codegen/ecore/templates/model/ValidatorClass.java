...
public class ValidatorClass
{
  ...
  protected final String TEXT_610 = NL + "\t\t\tif (eAnnotation != null)" + NL + "\t\t\t{" + NL + "\t\t\t\tfor (EObject eContents : eAnnotation.eContents())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tif (eContents instanceof ";
  protected final String TEXT_611 = ")" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_612 = " nestedEAnnotation = (";
  protected final String TEXT_613 = ") eContents;" + NL + "\t\t\t\t\t\tif (featureName.equals(nestedEAnnotation.getSource()))" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tredefinitionDetail = nestedEAnnotation.getDetails().get(key);" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn redefinitionDetail;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int getLowerBound(";
  protected final String TEXT_614 = " eObject, ";
  protected final String TEXT_615 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"lowerBound\"));";
  protected final String TEXT_616 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getLowerBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int getUpperBound(";
  protected final String TEXT_617 = " eObject, ";
  protected final String TEXT_618 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"upperBound\"));";
  protected final String TEXT_619 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getUpperBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_620 = NL + "\t@Override";
  protected final String TEXT_621 = NL + "\tprotected boolean isEcoreString(String key)" + NL + "\t{" + NL + "\t\treturn super.isEcoreString(key)" + NL + "\t\t\t|| \"_UI_FeatureHasTooFewValues_diagnostic\".equals(key)";
  protected final String TEXT_622 = NL + "\t\t\t|| \"_UI_FeatureHasTooManyValues_diagnostic\".equals(key)";
  protected final String TEXT_623 = NL + "\t\t\t|| \"_UI_RequiredFeatureMustBeSet_diagnostic\".equals(key);";
  ...
  protected final String TEXT_626 = NL + "\tprotected boolean validate_MultiplicityConforms(";
  protected final String TEXT_627 = " eObject, ";
  protected final String TEXT_628 = " eStructuralFeature, ";
  protected final String TEXT_629 = " diagnostics, ";
  protected final String TEXT_630 = " context)" + NL + "\t{" + NL + "\t\tboolean result = true;" + NL + "\t\tif (eStructuralFeature.isMany())" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_631 = ".isFeatureMap(eStructuralFeature) && ";
  protected final String TEXT_632 = ".INSTANCE.isDocumentRoot(eObject.eClass()))" + NL + "\t\t\t{" + NL + "\t\t\t\tresult = super.validate_MultiplicityConforms(eObject, eStructuralFeature, diagnostics, context);" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tint lowerBound = getLowerBound(eObject, eStructuralFeature);" + NL + "\t\t\t\tif (lowerBound > 0)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tint size = ((List";
  protected final String TEXT_633 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\tif (size < lowerBound)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_634 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_635 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_636 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooFewValues_diagnostic\",";
  ...
  protected final String TEXT_638 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_639 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_640 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  ...
  protected final String TEXT_642 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\t\tif (size > upperBound)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_643 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_644 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_645 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  ...
  protected final String TEXT_647 = ".ERROR," + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_648 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_649 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\"_UI_RequiredFeatureMustBeSet_diagnostic\",";
  protected final String TEXT_650 = NL + "\t\t\t\t\t\t\tnew Object [] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context) }," + NL + "\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn result;" + NL + "\t}";
