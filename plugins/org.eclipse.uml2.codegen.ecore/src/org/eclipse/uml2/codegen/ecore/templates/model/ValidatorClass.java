...
public class ValidatorClass
{
  ...
  protected final String TEXT_610 = NL + "\t\t\tif (eAnnotation != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_612 = " eObject, ";
  protected final String TEXT_613 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"lowerBound\"));";
  protected final String TEXT_614 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getLowerBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int getUpperBound(";
  protected final String TEXT_615 = " eObject, ";
  protected final String TEXT_616 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"upperBound\"));";
  protected final String TEXT_617 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getUpperBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_618 = NL + "\t@Override";
  protected final String TEXT_619 = NL + "\tprotected boolean isEcoreString(String key)" + NL + "\t{" + NL + "\t\treturn super.isEcoreString(key)" + NL + "\t\t\t|| \"_UI_FeatureHasTooFewValues_diagnostic\".equals(key)";
  protected final String TEXT_620 = NL + "\t\t\t|| \"_UI_FeatureHasTooManyValues_diagnostic\".equals(key)";
  protected final String TEXT_621 = NL + "\t\t\t|| \"_UI_RequiredFeatureMustBeSet_diagnostic\".equals(key);";
  protected final String TEXT_622 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_623 = NL + "\t@Override";
  protected final String TEXT_624 = NL + "\tprotected boolean validate_MultiplicityConforms(";
  protected final String TEXT_625 = " eObject, ";
  protected final String TEXT_626 = " eStructuralFeature, ";
  protected final String TEXT_627 = " diagnostics, ";
  protected final String TEXT_628 = " context)" + NL + "\t{" + NL + "\t\tboolean result = true;" + NL + "\t\tif (eStructuralFeature.isMany())" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_629 = ".isFeatureMap(eStructuralFeature) && ";
  protected final String TEXT_630 = ".INSTANCE.isDocumentRoot(eObject.eClass()))" + NL + "\t\t\t{" + NL + "\t\t\t\tresult = super.validate_MultiplicityConforms(eObject, eStructuralFeature, diagnostics, context);" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tint lowerBound = getLowerBound(eObject, eStructuralFeature);" + NL + "\t\t\t\tif (lowerBound > 0)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tint size = ((List";
  protected final String TEXT_631 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\tif (size < lowerBound)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_632 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_633 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_634 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooFewValues_diagnostic\",";
  ...
  protected final String TEXT_638 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  ...
  protected final String TEXT_640 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\t\tif (size > upperBound)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_641 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_642 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_643 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  ...
  protected final String TEXT_647 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\"_UI_RequiredFeatureMustBeSet_diagnostic\",";
  protected final String TEXT_648 = NL + "\t\t\t\t\t\t\tnew Object [] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context) }," + NL + "\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn result;" + NL + "\t}";
