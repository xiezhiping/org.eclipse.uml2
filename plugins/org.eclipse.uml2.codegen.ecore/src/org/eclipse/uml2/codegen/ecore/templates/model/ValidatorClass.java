...
public class ValidatorClass
{
  ...
  protected final String TEXT_606 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate String getRedefinitionDetail(";
  protected final String TEXT_607 = " eClass, String featureName, String key)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_608 = " eClasses = new ";
  protected final String TEXT_609 = "();" + NL + "\t\teClasses.add(eClass);" + NL + "\t\teClasses.addAll(eClass.getEAllSuperTypes());" + NL + "\t\tString redefinitionDetail = null;" + NL + "\t\tfor (";
  protected final String TEXT_610 = " eClassesIterator = eClasses.iterator(); redefinitionDetail == null && eClassesIterator.hasNext(); )" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_611 = " eAnnotation = eClassesIterator.next().getEAnnotation(\"duplicates\");";
  protected final String TEXT_612 = NL + "\t\t\tif (eAnnotation != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_615 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\tString redefinitionDetail = getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"lowerBound\");";
  ...
  protected final String TEXT_618 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\tString redefinitionDetail = getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"upperBound\");";
  protected final String TEXT_619 = NL + "\t\tif (redefinitionDetail != null && redefinitionDetail.length() > 0)" + NL + "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn Integer.parseInt(redefinitionDetail);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t// do nothing" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn eStructuralFeature.getUpperBound();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
