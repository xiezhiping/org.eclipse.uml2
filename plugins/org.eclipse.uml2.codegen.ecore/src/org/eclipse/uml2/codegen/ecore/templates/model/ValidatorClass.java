...
public class ValidatorClass
{
  ...
  protected final String TEXT_604 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate String getRedefinitionDetail(";
  protected final String TEXT_605 = " eClass, String featureName, String key)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_606 = " eClasses = new ";
  protected final String TEXT_607 = "();" + NL + "\t\teClasses.add(eClass);" + NL + "\t\teClasses.addAll(eClass.getEAllSuperTypes());" + NL + "\t\tString redefinitionDetail = null;" + NL + "\t\tfor (";
  protected final String TEXT_608 = " eClassesIterator = eClasses.iterator(); redefinitionDetail == null && eClassesIterator.hasNext(); )" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_609 = " eAnnotation = eClassesIterator.next().getEAnnotation(\"duplicates\");";
  protected final String TEXT_610 = NL + "\t\t\tif (eAnnotation != null)" + NL + "\t\t\t{" + NL + "\t\t\t\teAnnotation = eAnnotation.getEAnnotation(featureName);" + NL + "\t\t\t\tif (eAnnotation != null)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tredefinitionDetail = eAnnotation.getDetails().get(key);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn redefinitionDetail;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int getLowerBound(";
  protected final String TEXT_611 = " eObject, ";
  protected final String TEXT_612 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"lowerBound\"));";
  protected final String TEXT_613 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getLowerBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int getUpperBound(";
  protected final String TEXT_614 = " eObject, ";
  protected final String TEXT_615 = " eStructuralFeature)" + NL + "\t{" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\treturn Integer.parseInt(getRedefinitionDetail(eObject.eClass(), eStructuralFeature.getName(), \"upperBound\"));";
  protected final String TEXT_616 = NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL + "\t\t\treturn eStructuralFeature.getUpperBound();\t\t" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_617 = NL + "\t@Override";
  protected final String TEXT_618 = NL + "\tprotected boolean isEcoreString(String key)" + NL + "\t{" + NL + "\t\treturn super.isEcoreString(key)" + NL + "\t\t\t|| \"_UI_FeatureHasTooFewValues_diagnostic\".equals(key)";
  protected final String TEXT_619 = NL + "\t\t\t|| \"_UI_FeatureHasTooManyValues_diagnostic\".equals(key)";
  protected final String TEXT_620 = NL + "\t\t\t|| \"_UI_RequiredFeatureMustBeSet_diagnostic\".equals(key);";
  ...
  protected final String TEXT_623 = NL + "\tprotected boolean validate_MultiplicityConforms(";
  protected final String TEXT_624 = " eObject, ";
  protected final String TEXT_625 = " eStructuralFeature, ";
  protected final String TEXT_626 = " diagnostics, ";
  protected final String TEXT_627 = " context)" + NL + "\t{" + NL + "\t\tboolean result = true;" + NL + "\t\tif (eStructuralFeature.isMany())" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_628 = ".isFeatureMap(eStructuralFeature) && ";
  protected final String TEXT_629 = ".INSTANCE.isDocumentRoot(eObject.eClass()))" + NL + "\t\t\t{" + NL + "\t\t\t\tresult = super.validate_MultiplicityConforms(eObject, eStructuralFeature, diagnostics, context);" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tint lowerBound = getLowerBound(eObject, eStructuralFeature);" + NL + "\t\t\t\tif (lowerBound > 0)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tint size = ((List";
  protected final String TEXT_630 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\tif (size < lowerBound)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_631 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_632 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_633 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooFewValues_diagnostic\",";
  protected final String TEXT_634 = NL + "\t\t\t\t\t\t\t\t\tnew Object []" + NL + "\t\t\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\t\t\tgetFeatureLabel(eStructuralFeature, context)," + NL + "\t\t\t\t\t\t\t\t\t\tgetObjectLabel(eObject, context)," + NL + "\t\t\t\t\t\t\t\t\t\tsize," + NL + "\t\t\t\t\t\t\t\t\t\tlowerBound" + NL + "\t\t\t\t\t\t\t\t\t}," + NL + "\t\t\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tint upperBound = getUpperBound(eObject, eStructuralFeature);" + NL + "\t\t\t\t\tif (upperBound > 0 && size > upperBound)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_635 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_636 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_637 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  protected final String TEXT_638 = NL + "\t\t\t\t\t\t\t\t\tnew Object []" + NL + "\t\t\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\t\t\tgetFeatureLabel(eStructuralFeature, context)," + NL + "\t\t\t\t\t\t\t\t\t\tgetObjectLabel(eObject, context)," + NL + "\t\t\t\t\t\t\t\t\t\tsize," + NL + "\t\t\t\t\t\t\t\t\t\tupperBound" + NL + "\t\t\t\t\t\t\t\t\t}," + NL + "\t\t\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tint upperBound = getUpperBound(eObject, eStructuralFeature);" + NL + "\t\t\t\t\tif (upperBound > 0)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tint size = ((List";
  protected final String TEXT_639 = ") eObject.eGet(eStructuralFeature)).size();" + NL + "\t\t\t\t\t\tif (size > upperBound)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tresult = false;" + NL + "\t\t\t\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t\t\t\t(";
  protected final String TEXT_640 = ".ERROR," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_641 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_642 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\t\t\t\"_UI_FeatureHasTooManyValues_diagnostic\",";
  protected final String TEXT_643 = NL + "\t\t\t\t\t\t\t\t\t\tnew Object []" + NL + "\t\t\t\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\t\t\t\tgetFeatureLabel(eStructuralFeature, context)," + NL + "\t\t\t\t\t\t\t\t\t\t\tgetObjectLabel(eObject, context)," + NL + "\t\t\t\t\t\t\t\t\t\t\tsize," + NL + "\t\t\t\t\t\t\t\t\t\t\tupperBound" + NL + "\t\t\t\t\t\t\t\t\t\t}," + NL + "\t\t\t\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\telse if (getLowerBound(eObject, eStructuralFeature) >= 1)" + NL + "\t\t{" + NL + "\t\t\tif (eStructuralFeature.isUnsettable() ? !eObject.eIsSet(eStructuralFeature) : eObject.eGet(eStructuralFeature, false) == null)" + NL + "\t\t\t{" + NL + "\t\t\t\tresult = false;" + NL + "\t\t\t\tif (diagnostics != null)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tdiagnostics.add" + NL + "\t\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t\t(";
  protected final String TEXT_644 = ".ERROR," + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_645 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_646 = ".EOBJECT__EVERY_MULTIPCITY_CONFORMS," + NL + "\t\t\t\t\t\t\t\"_UI_RequiredFeatureMustBeSet_diagnostic\",";
  protected final String TEXT_647 = NL + "\t\t\t\t\t\t\tnew Object [] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context) }," + NL + "\t\t\t\t\t\t\tnew Object [] { eObject, eStructuralFeature }," + NL + "\t\t\t\t\t\t\tcontext));" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn result;" + NL + "\t}";
