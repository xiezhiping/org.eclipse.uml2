...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_35 = "(uri);";
  protected final String TEXT_36 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_37 = ".OPTION_EXTENDED_META_DATA, extendedMetaData);" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_38 = ".OPTION_EXTENDED_META_DATA, extendedMetaData);" + NL + "" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_39 = ".OPTION_SCHEMA_LOCATION, Boolean.TRUE);" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_40 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_41 = ".OPTION_USE_LEXICAL_HANDLER, Boolean.TRUE);";
  protected final String TEXT_42 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_45 = NL + "\t\tresult.setEncoding(";
  protected final String TEXT_46 = ".DEFAULT_ENCODING);";
