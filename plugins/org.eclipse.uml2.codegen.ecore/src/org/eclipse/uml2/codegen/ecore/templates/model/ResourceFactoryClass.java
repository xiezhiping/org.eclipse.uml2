...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_34 = "(uri);";
  protected final String TEXT_35 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_50 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_53 = NL + "\t\tresult.setEncoding(";
  protected final String TEXT_54 = ".DEFAULT_ENCODING);";
