...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_36 = "(uri);";
  protected final String TEXT_37 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_45 = ");" + NL + "" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_46 = ".OPTION_SCHEMA_LOCATION, Boolean.TRUE);" + NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_47 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_48 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_49 = ".OPTION_USE_LEXICAL_HANDLER, Boolean.TRUE);";
  protected final String TEXT_50 = NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_51 = ".OPTION_USE_DATA_CONVERTER, Boolean.TRUE);";
  protected final String TEXT_52 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_55 = NL + "\t\tresult.setEncoding(";
  protected final String TEXT_56 = ".DEFAULT_ENCODING);";
