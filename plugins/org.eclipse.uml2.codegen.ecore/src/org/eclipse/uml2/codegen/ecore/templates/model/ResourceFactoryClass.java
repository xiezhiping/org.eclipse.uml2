...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_37 = "(uri);";
  protected final String TEXT_38 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_39 = ".OPTION_EXTENDED_META_DATA, ";
  protected final String TEXT_40 = "Boolean.TRUE";
  protected final String TEXT_41 = "extendedMetaData";
  protected final String TEXT_42 = ");" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_43 = ".OPTION_EXTENDED_META_DATA, ";
  protected final String TEXT_44 = "Boolean.TRUE";
  protected final String TEXT_45 = "extendedMetaData";
  protected final String TEXT_46 = ");" + NL + "" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_47 = ".OPTION_SCHEMA_LOCATION, Boolean.TRUE);" + NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_48 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  protected final String TEXT_49 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL + "" + NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_50 = ".OPTION_USE_LEXICAL_HANDLER, Boolean.TRUE);";
  protected final String TEXT_51 = NL + "\t\tresult.getDefaultLoadOptions().put(";
  protected final String TEXT_52 = ".OPTION_USE_DATA_CONVERTER, Boolean.TRUE);";
  protected final String TEXT_53 = NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_56 = NL + "\t\tresult.setEncoding(";
  protected final String TEXT_57 = ".DEFAULT_ENCODING);";
