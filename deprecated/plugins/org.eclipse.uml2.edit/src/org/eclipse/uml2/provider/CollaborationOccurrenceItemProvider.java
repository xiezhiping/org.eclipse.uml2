 ...
 *
 * $Id: CollaborationOccurrenceItemProvider.java,v 1.17 2006/04/10 20:41:28 khussey Exp $
 */
...
public class CollaborationOccurrenceItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CollaborationOccurrence")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_CollaborationOccurrence_type"), object).toString(); //$NON-NLS-1$
	}
