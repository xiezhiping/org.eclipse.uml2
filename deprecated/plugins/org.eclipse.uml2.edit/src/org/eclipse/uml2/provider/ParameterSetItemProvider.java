 ...
 *
 * $Id: ParameterSetItemProvider.java,v 1.16 2006/04/10 20:41:29 khussey Exp $
 */
...
public class ParameterSetItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ParameterSet")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		if (label.length() > 0) {
			...
			for (Iterator i = parameterSet.getParameters().iterator(); i
				.hasNext();) {
