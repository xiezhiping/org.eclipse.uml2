 ...
 *
 * $Id: ConnectorEndItemProvider.java,v 1.16 2006/04/10 20:41:28 khussey Exp $
 */
...
public class ConnectorEndItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectorEnd")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendType(appendKeywords(new StringBuffer(), object),
			"_UI_ConnectorEnd_type").toString(); //$NON-NLS-1$
	}
