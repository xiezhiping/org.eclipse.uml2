 ...
 *
 * $Id: PrimitiveFunctionItemProvider.java,v 1.16 2006/04/10 20:41:28 khussey Exp $
 */
...
public class PrimitiveFunctionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.PRIMITIVE_FUNCTION__BODY,
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.PRIMITIVE_FUNCTION__LANGUAGE,
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				 null,
				 null));
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PrimitiveFunction")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_PrimitiveFunction_type"), object).toString(); //$NON-NLS-1$
	}
