 ...
 *
 * $Id: ManifestationItemProvider.java,v 1.17 2006/04/10 20:41:28 khussey Exp $
 */
...
public class ManifestationItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Manifestation")); //$NON-NLS-1$
	}
	...
	protected Command createReplaceCommand(EditingDomain domain, EObject owner, EStructuralFeature feature, EObject value, Collection collection) {
		if (feature == UML2Package.Literals.DEPENDENCY__SUPPLIER) {
			return new SubsetSupersetReplaceCommand(domain, owner, feature, null, new EStructuralFeature[] {UML2Package.Literals.MANIFESTATION__UTILIZED_ELEMENT}, value, collection);
		}
