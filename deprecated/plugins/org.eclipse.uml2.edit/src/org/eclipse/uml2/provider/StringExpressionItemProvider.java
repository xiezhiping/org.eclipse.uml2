 ...
 *
 * $Id: StringExpressionItemProvider.java,v 1.15 2006/04/10 20:41:30 khussey Exp $
 */
...
public class StringExpressionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StringExpression")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_StringExpression_type"), object).toString(); //$NON-NLS-1$
	}
