 ...
 *
 * $Id: InteractionOccurrenceItemProvider.java,v 1.15 2006/04/10 20:41:29 khussey Exp $
 */
...
public class InteractionOccurrenceItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InteractionOccurrence")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_InteractionOccurrence_type"), object).toString(); //$NON-NLS-1$
	}
