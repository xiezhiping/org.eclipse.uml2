 ...
 *
 * $Id: ActivityPartitionItemProvider.java,v 1.15 2006/04/10 20:41:28 khussey Exp $
 */
...
public class ActivityPartitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.ACTIVITY_PARTITION__CONTAINED_EDGE,
				 true,
				 null,
				 null,
				 null));
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.ACTIVITY_PARTITION__CONTAINED_NODE,
				 true,
				 null,
				 null,
				 null));
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.ACTIVITY_PARTITION__SUBGROUP,
				 true,
				 null,
				 null,
				 new String[] {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UML2Package.Literals.ACTIVITY_PARTITION__SUPER_PARTITION,
				 true,
				 null,
				 null,
				 new String[] {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UML2Package.Literals.ACTIVITY_PARTITION__SUBGROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActivityPartition")); //$NON-NLS-1$
	}
