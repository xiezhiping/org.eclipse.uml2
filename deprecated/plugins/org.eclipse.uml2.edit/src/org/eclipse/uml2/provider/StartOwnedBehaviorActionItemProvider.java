 ...
 *
 * $Id: StartOwnedBehaviorActionItemProvider.java,v 1.16 2006/04/10 20:41:29 khussey Exp $
 */
...
public class StartOwnedBehaviorActionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StartOwnedBehaviorAction")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_StartOwnedBehaviorAction_type"), object).toString(); //$NON-NLS-1$
	}
