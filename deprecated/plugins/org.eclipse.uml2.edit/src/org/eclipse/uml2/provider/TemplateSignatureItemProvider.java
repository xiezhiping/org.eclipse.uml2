 ...
 *
 * $Id: TemplateSignatureItemProvider.java,v 1.16 2006/04/10 20:41:30 khussey Exp $
 */
...
public class TemplateSignatureItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemplateSignature")); //$NON-NLS-1$
	}
	...
	protected Command createReplaceCommand(EditingDomain domain, EObject owner, EStructuralFeature feature, EObject value, Collection collection) {
		if (feature == UML2Package.Literals.TEMPLATE_SIGNATURE__OWNED_PARAMETER) {
			return new SubsetSupersetReplaceCommand(domain, owner, feature, new EStructuralFeature[] {UML2Package.Literals.TEMPLATE_SIGNATURE__PARAMETER}, null, value, collection);
		}
		if (feature == UML2Package.Literals.TEMPLATE_SIGNATURE__PARAMETER) {
			return new SubsetSupersetReplaceCommand(domain, owner, feature, null, new EStructuralFeature[] {UML2Package.Literals.TEMPLATE_SIGNATURE__OWNED_PARAMETER}, value, collection);
		}
