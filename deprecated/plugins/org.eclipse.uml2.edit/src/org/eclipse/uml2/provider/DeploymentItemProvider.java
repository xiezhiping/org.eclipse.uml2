 ...
 *
 * $Id: DeploymentItemProvider.java,v 1.17 2006/04/10 20:41:30 khussey Exp $
 */
...
public class DeploymentItemProvider
	...
	public String getText(Object object) {
		...
		if (label.length() > 0) {
			...
			for (Iterator i = deployment.getDeployedArtifacts().iterator(); i
				.hasNext();) {
				...
				if (deployedArtifactLabel.length() > 0) {
