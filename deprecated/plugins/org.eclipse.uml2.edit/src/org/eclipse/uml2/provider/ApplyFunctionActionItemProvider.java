 ...
 *
 * $Id: ApplyFunctionActionItemProvider.java,v 1.16 2006/04/10 20:41:30 khussey Exp $
 */
...
public class ApplyFunctionActionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ApplyFunctionAction")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return appendLabel(
			appendType(appendKeywords(new StringBuffer(), object),
				"_UI_ApplyFunctionAction_type"), object).toString(); //$NON-NLS-1$
	}
