 ...
 *
 * $Id: ImplementationItemProvider.java,v 1.16 2006/04/10 20:41:28 khussey Exp $
 */
...
public class ImplementationItemProvider
	...
	protected Command createReplaceCommand(EditingDomain domain, EObject owner, EStructuralFeature feature, EObject value, Collection collection) {
		if (feature == UML2Package.Literals.DEPENDENCY__SUPPLIER) {
			return new SubsetSupersetReplaceCommand(domain, owner, feature, null, new EStructuralFeature[] {UML2Package.Literals.REALIZATION__REALIZING_CLASSIFIER, UML2Package.Literals.IMPLEMENTATION__CONTRACT}, value, collection);
		}
		if (feature == UML2Package.Literals.DEPENDENCY__CLIENT) {
			return new SubsetSupersetReplaceCommand(domain, owner, feature, null, new EStructuralFeature[] {UML2Package.Literals.REALIZATION__ABSTRACTION, UML2Package.Literals.IMPLEMENTATION__IMPLEMENTING_CLASSIFIER}, value, collection);
		}
