 ...
 *
 * $Id: CreateLinkObjectActionImpl.java,v 1.25 2006/04/10 20:40:18 khussey Exp $
 */
...
public class CreateLinkObjectActionImpl extends CreateLinkActionImpl implements CreateLinkObjectAction {
	...
	public EList getOutputs() {
		...
		if (cache != null) {
			...
			if (outputs == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__OUTPUT, outputs = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.CREATE_LINK_OBJECT_ACTION__OUTPUT, OUTPUT_ESUBSETS));
			}
			return outputs;
		}
		return new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.CREATE_LINK_OBJECT_ACTION__OUTPUT, OUTPUT_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] OUTPUT_ESUBSETS = new int[] {UML2Package.CREATE_LINK_OBJECT_ACTION__RESULT};
