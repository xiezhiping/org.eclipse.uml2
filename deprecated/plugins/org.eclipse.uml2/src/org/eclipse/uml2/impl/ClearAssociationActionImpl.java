 ...
 *
 * $Id: ClearAssociationActionImpl.java,v 1.24 2005/12/06 23:18:03 khussey Exp $
 */
...
public class ClearAssociationActionImpl extends ActionImpl implements ClearAssociationAction {
	...
	public EList getInputs() {
		...
		if (input == null) {
			eVirtualSet(UML2Package.CLEAR_ASSOCIATION_ACTION__INPUT, input = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.CLEAR_ASSOCIATION_ACTION__INPUT, new int[] {UML2Package.CLEAR_ASSOCIATION_ACTION__OBJECT}));
		}
		return input;
	}
	...
	public InputPin getObject() {
		return (InputPin)eVirtualGet(UML2Package.CLEAR_ASSOCIATION_ACTION__OBJECT);
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.CLEAR_ASSOCIATION_ACTION__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.CLEAR_ASSOCIATION_ACTION__EANNOTATIONS);
			...
			case UML2Package.CLEAR_ASSOCIATION_ACTION__NAME:
				String name = (String)eVirtualGet(UML2Package.CLEAR_ASSOCIATION_ACTION__NAME, NAME_EDEFAULT);
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.CLEAR_ASSOCIATION_ACTION__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.CLEAR_ASSOCIATION_ACTION__VISIBILITY:
				return eVirtualGet(UML2Package.CLEAR_ASSOCIATION_ACTION__VISIBILITY, VISIBILITY_EDEFAULT) != VISIBILITY_EDEFAULT;
			case UML2Package.CLEAR_ASSOCIATION_ACTION__CLIENT_DEPENDENCY:
			...
			case UML2Package.CLEAR_ASSOCIATION_ACTION__EFFECT:
				String effect = (String)eVirtualGet(UML2Package.CLEAR_ASSOCIATION_ACTION__EFFECT, EFFECT_EDEFAULT);
