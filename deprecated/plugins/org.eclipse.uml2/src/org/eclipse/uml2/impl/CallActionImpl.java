...
public abstract class CallActionImpl extends InvocationActionImpl implements CallAction {
	...
	public EList getOutputs() {
		if (output == null) {
			output = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.CALL_ACTION__OUTPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getCallAction_Result()});
		}
		return output;
	}
