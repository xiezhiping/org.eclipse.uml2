 ...
 *
 * $Id: ProtocolStateMachineImpl.java,v 1.35 2005/12/06 23:18:04 khussey Exp $
 */
...
public class ProtocolStateMachineImpl extends StateMachineImpl implements ProtocolStateMachine {
	...
	public EList getConformances() {
		...
		if (conformance == null) {
			eVirtualSet(UML2Package.PROTOCOL_STATE_MACHINE__CONFORMANCE, conformance = new EObjectContainmentWithInverseEList(ProtocolConformance.class, this, UML2Package.PROTOCOL_STATE_MACHINE__CONFORMANCE, UML2Package.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE));
		}
		return conformance;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_TEMPLATE_SIGNATURE:
				TemplateSignature ownedTemplateSignature = (TemplateSignature)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_TEMPLATE_SIGNATURE);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_PARAMETER:
				TemplateParameter templateParameter = (TemplateParameter)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_PARAMETER);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__SPECIFICATION:
				BehavioralFeature specification = (BehavioralFeature)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__SPECIFICATION);
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.PROTOCOL_STATE_MACHINE__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__EANNOTATIONS);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNER:
				return isSetOwner();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_COMMENT:
				EList ownedComment = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_COMMENT);
				return ownedComment != null && !ownedComment.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_BINDING:
				EList templateBinding = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_BINDING);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__NAME_EXPRESSION:
				return eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__NAME_EXPRESSION) != null;
			case UML2Package.PROTOCOL_STATE_MACHINE__MEMBER:
				return isSetMembers();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_RULE:
				EList ownedRule = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_RULE);
				return ownedRule != null && !ownedRule.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__IMPORTED_MEMBER:
				return !getImportedMembers().isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__ELEMENT_IMPORT:
				EList elementImport = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__ELEMENT_IMPORT);
				return elementImport != null && !elementImport.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__PACKAGE_IMPORT:
				EList packageImport = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__PACKAGE_IMPORT);
				return packageImport != null && !packageImport.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_PARAMETER:
				return eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__TEMPLATE_PARAMETER) != null;
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNING_PARAMETER:
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__REDEFINED_CLASSIFIER:
				EList redefinedClassifier = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__REDEFINED_CLASSIFIER);
				return redefinedClassifier != null && !redefinedClassifier.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__SUBSTITUTION:
				EList substitution = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__SUBSTITUTION);
				return substitution != null && !substitution.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__POWERTYPE_EXTENT:
				EList powertypeExtent = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__POWERTYPE_EXTENT);
				return powertypeExtent != null && !powertypeExtent.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_USE_CASE:
				EList ownedUseCase = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_USE_CASE);
				return ownedUseCase != null && !ownedUseCase.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__USE_CASE:
				EList useCase = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__USE_CASE);
				return useCase != null && !useCase.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__REPRESENTATION:
				return eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__REPRESENTATION) != null;
			case UML2Package.PROTOCOL_STATE_MACHINE__OCCURRENCE:
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__IMPLEMENTATION:
				EList implementation = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__IMPLEMENTATION);
				return implementation != null && !implementation.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_TRIGGER:
				EList ownedTrigger = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_TRIGGER);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__ROLE:
				return isSetRoles();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_CONNECTOR:
				EList ownedConnector = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_CONNECTOR);
				return ownedConnector != null && !ownedConnector.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_PORT:
				EList ownedPort = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_PORT);
				return ownedPort != null && !ownedPort.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_OPERATION:
				EList ownedOperation = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_OPERATION);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__NESTED_CLASSIFIER:
				EList nestedClassifier = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__NESTED_CLASSIFIER);
				return nestedClassifier != null && !nestedClassifier.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__IS_ACTIVE:
				return ((eFlags & IS_ACTIVE_EFLAG) != 0) != IS_ACTIVE_EDEFAULT;
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_RECEPTION:
				EList ownedReception = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_RECEPTION);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__REDEFINED_BEHAVIOR:
				EList redefinedBehavior = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__REDEFINED_BEHAVIOR);
				return redefinedBehavior != null && !redefinedBehavior.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__SPECIFICATION:
				return eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__SPECIFICATION) != null;
			case UML2Package.PROTOCOL_STATE_MACHINE__PARAMETER:
				EList parameter = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__PARAMETER);
			...
			case UML2Package.PROTOCOL_STATE_MACHINE__PRECONDITION:
				EList precondition = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__PRECONDITION);
				return precondition != null && !precondition.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__POSTCONDITION:
				EList postcondition = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__POSTCONDITION);
				return postcondition != null && !postcondition.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__OWNED_PARAMETER_SET:
				EList ownedParameterSet = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__OWNED_PARAMETER_SET);
				return ownedParameterSet != null && !ownedParameterSet.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__REGION:
				EList region = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__REGION);
				return region != null && !region.isEmpty();
			case UML2Package.PROTOCOL_STATE_MACHINE__CONNECTION_POINT:
				EList connectionPoint = (EList)eVirtualGet(UML2Package.PROTOCOL_STATE_MACHINE__CONNECTION_POINT);
	...
	protected EList getOwnedElementsHelper(EList ownedElement) {
		...
		EList conformance = getConformances();
