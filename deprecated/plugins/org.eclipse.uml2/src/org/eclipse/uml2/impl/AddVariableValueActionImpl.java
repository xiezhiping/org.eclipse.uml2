 ...
 *
 * $Id: AddVariableValueActionImpl.java,v 1.17 2005/11/14 17:31:06 khussey Exp $
 */
...
public class AddVariableValueActionImpl extends WriteVariableActionImpl implements AddVariableValueAction {
	...
	public EList getInputs() {
		...
		if (input == null) {
			eVirtualSet(UML2Package.ADD_VARIABLE_VALUE_ACTION__INPUT, input = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.ADD_VARIABLE_VALUE_ACTION__INPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getWriteVariableAction_Value(), UML2Package.eINSTANCE.getAddVariableValueAction_InsertAt()}));
		}
		return input;
	}
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ADD_VARIABLE_VALUE_ACTION__NAME:
				String name = eVirtualIsSet(UML2Package.ADD_VARIABLE_VALUE_ACTION__NAME) ? (String)eVirtualGet(UML2Package.ADD_VARIABLE_VALUE_ACTION__NAME) : NAME_EDEFAULT;
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.ADD_VARIABLE_VALUE_ACTION__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.ADD_VARIABLE_VALUE_ACTION__VISIBILITY:
				return eVirtualIsSet(UML2Package.ADD_VARIABLE_VALUE_ACTION__VISIBILITY) && eVirtualGet(UML2Package.ADD_VARIABLE_VALUE_ACTION__VISIBILITY) != VISIBILITY_EDEFAULT;
			case UML2Package.ADD_VARIABLE_VALUE_ACTION__CLIENT_DEPENDENCY:
			...
			case UML2Package.ADD_VARIABLE_VALUE_ACTION__EFFECT:
				String effect = eVirtualIsSet(UML2Package.ADD_VARIABLE_VALUE_ACTION__EFFECT) ? (String)eVirtualGet(UML2Package.ADD_VARIABLE_VALUE_ACTION__EFFECT) : EFFECT_EDEFAULT;
