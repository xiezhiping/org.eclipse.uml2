 ...
 *
 * $Id: StructuralFeatureActionImpl.java,v 1.2 2004/04/10 04:09:49 khussey Exp $
 */
...
public abstract class StructuralFeatureActionImpl extends ActionImpl implements StructuralFeatureAction {
	...
	public InputPin createObject(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.STRUCTURAL_FEATURE_ACTION__OBJECT, null, newObject));
		}
        setObject(newObject);
		return newObject;
	}
