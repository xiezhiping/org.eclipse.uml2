...
public abstract class WriteVariableActionImpl extends VariableActionImpl implements WriteVariableAction {
	...
	public EList getInputs() {
		if (input == null) {
			input = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.WRITE_VARIABLE_ACTION__INPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getWriteVariableAction_Value()});
		}
		return input;
	}
