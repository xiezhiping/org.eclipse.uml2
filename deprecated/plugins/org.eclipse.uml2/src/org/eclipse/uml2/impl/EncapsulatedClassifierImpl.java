 ...
 *
 * $Id: EncapsulatedClassifierImpl.java,v 1.6 2004/05/11 15:23:59 khussey Exp $
 */
...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
	...
	public Port createOwnedPort(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.ENCAPSULATED_CLASSIFIER__OWNED_PORT, null, newOwnedPort));
		}
	...
	public EList getOwnedMembers() {
		...
		if (!getCacheAdapter().containsKey(this, UML2Package.eINSTANCE.getEncapsulatedClassifier().getEAllOperations().get(74))) {
			...
			getCacheAdapter().put(
				this,
				UML2Package.eINSTANCE.getEncapsulatedClassifier().getEAllOperations().get(74),
				new BasicEList.UnmodifiableEList(union.size(), union.toArray()));
		}
		return (EList) getCacheAdapter().get(this, UML2Package.eINSTANCE.getEncapsulatedClassifier().getEAllOperations().get(74));
	}
