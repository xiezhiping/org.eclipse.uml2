 ...
 *
 * $Id: BehavioredClassifierImpl.java,v 1.2 2004/04/10 04:09:49 khussey Exp $
 */
...
public abstract class BehavioredClassifierImpl extends ClassifierImpl implements BehavioredClassifier {
	...
	public Behavior createOwnedBehavior(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR, null, newOwnedBehavior));
		}
	...
	public Implementation createImplementation(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.BEHAVIORED_CLASSIFIER__IMPLEMENTATION, null, newImplementation));
		}
	...
	public StateMachine createOwnedStateMachine(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE, null, newOwnedStateMachine));
		}
	...
	public EList getOwnedMembers() {
		...
		if (!getCacheAdapter().containsKey(this, UML2Package.eINSTANCE.getBehavioredClassifier().getEAllOperations().get(69))) {
			Set union = new LinkedHashSet();
			union.addAll(super.getOwnedMembers());
			union.addAll(getOwnedBehaviors());
			getCacheAdapter().put(
				this,
				UML2Package.eINSTANCE.getBehavioredClassifier().getEAllOperations().get(69),
				new BasicEList.UnmodifiableEList(union.size(), union.toArray()));
		}
		return (EList) getCacheAdapter().get(this, UML2Package.eINSTANCE.getBehavioredClassifier().getEAllOperations().get(69));
	}
