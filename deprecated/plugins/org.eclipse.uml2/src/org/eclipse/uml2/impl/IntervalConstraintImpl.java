 ...
 *
 * $Id: IntervalConstraintImpl.java,v 1.17 2005/12/06 23:18:03 khussey Exp $
 */
...
public class IntervalConstraintImpl extends ConstraintImpl implements IntervalConstraint {
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.INTERVAL_CONSTRAINT__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.INTERVAL_CONSTRAINT__EANNOTATIONS);
			...
			case UML2Package.INTERVAL_CONSTRAINT__NAME:
				String name = (String)eVirtualGet(UML2Package.INTERVAL_CONSTRAINT__NAME, NAME_EDEFAULT);
