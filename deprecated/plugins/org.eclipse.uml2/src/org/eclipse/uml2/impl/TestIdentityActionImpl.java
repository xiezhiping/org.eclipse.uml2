...
public class TestIdentityActionImpl extends ActionImpl implements TestIdentityAction {
	...
	public InputPin getFirst() {
		return (InputPin)eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__FIRST);
	}
	...
	public InputPin getSecond() {
		return (InputPin)eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__SECOND);
	}
	...
	public OutputPin getResult() {
		return (OutputPin)eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__RESULT);
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UML2Package.TEST_IDENTITY_ACTION__NAME:
				String name = (String)eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__NAME, NAME_EDEFAULT);
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.TEST_IDENTITY_ACTION__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.TEST_IDENTITY_ACTION__VISIBILITY:
				return eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__VISIBILITY, VISIBILITY_EDEFAULT) != VISIBILITY_EDEFAULT;
			case UML2Package.TEST_IDENTITY_ACTION__CLIENT_DEPENDENCY:
			...
			case UML2Package.TEST_IDENTITY_ACTION__EFFECT:
				String effect = (String)eVirtualGet(UML2Package.TEST_IDENTITY_ACTION__EFFECT, EFFECT_EDEFAULT);
