...
public class ReadVariableActionImpl extends VariableActionImpl implements ReadVariableAction {
	...
	public EList getOutputs() {
		if (output == null) {
			output = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_VARIABLE_ACTION__OUTPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getReadVariableAction_Result()});
		}
		return output;
	}
