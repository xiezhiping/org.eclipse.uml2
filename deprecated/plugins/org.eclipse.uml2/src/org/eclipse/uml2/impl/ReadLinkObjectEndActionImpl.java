 ...
 *
 * $Id: ReadLinkObjectEndActionImpl.java,v 1.26 2006/05/26 18:16:42 khussey Exp $
 */
...
public class ReadLinkObjectEndActionImpl extends ActionImpl implements ReadLinkObjectEndAction {
	...
	public EList getInputs() {
		...
		if (cache != null) {
			...
			if (inputs == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__INPUT, inputs = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.READ_LINK_OBJECT_END_ACTION__INPUT, INPUT_ESUBSETS));
			}
			return inputs;
		}
		return new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.READ_LINK_OBJECT_END_ACTION__INPUT, INPUT_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] INPUT_ESUBSETS = new int[] {UML2Package.READ_LINK_OBJECT_END_ACTION__OBJECT};
	...
	public EList getOutputs() {
		...
		if (cache != null) {
			...
			if (outputs == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__OUTPUT, outputs = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_LINK_OBJECT_END_ACTION__OUTPUT, OUTPUT_ESUBSETS));
			}
			return outputs;
		}
		return new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_LINK_OBJECT_END_ACTION__OUTPUT, OUTPUT_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] OUTPUT_ESUBSETS = new int[] {UML2Package.READ_LINK_OBJECT_END_ACTION__RESULT};
