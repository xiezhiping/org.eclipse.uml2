 ...
 *
 * $Id: ImplementationImpl.java,v 1.11 2005/04/04 20:11:13 khussey Exp $
 */
...
public class ImplementationImpl extends RealizationImpl implements Implementation {
	...
	public void setContract(Interface newContract) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.IMPLEMENTATION__CONTRACT, oldContract, newContract));
		}
	}
	...
	public BehavioredClassifier getImplementingClassifier() {
		if (eContainerFeatureID != UML2Package.IMPLEMENTATION__IMPLEMENTING_CLASSIFIER) {
			return null;
		}
	...
	public void setImplementingClassifier(BehavioredClassifier newImplementingClassifier) {
		...
		EObject oldImplementingClassifier = eContainer;
		if (eContainer != newImplementingClassifier || (eContainerFeatureID != UML2Package.IMPLEMENTATION__IMPLEMENTING_CLASSIFIER && null != newImplementingClassifier)) {
			...
			if (null != newImplementingClassifier) {
	...
	public EList getSources() {
		...
		if (null == source) {
			...
			if (null != getImplementingClassifier()) {
				union.add(getImplementingClassifier());
			}
