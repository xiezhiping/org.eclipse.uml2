 ...
 *
 * $Id: AnyTriggerImpl.java,v 1.2 2004/04/10 04:09:49 khussey Exp $
 */
...
public class AnyTriggerImpl extends MessageTriggerImpl implements AnyTrigger {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ANY_TRIGGER__TEMPLATE_PARAMETER:
					if (templateParameter != null)
						msgs = ((InternalEObject)templateParameter).eInverseRemove(this, UML2Package.TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, TemplateParameter.class, msgs);
					return basicSetTemplateParameter((TemplateParameter)otherEnd, msgs);
				case UML2Package.ANY_TRIGGER__OWNING_PARAMETER:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UML2Package.ANY_TRIGGER__OWNING_PARAMETER, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UML2Package.ANY_TRIGGER__OWNING_PARAMETER:
					return eBasicSetContainer(null, UML2Package.ANY_TRIGGER__OWNING_PARAMETER, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.ANY_TRIGGER__PACKAGEABLE_ELEMENT_VISIBILITY:
