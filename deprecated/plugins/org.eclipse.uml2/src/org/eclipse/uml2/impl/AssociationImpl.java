 ...
 *
 * $Id: AssociationImpl.java,v 1.2 2004/04/10 04:09:49 khussey Exp $
 */
...
public class AssociationImpl extends ClassifierImpl implements Association {
	...
	public Property createOwnedEnd(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.ASSOCIATION__OWNED_END, null, newOwnedEnd));
		}
