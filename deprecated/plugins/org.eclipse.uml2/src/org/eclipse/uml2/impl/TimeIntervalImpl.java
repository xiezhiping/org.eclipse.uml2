 ...
 *
 * $Id: TimeIntervalImpl.java,v 1.17 2006/04/10 20:40:16 khussey Exp $
 */
...
public class TimeIntervalImpl extends IntervalImpl implements TimeInterval {
	...
	public EList getMaxes() {
		if (maxes == null) {
			maxes = new EObjectResolvingEList(TimeExpression.class, this, UML2Package.TIME_INTERVAL__MAX);
		}
		return maxes;
	}
	...
	public EList getMins() {
		if (mins == null) {
			mins = new EObjectResolvingEList(TimeExpression.class, this, UML2Package.TIME_INTERVAL__MIN);
		}
		return mins;
	}
