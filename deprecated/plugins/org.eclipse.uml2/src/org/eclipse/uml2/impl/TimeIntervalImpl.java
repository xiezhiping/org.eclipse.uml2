 ...
 *
 * $Id: TimeIntervalImpl.java,v 1.16 2005/12/06 23:18:02 khussey Exp $
 */
...
public class TimeIntervalImpl extends IntervalImpl implements TimeInterval {
	...
	protected EClass eStaticClass() {
		return UML2Package.Literals.TIME_INTERVAL;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.TIME_INTERVAL__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.TIME_INTERVAL__EANNOTATIONS);
			...
			case UML2Package.TIME_INTERVAL__NAME:
				String name = (String)eVirtualGet(UML2Package.TIME_INTERVAL__NAME, NAME_EDEFAULT);
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.TIME_INTERVAL__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.TIME_INTERVAL__VISIBILITY:
				return eVirtualGet(UML2Package.TIME_INTERVAL__VISIBILITY, VISIBILITY_EDEFAULT) != VISIBILITY_EDEFAULT;
			case UML2Package.TIME_INTERVAL__CLIENT_DEPENDENCY:
