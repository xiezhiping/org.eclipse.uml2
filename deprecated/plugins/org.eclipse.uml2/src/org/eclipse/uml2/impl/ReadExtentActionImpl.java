...
public class ReadExtentActionImpl extends ActionImpl implements ReadExtentAction {
	...
	public EList getOutputs() {
		if (output == null) {
			output = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_EXTENT_ACTION__OUTPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getReadExtentAction_Result()});
		}
		return output;
	}
