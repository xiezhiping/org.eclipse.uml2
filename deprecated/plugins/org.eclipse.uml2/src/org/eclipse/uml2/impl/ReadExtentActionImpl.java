 ...
 *
 * $Id: ReadExtentActionImpl.java,v 1.24 2005/12/06 23:18:04 khussey Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.uml2.impl.ReadExtentActionImpl#getOutputs <em>Output</em>}</li>
...
public class ReadExtentActionImpl extends ActionImpl implements ReadExtentAction {
	...
	public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
		Object oldResult = eVirtualSet(UML2Package.READ_EXTENT_ACTION__RESULT, newResult);
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2Package.READ_EXTENT_ACTION__RESULT, oldResult == EVIRTUAL_NO_VALUE ? null : oldResult, newResult);
	...
	public Classifier getClassifier() {
		Classifier classifier = (Classifier)eVirtualGet(UML2Package.READ_EXTENT_ACTION__CLASSIFIER);
		if (classifier != null && classifier.eIsProxy()) {
			InternalEObject oldClassifier = (InternalEObject)classifier;
			classifier = (Classifier)eResolveProxy(oldClassifier);
			if (classifier != oldClassifier) {
				eVirtualSet(UML2Package.READ_EXTENT_ACTION__CLASSIFIER, classifier);
				if (eNotificationRequired())
	...
	public Classifier basicGetClassifier() {
		return (Classifier)eVirtualGet(UML2Package.READ_EXTENT_ACTION__CLASSIFIER);
	}
	...
	public void setClassifier(Classifier newClassifier) {
		...
		Object oldClassifier = eVirtualSet(UML2Package.READ_EXTENT_ACTION__CLASSIFIER, classifier);
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.READ_EXTENT_ACTION__CLASSIFIER, oldClassifier == EVIRTUAL_NO_VALUE ? null : oldClassifier, classifier));
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.READ_EXTENT_ACTION__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__EANNOTATIONS);
			...
			case UML2Package.READ_EXTENT_ACTION__OWNER:
				return isSetOwner();
			case UML2Package.READ_EXTENT_ACTION__OWNED_COMMENT:
				EList ownedComment = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__OWNED_COMMENT);
				return ownedComment != null && !ownedComment.isEmpty();
			case UML2Package.READ_EXTENT_ACTION__TEMPLATE_BINDING:
				EList templateBinding = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__TEMPLATE_BINDING);
			...
			case UML2Package.READ_EXTENT_ACTION__NAME_EXPRESSION:
				return eVirtualGet(UML2Package.READ_EXTENT_ACTION__NAME_EXPRESSION) != null;
			case UML2Package.READ_EXTENT_ACTION__REDEFINITION_CONTEXT:
				return isSetRedefinitionContexts();
			case UML2Package.READ_EXTENT_ACTION__IS_LEAF:
				return ((eFlags & IS_LEAF_EFLAG) != 0) != IS_LEAF_EDEFAULT;
			case UML2Package.READ_EXTENT_ACTION__OUTGOING:
				EList outgoing = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__OUTGOING);
				return outgoing != null && !outgoing.isEmpty();
			case UML2Package.READ_EXTENT_ACTION__INCOMING:
				EList incoming = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__INCOMING);
			...
			case UML2Package.READ_EXTENT_ACTION__IN_PARTITION:
				EList inPartition = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__IN_PARTITION);
				return inPartition != null && !inPartition.isEmpty();
			case UML2Package.READ_EXTENT_ACTION__IN_INTERRUPTIBLE_REGION:
				EList inInterruptibleRegion = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__IN_INTERRUPTIBLE_REGION);
			...
			case UML2Package.READ_EXTENT_ACTION__LOCAL_PRECONDITION:
				EList localPrecondition = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__LOCAL_PRECONDITION);
				return localPrecondition != null && !localPrecondition.isEmpty();
			case UML2Package.READ_EXTENT_ACTION__LOCAL_POSTCONDITION:
				EList localPostcondition = (EList)eVirtualGet(UML2Package.READ_EXTENT_ACTION__LOCAL_POSTCONDITION);
				return localPostcondition != null && !localPostcondition.isEmpty();
			case UML2Package.READ_EXTENT_ACTION__RESULT:
				return eVirtualGet(UML2Package.READ_EXTENT_ACTION__RESULT) != null;
			case UML2Package.READ_EXTENT_ACTION__CLASSIFIER:
