 ...
 *
 * $Id: PackageableElementImpl.java,v 1.21 2005/12/06 23:18:03 khussey Exp $
 */
...
public abstract class PackageableElementImpl extends NamedElementImpl implements PackageableElement {
	...
	public VisibilityKind getPackageableElement_visibility() {
		return (VisibilityKind)eVirtualGet(UML2Package.PACKAGEABLE_ELEMENT__PACKAGEABLE_ELEMENT_VISIBILITY, PACKAGEABLE_ELEMENT_VISIBILITY_EDEFAULT);
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UML2Package.PACKAGEABLE_ELEMENT__EANNOTATIONS:
				EList eAnnotations = (EList)eVirtualGet(UML2Package.PACKAGEABLE_ELEMENT__EANNOTATIONS);
			...
			case UML2Package.PACKAGEABLE_ELEMENT__NAME:
				String name = (String)eVirtualGet(UML2Package.PACKAGEABLE_ELEMENT__NAME, NAME_EDEFAULT);
