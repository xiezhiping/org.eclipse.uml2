 ...
 *
 * $Id: CreateObjectActionImpl.java,v 1.2 2004/04/10 04:09:49 khussey Exp $
 */
...
public class CreateObjectActionImpl extends ActionImpl implements CreateObjectAction {
	...
	public OutputPin createResult(EClass eClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.CREATE, UML2Package.CREATE_OBJECT_ACTION__RESULT, null, newResult));
		}
        setResult(newResult);
		return newResult;
	}
