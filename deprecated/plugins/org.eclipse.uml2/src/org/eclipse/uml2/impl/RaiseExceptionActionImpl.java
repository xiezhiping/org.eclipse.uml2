...
public class RaiseExceptionActionImpl extends ActionImpl implements RaiseExceptionAction {
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UML2Package.RAISE_EXCEPTION_ACTION__NAME:
				String name = eVirtualIsSet(UML2Package.RAISE_EXCEPTION_ACTION__NAME) ? (String)eVirtualGet(UML2Package.RAISE_EXCEPTION_ACTION__NAME) : NAME_EDEFAULT;
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.RAISE_EXCEPTION_ACTION__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.RAISE_EXCEPTION_ACTION__VISIBILITY:
				return eVirtualIsSet(UML2Package.RAISE_EXCEPTION_ACTION__VISIBILITY) && eVirtualGet(UML2Package.RAISE_EXCEPTION_ACTION__VISIBILITY) != VISIBILITY_EDEFAULT;
			case UML2Package.RAISE_EXCEPTION_ACTION__CLIENT_DEPENDENCY:
			...
			case UML2Package.RAISE_EXCEPTION_ACTION__EFFECT:
				String effect = eVirtualIsSet(UML2Package.RAISE_EXCEPTION_ACTION__EFFECT) ? (String)eVirtualGet(UML2Package.RAISE_EXCEPTION_ACTION__EFFECT) : EFFECT_EDEFAULT;
