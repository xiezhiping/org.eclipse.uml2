 ...
 *
 * $Id: ReadLinkActionImpl.java,v 1.25 2006/05/26 18:16:51 khussey Exp $
 */
...
public class ReadLinkActionImpl extends LinkActionImpl implements ReadLinkAction {
	...
	public EList getOutputs() {
		...
		if (cache != null) {
			...
			if (outputs == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__OUTPUT, outputs = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_LINK_ACTION__OUTPUT, OUTPUT_ESUBSETS));
			}
			return outputs;
		}
		return new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_LINK_ACTION__OUTPUT, OUTPUT_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] OUTPUT_ESUBSETS = new int[] {UML2Package.READ_LINK_ACTION__RESULT};
