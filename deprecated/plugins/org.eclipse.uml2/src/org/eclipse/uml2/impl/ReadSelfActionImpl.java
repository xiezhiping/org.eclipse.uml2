...
public class ReadSelfActionImpl extends ActionImpl implements ReadSelfAction {
	...
	public EList getOutputs() {
		if (output == null) {
			output = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_SELF_ACTION__OUTPUT, new EStructuralFeature[] {UML2Package.eINSTANCE.getReadSelfAction_Result()});
		}
		return output;
	}
