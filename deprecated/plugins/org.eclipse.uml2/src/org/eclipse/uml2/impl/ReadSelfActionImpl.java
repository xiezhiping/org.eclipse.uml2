...
public class ReadSelfActionImpl extends ActionImpl implements ReadSelfAction {
	...
	public EList getOutputs() {
		...
		if (cache != null) {
			...
			if (outputs == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__OUTPUT, outputs = new DerivedUnionEObjectEList(OutputPin.class, this, UML2Package.READ_SELF_ACTION__OUTPUT, OUTPUT_ESUBSETS));
			}
			return outputs;
		}
	 ...
	 * @ordered
	 */
	protected static final int[] OUTPUT_ESUBSETS = new int[] {UML2Package.READ_SELF_ACTION__RESULT};
