 ...
 *
 * $Id: TimeObservationActionImpl.java,v 1.23 2006/04/10 20:40:19 khussey Exp $
 */
...
public class TimeObservationActionImpl extends WriteStructuralFeatureActionImpl implements TimeObservationAction {
	...
	protected EClass eStaticClass() {
		return UML2Package.Literals.TIME_OBSERVATION_ACTION;
	}
	...
	public EList getNows() {
		if (nows == null) {
			nows = new EObjectContainmentEList(TimeExpression.class, this, UML2Package.TIME_OBSERVATION_ACTION__NOW);
		}
		return nows;
	}
	 ...
	 * @generated
	 */
	public TimeExpression getNow(String name, boolean ignoreCase) {
		nowLoop: for (Iterator i = getNows().iterator(); i.hasNext(); ) {
			TimeExpression now = (TimeExpression) i.next();
			if (name != null && !(ignoreCase ? name.equalsIgnoreCase(now.getName()) : name.equals(now.getName())))
				continue nowLoop;
			return now;
		}
		return null;
	 ...
	 * @see #getInputs()
	 */
	protected static final int[] INPUT_ESUBSETS = new int[] {UML2Package.TIME_OBSERVATION_ACTION__OBJECT, UML2Package.TIME_OBSERVATION_ACTION__NOW};
	...
	public EList getInputs() {
		...
		if (cache != null) {
			...
			if (input == null) {
				cache.put(eResource, this, UML2Package.Literals.ACTION__INPUT, input = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.TIME_OBSERVATION_ACTION__INPUT, INPUT_ESUBSETS));
			}
			return input;
		}
		return new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.TIME_OBSERVATION_ACTION__INPUT, INPUT_ESUBSETS);
	}
