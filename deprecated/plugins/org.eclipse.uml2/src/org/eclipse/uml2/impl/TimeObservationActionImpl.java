 ...
 *
 * $Id: TimeObservationActionImpl.java,v 1.20 2005/11/23 20:05:09 khussey Exp $
 */
...
public class TimeObservationActionImpl extends WriteStructuralFeatureActionImpl implements TimeObservationAction {
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UML2Package.TIME_OBSERVATION_ACTION__NAME:
				String name = (String)eVirtualGet(UML2Package.TIME_OBSERVATION_ACTION__NAME, NAME_EDEFAULT);
				return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT.equals(name);
			case UML2Package.TIME_OBSERVATION_ACTION__QUALIFIED_NAME:
				return QUALIFIED_NAME_EDEFAULT == null ? getQualifiedName() != null : !QUALIFIED_NAME_EDEFAULT.equals(getQualifiedName());
			case UML2Package.TIME_OBSERVATION_ACTION__VISIBILITY:
				return eVirtualGet(UML2Package.TIME_OBSERVATION_ACTION__VISIBILITY, VISIBILITY_EDEFAULT) != VISIBILITY_EDEFAULT;
			case UML2Package.TIME_OBSERVATION_ACTION__CLIENT_DEPENDENCY:
			...
			case UML2Package.TIME_OBSERVATION_ACTION__EFFECT:
				String effect = (String)eVirtualGet(UML2Package.TIME_OBSERVATION_ACTION__EFFECT, EFFECT_EDEFAULT);
	...
	public EList getInputs() {
		...
		if (input == null) {
			eVirtualSet(UML2Package.TIME_OBSERVATION_ACTION__INPUT, input = new DerivedUnionEObjectEList(InputPin.class, this, UML2Package.TIME_OBSERVATION_ACTION__INPUT, new int[] {UML2Package.TIME_OBSERVATION_ACTION__OBJECT, UML2Package.TIME_OBSERVATION_ACTION__NOW}));
		}
		return input;
	}
