 ...
 *
 * $Id: ReplyAction.java,v 1.10 2006/04/10 20:40:20 khussey Exp $
 */
...
public interface ReplyAction extends Action {
	...
	/**
	 * Retrieves the first {@link org.eclipse.uml2.InputPin} with the specified '<em><b>Name</b></em>' from the '<em><b>Reply Value</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	InputPin getReplyValue(String name, boolean ignoreCase, EClass eClass);
