 ...
 *
 * $Id: ExtensionItemProviderTest.java,v 1.2 2005/03/15 18:49:58 khussey Exp $
 */
...
public class ExtensionItemProviderTest extends AssociationItemProviderTest {
	...
	public void testCreateAddCommand() {
		...
		command =
			AddCommand.create(
				...
				Collections.singleton(extensionEnd),
				CommandParameter.NO_INDEX);
	...
	public void testCreateRemoveCommand() {
		...
		command = RemoveCommand.create(getEditingDomain(), getModelObject(), UML2Package.eINSTANCE.getAssociation_MemberEnd(), Collections.singleton(extensionEnd));
	...
	public void testCreateReplaceCommand() {
		...
		// test ASSOCIATION__OWNED_END subset...
		ExtensionEnd extensionEnd = UML2Factory.eINSTANCE.createExtensionEnd();
		ExtensionEnd replacementExtensionEnd = UML2Factory.eINSTANCE.createExtensionEnd();
		...
		assertFalse(getModelObject().getOwnedEnds().contains(extensionEnd));
		assertTrue(getModelObject().getOwnedEnds().contains(replacementExtensionEnd));
		assertTrue(getModelObject().getMemberEnds().contains(replacementExtensionEnd));
	
		getCommandStack().undo();
	
		assertTrue(getModelObject().getOwnedEnds().contains(extensionEnd));
		assertFalse(getModelObject().getOwnedEnds().contains(replacementExtensionEnd));
		assertFalse(getModelObject().getMemberEnds().contains(replacementExtensionEnd));
	...
	public void testCreateSetCommand() {
		...
		Command command = SetCommand.create(getEditingDomain(), getModelObject(), UML2Package.eINSTANCE.getClassifier_Representation(), collaborationOccurrence);
